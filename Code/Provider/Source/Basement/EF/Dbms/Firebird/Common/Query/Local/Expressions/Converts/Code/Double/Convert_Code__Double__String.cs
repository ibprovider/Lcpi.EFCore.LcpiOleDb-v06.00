 ...
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__Double__String
  Instance
   =new Convert_Code__Double__String();

 //-----------------------------------------------------------------------
 private Convert_Code__Double__String()
 {
 }//Convert_Code__Double__String
 ...
 //-----------------------------------------------------------------------
 private static System.String Exec(T_SOURCE v)
 {
  return FB_CVT_CODE.Convert_Code__DOUBLE__STRING.Exec(v);
 }//Exec
};//class Convert_Code__Double__String
