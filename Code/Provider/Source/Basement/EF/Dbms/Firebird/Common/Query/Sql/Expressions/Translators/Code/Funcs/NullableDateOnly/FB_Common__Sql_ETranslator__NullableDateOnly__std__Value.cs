...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__NullableDateOnly__std__Value

static class FB_Common__Sql_ETranslator__NullableDateOnly__std__Value
{
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance_d1__not_supported
   =new FB_Common__Sql_ETranslator_Member.tagDescr
    (Structure_MemberIdCache.MemberIdOf__NullableDateOnly__std__Value,
   ...
   =new FB_Common__Sql_ETranslator_Member.tagDescr
         (Structure_MemberIdCache.MemberIdOf__NullableDateOnly__std__Value,
          new Internal.FB_Common__Sql_ETranslator__Nullable__std__Value
           (FB_Common__TypeMappingCache.TypeMapping_D3__TYPE_DATE__as_DateOnly));
};//class FB_Common__Sql_ETranslator__NullableDateOnly__std__Value
