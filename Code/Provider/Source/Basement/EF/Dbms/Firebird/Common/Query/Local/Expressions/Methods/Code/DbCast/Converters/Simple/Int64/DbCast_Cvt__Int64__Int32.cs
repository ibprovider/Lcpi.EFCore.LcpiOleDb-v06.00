...
////////////////////////////////////////////////////////////////////////////////
//class DbCast_Cvt__Int64__Int32

sealed class DbCast_Cvt__Int64__Int32
 :Core.Core_ValueCvt<object,object>
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Query_Local_Expressions__DbCast_Cvt__Int64__Int32;

 //-----------------------------------------------------------------------
 public static readonly DbCast_Cvt__Int64__Int32
  Instance
   =new DbCast_Cvt__Int64__Int32();
                  ...
                  out object            targetValue)
 {
  ...
  Int64 typedSourceValue=(Int64)sourceValue;

  Int32 typedTargetValue=0;

  try
  {
   typedTargetValue=(Int32)typedSourceValue;
  }
