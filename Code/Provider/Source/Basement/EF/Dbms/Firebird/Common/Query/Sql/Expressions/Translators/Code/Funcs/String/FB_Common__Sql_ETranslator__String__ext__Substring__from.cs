...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__ext__Substring__from

sealed class FB_Common__Sql_ETranslator__String__ext__Substring__from
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__ext__Substring__from,
      new FB_Common__Sql_ETranslator__String__ext__Substring__from());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__ext__Substring__from()
 {
 }//FB_Common__Sql_ETranslator__String__ext__Substring__from
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__ext__Substring__from));
