...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__TimeOnly__std__Second

sealed class FB_Common__Sql_ETranslator__TimeOnly__std__Second
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Second,
      new FB_Common__Sql_ETranslator__TimeOnly__std__Second());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__TimeOnly__std__Second()
 {
 }//FB_Common__Sql_ETranslator__TimeOnly__std__Second
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Second);
#endif
