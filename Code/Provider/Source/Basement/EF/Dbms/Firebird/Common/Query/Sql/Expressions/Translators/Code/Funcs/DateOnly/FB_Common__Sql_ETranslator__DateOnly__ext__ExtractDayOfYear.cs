...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractDayOfYear

sealed class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractDayOfYear
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateOnly__ext__ExtractDayOfYear,
      new FB_Common__Sql_ETranslator__DateOnly__ext__ExtractDayOfYear());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateOnly__ext__ExtractDayOfYear()
 {
 }//FB_Common__Sql_ETranslator__DateOnly__ext__ExtractDayOfYear
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateOnly__ext__ExtractDayOfYear));
  ...
  Debug.Assert(exprArg0.Type==Structure_TypeCache.TypeOf__System_DateOnly);
