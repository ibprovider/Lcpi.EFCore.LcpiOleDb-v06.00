...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__VARBINARY

sealed class FB_Common__TypeMapping__VARBINARY
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__VARBINARY;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__VARBINARY(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 public static RelationalTypeMapping Create(int length)
 {
  ...
  return new FB_Common__TypeMapping__VARBINARY(parameters);
 }//Create - length
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__VARBINARY::Clone(...)");
#endif
