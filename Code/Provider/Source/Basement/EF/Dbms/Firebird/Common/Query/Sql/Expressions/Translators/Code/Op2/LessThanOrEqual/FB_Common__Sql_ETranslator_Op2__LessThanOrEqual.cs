...
//                                      IBProvider and Contributors. 27.04.2021.
using System;
...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator_Op2__LessThanOrEqual

sealed class FB_Common__Sql_ETranslator_Op2__LessThanOrEqual
 :FB_Common__Sql_ETranslator_Op2
{
 public static readonly FB_Common__Sql_ETranslator_Op2
  Instance
   =new FB_Common__Sql_ETranslator_Op2__LessThanOrEqual();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator_Op2__LessThanOrEqual()
 {
 }//FB_Common__Sql_ETranslator_Op2__LessThanOrEqual

 //FB_Common__Sql_ETranslator_Op2 interface ------------------------------
 public override SqlExpression Translate(in tagOpData opData)
 {
  Debug.Assert(opData.OperationType==LcpiOleDb__ExpressionType.LessThanOrEqual);
  ...
  //------------------------------------------------------------
  var result
   =Nodes.FB_Common__Sql_ENode_Binary__LessThanOrEqual.Create
     (sqlLeft,
      sqlRight,
      resultTypeMapping);
