...
//                                      IBProvider and Contributors. 22.07.2022.
using System;
...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__TimeOnly__std__AddHours

sealed class FB_Common__Sql_ETranslator__TimeOnly__std__AddHours
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__TimeOnly__std__AddHours,
      new FB_Common__Sql_ETranslator__TimeOnly__std__AddHours());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__TimeOnly__std__AddHours()
 {
 }//FB_Common__Sql_ETranslator__TimeOnly__std__AddHours
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__TimeOnly__std__AddHours));
  ...
  //----------------------------------------
  var exprScale
   =FB_Common__Data.sm_SqlConstantExpression__Int32__MillisecondsInHour;
