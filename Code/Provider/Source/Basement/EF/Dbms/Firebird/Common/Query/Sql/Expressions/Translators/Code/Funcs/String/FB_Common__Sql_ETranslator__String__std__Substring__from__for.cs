...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__std__Substring__from__for

sealed class FB_Common__Sql_ETranslator__String__std__Substring__from__for
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__std__Substring__from_for,
      new FB_Common__Sql_ETranslator__String__std__Substring__from__for());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__std__Substring__from__for()
 {
 }//FB_Common__Sql_ETranslator__String__std__Substring__from__for
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__std__Substring__from_for));
