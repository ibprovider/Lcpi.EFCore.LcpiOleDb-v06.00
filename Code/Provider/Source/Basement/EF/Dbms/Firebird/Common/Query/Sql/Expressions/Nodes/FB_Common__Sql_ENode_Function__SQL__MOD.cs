...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__MOD

sealed class FB_Common__Sql_ENode_Function__SQL__MOD
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__MOD;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__MOD
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__MOD::FB_Common__Sql_ENode_Function__SQL__MOD(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__MOD::FB_Common__Sql_ENode_Function__SQL__MOD\n"
   +" (leftExpression  : {0},\n"
   +"  rightExpression : {1},\n"
   +"  resultType      : {2})",
    leftExpression,
...
//-----------------------------------------------------------------------
                                    ...
                                    SqlExpression         rightExpression)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__MOD
              (leftExpression,
               rightExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__MOD::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__MOD::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__MOD::VisitChildren";
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__MOD::Print(...)");
#endif
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__MOD::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("MOD(");
 ...
 private static readonly Helpers.Map_Op2ResultTypeMappings
  sm_SupportedStates
   =new Helpers.Map_Op2ResultTypeMappings()
     ...
     .Add(Structure_TypeCache.TypeOf__System_Int16   ,Structure_TypeCache.TypeOf__System_Int32   ,FB_Common__TypeMappingCache.TypeMapping__INT16)
     .Add(Structure_TypeCache.TypeOf__System_Int16   ,Structure_TypeCache.TypeOf__System_Int64   ,FB_Common__TypeMappingCache.TypeMapping__INT16)
     ...
     .Add(Structure_TypeCache.TypeOf__System_Int32   ,Structure_TypeCache.TypeOf__System_Int64   ,FB_Common__TypeMappingCache.TypeMapping__INT32)
     ...
     //
     // [2021-09-29] Field for improving.
     //
