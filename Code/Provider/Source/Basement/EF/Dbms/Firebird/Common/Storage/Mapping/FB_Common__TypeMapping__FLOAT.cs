...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__FLOAT

sealed class FB_Common__TypeMapping__FLOAT
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__FLOAT;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__FLOAT(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__FLOAT::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__FLOAT(parameters);
 }//Clone
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  if(Structure_ADP.StrHasFloatValueAttrs(typedValue,r))
   return r;
 ...
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetFloat,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetFloat;
 }//GetDataReaderMethod
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.FLOAT;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__FLOAT
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__FLOAT
