...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DbCast__std__AsDouble

sealed class ETranslator__DbCast__std__AsDouble
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DbCast__std__AsDouble();

 //-----------------------------------------------------------------------
 private ETranslator__DbCast__std__AsDouble()
  :base(Structure_MethodIdCache.MethodIdOf__DbCast__std__AsDouble)
 {
 }//ETranslator__DbCast__std__AsDouble
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DbCast__std__AsDouble);
  ...
  var r=Expression.Call
         (Code.Method_Code__DbCast__AsDouble.MethodInfo,
          node_Arg0);
