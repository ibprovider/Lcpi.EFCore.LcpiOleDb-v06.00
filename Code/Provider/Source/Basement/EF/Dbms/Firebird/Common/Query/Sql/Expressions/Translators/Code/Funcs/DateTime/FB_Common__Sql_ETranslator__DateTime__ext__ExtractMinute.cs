...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__ext__ExtractMinute

sealed class FB_Common__Sql_ETranslator__DateTime__ext__ExtractMinute
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateTime__ext__ExtractMinute,
      new FB_Common__Sql_ETranslator__DateTime__ext__ExtractMinute());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__ext__ExtractMinute()
 {
 }//FB_Common__Sql_ETranslator__DateTime__ext__ExtractMinute
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateTime__ext__ExtractMinute));
