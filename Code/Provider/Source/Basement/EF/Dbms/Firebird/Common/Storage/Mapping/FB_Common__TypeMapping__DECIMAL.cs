...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__DECIMAL

sealed class FB_Common__TypeMapping__DECIMAL
 :FB_Common__TypeMapping
 ,FB_Common__ITypeMapping__IsCompatiblyWithIdentity
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__DECIMAL;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__DECIMAL(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 public static RelationalTypeMapping Create(in RelationalTypeMappingInfo mappingInfo)
 {
  ...
  return new FB_Common__TypeMapping__DECIMAL(parameters);
 }//Create - mappingInfo

 //-----------------------------------------------------------------------
 public static RelationalTypeMapping Create_Default()
 {
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__DECIMAL::Clone(...)");
#endif
  ...
  HelperCheck.RelationalTypeMappingParameters__Precision_and_Scale__optional
   (c_ErrSrcID,
    parameters,
    Core.Engines.Dbms.IscBase.IscBase_Const.c_max_decimal_precision);
  ...
  //------------------------------------------------------------
  return new FB_Common__TypeMapping__DECIMAL(RTMP);
 }//Clone
                                                   ...
                                                   Nullable<int> scale)
 {
  ...
  else
  {
   ...
   Debug.Assert(precision.Value<=c_MaxDecimalPrecision);
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMappingParameters Helper__CreateRTMP__default
                                                  ()
 {
  return Helper__CreateRTMP
          (/*precision*/null,
           /*scale*/null);
 }//Helper__CreateRTMP
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.DECIMAL;

 private const int c_MaxDecimalPrecision
  =Core.Engines.Dbms.IscBase.IscBase_Const.c_max_decimal_precision;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance_default
   =new FB_Common__TypeMapping__DECIMAL
     (Helper__CreateRTMP__default
       ());
};//class FB_Common__TypeMapping__DECIMAL
