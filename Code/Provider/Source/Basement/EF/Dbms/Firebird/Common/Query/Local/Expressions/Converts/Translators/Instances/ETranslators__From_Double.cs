...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__From_Double

static class ETranslators__From_Double
{
 public static readonly LOCAL_EVAL__Convert__Descr
  sm_TO__String
   =new LOCAL_EVAL__Convert__Descr
     (new LOCAL_EVAL__Convert__ETranslator__STD__SIMPLE(Code.Convert_Code__Double__String.MethodInfo),
      Code.Convert_Code__Double__String.Instance);
};//class ETranslators__From_Double
