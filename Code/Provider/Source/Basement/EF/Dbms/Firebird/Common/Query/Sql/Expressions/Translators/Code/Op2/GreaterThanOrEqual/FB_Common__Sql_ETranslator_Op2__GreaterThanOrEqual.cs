...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator_Op2__GreaterThanOrEqual

sealed class FB_Common__Sql_ETranslator_Op2__GreaterThanOrEqual
 :FB_Common__Sql_ETranslator_Op2
{
 public static readonly FB_Common__Sql_ETranslator_Op2
  Instance
   =new FB_Common__Sql_ETranslator_Op2__GreaterThanOrEqual();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator_Op2__GreaterThanOrEqual()
 {
 }//FB_Common__Sql_ETranslator_Op2__GreaterThanOrEqual

 //FB_Common__Sql_ETranslator_Op2 interface ------------------------------
 public override SqlExpression Translate(in tagOpData opData)
 {
  Debug.Assert(opData.OperationType==LcpiOleDb__ExpressionType.GreaterThanOrEqual);
  ...
  //------------------------------------------------------------
  var result
   =Nodes.FB_Common__Sql_ENode_Binary__GreaterThanOrEqual.Create
     (sqlLeft,
      sqlRight,
      resultTypeMapping);
