...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__BOOLEAN

sealed class FB_Common__TypeMapping__BOOLEAN
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__BOOLEAN;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__BOOLEAN(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__BOOLEAN::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__BOOLEAN(parameters);
 }//Clone
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  return FB_CVT_CODE.Convert_Code__BOOLEAN__STRING.Exec(typedValue);
 }//GenerateNonNullSqlLiteral

 //-----------------------------------------------------------------------
 public override MethodInfo GetDataReaderMethod()
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetBoolean,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetBoolean;
 }//GetDataReaderMethod
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.BOOLEAN;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__BOOLEAN
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__BOOLEAN
