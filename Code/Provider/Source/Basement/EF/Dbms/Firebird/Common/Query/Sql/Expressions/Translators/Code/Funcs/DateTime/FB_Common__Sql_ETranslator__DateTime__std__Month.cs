...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__Month

sealed class FB_Common__Sql_ETranslator__DateTime__std__Month
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateTime__std__Month,
      new FB_Common__Sql_ETranslator__DateTime__std__Month());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__Month()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__Month
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateTime__std__Month);
#endif
