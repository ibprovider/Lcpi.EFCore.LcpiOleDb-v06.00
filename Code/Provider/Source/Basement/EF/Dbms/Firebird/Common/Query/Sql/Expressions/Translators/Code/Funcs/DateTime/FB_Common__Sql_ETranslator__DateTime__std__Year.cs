...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__Year

sealed class FB_Common__Sql_ETranslator__DateTime__std__Year
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateTime__std__Year,
      new FB_Common__Sql_ETranslator__DateTime__std__Year());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__Year()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__Year
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateTime__std__Year);
#endif
