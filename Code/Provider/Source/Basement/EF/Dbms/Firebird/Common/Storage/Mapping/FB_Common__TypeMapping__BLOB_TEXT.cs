...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__BLOB_TEXT

sealed class FB_Common__TypeMapping__BLOB_TEXT
 :FB_Common__TypeMapping
 ,FB_Common__ITypeMapping__BLOB
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__BLOB_TEXT;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__BLOB_TEXT(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 private static RelationalTypeMapping Helper__Create(string charsetName)
 {
  ...
  return new FB_Common__TypeMapping__BLOB_TEXT(parameters);
 }//Helper__Create
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__BLOB_TEXT::Clone(...)");
#endif
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  return FB_Common__Utilities.TextToSqlLiteral((string)value);
 }//GenerateNonNullSqlLiteral

 //-----------------------------------------------------------------------
 public override MethodInfo GetDataReaderMethod()
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetString,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetString;
 }//GetDataReaderMethod
 ...
 private static readonly RelationalTypeMapping
  sm_Instance_default
   =new FB_Common__TypeMapping__BLOB_TEXT
