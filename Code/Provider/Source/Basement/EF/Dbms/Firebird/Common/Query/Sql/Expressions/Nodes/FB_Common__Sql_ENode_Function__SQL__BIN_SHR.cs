...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__BIN_SHR

sealed class FB_Common__Sql_ENode_Function__SQL__BIN_SHR
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__BIN_SHR;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__BIN_SHR
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::FB_Common__Sql_ENode_Function__SQL__BIN_SHR(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::FB_Common__Sql_ENode_Function__SQL__BIN_SHR\n"
   +" (leftExpression  : {0},\n"
   +"  rightExpression : {1},\n"
   +"  resultType      : {2})",
    leftExpression,
...
//-----------------------------------------------------------------------
                                    ...
                                    SqlExpression rightExpression)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__BIN_SHR
              (leftExpression,
               rightExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__BIN_SHR::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("BIN_SHR(");
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__BIN_SHR::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("BIN_SHR(");
 ...
 private static readonly Helpers.Map_Op2ResultTypeMappings
  sm_SupportedStates
   =new Helpers.Map_Op2ResultTypeMappings()
     .Add(Structure_TypeCache.TypeOf__System_Int16   ,Structure_TypeCache.TypeOf__System_Int16   ,FB_Common__TypeMappingCache.TypeMapping__INT64)
     .Add(Structure_TypeCache.TypeOf__System_Int16   ,Structure_TypeCache.TypeOf__System_Int32   ,FB_Common__TypeMappingCache.TypeMapping__INT64)
     .Add(Structure_TypeCache.TypeOf__System_Int16   ,Structure_TypeCache.TypeOf__System_Int64   ,FB_Common__TypeMappingCache.TypeMapping__INT64) /*not supported by C#*/

     .Add(Structure_TypeCache.TypeOf__System_Int32   ,Structure_TypeCache.TypeOf__System_Int16   ,FB_Common__TypeMappingCache.TypeMapping__INT64)
     .Add(Structure_TypeCache.TypeOf__System_Int32   ,Structure_TypeCache.TypeOf__System_Int32   ,FB_Common__TypeMappingCache.TypeMapping__INT64)
     .Add(Structure_TypeCache.TypeOf__System_Int32   ,Structure_TypeCache.TypeOf__System_Int64   ,FB_Common__TypeMappingCache.TypeMapping__INT64) /*not supported by C#*/
     ...
     .Add(Structure_TypeCache.TypeOf__System_Int64   ,Structure_TypeCache.TypeOf__System_Int64   ,FB_Common__TypeMappingCache.TypeMapping__INT64) /*not supported by C#*/
