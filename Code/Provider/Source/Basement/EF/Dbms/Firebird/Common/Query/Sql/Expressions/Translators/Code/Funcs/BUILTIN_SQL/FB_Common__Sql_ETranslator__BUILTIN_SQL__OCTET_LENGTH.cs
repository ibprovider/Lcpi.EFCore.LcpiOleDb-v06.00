...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__BUILTIN_SQL__OCTET_LENGTH

sealed class FB_Common__Sql_ETranslator__BUILTIN_SQL__OCTET_LENGTH
 :FB_Common__Sql_ETranslator_MethodCall
{
  ...
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__BUILTIN_SQL__OCTET_LENGTH,
      new FB_Common__Sql_ETranslator__BUILTIN_SQL__OCTET_LENGTH());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__BUILTIN_SQL__OCTET_LENGTH()
 {
 }//FB_Common__Sql_ETranslator__BUILTIN_SQL__OCTET_LENGTH
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodIdCache.MethodIdOf__BUILTIN_SQL__OCTET_LENGTH));
  ...
  //----------------------------------------
  var r
   =Nodes.FB_Common__Sql_ENode_Function__SQL__OCTET_LENGTH.Create
     (exprArg0);
