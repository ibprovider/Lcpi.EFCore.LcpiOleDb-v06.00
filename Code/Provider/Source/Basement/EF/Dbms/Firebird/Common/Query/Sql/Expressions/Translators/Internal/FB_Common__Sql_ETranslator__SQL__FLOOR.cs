...
//                                      IBProvider and Contributors. 13.12.2020.
using System;
...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__SQL__FLOOR

sealed class FB_Common__Sql_ETranslator__SQL__FLOOR
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall
  Instance
   =new FB_Common__Sql_ETranslator__SQL__FLOOR();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__SQL__FLOOR()
 {
 }//FB_Common__Sql_ETranslator__SQL__FLOOR
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  //----------------------------------------
  return Nodes.FB_Common__Sql_ENode_Function__SQL__FLOOR.Create
          (exprArg0);
 }//Translate
};//class FB_Common__Sql_ETranslator__SQL__FLOOR
