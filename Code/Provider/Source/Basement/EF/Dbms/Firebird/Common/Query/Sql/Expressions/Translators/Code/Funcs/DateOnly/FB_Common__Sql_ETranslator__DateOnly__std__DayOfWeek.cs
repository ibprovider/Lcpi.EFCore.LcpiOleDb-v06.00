...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateOnly__std__DayOfWeek

sealed class FB_Common__Sql_ETranslator__DateOnly__std__DayOfWeek
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateOnly__std__DayOfWeek,
      new FB_Common__Sql_ETranslator__DateOnly__std__DayOfWeek());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateOnly__std__DayOfWeek()
 {
 }//FB_Common__Sql_ETranslator__DateOnly__std__DayOfWeek
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateOnly__std__DayOfWeek);
#endif
