...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1

sealed class FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1(...) - clone");
#endif
 ...
 //-----------------------------------------------------------------------
 public FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1\n"
   +" (valueExpression: {0},\n"
   +"  ch1Expression  : {1})",
    valueExpression,
    ch1Expression);
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::VisitChildren";
  ...
  return new FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1
              (this.Name,
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("TRIM(LEADING ");
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__TRIM_START__ch1::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("TRIM(LEADING ");
