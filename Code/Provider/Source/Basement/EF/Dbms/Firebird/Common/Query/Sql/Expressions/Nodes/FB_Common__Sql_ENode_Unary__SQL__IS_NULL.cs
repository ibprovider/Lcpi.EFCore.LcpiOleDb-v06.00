...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Unary__SQL__IS_NULL

sealed class FB_Common__Sql_ENode_Unary__SQL__IS_NULL
 :SqlUnaryExpression
 ,FB_Common__Sql_ETag__RequiresBrackets
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Unary__SQL__IS_NULL;

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Unary__SQL__IS_NULL
 ...
 public static SqlUnaryExpression Create(SqlExpression sqlOperand)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Unary__SQL__IS_NULL::Create";
  ...
  //------------------------------------------------------------
  var r
   =new FB_Common__Sql_ENode_Unary__SQL__IS_NULL
     (sqlOperand,
 ...
 public override bool CanReduce
 {
  get
  {
   ...
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Unary__SQL__IS_NULL::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Unary__SQL__IS_NULL::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  //----------------------------------------
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Unary__SQL__IS_NULL::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Unary__SQL__IS_NULL::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("UNARY_IS_NULL(");
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Unary__SQL__IS_NULL::Helper__Accept__GenerateSql(...)");
#endif
  ...
  querySqlGenerator.Sql.Append(" IS NULL");
