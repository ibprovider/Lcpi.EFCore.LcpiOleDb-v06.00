...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__DayOfYear

sealed class FB_Common__Sql_ETranslator__DateTime__std__DayOfYear
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateTime__std__DayOfYear,
      new FB_Common__Sql_ETranslator__DateTime__std__DayOfYear());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__DayOfYear()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__DayOfYear
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateTime__std__DayOfYear);
#endif
