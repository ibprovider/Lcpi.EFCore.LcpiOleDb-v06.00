 ...
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__Boolean__String
  Instance
   =new Convert_Code__Boolean__String();

 //-----------------------------------------------------------------------
 private Convert_Code__Boolean__String()
 {
 }//Convert_Code__Boolean__String
 ...
 {
  return FB_CVT_CODE.Convert_Code__BOOLEAN__STRING.Exec(v);
 }//Exec
};//class Convert_Code__Boolean__String
