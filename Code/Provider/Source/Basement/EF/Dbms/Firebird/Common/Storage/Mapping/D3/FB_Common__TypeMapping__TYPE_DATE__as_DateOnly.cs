...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.Common.Storage.Mapping.D3{
////////////////////////////////////////////////////////////////////////////////
//using
...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__TYPE_DATE__as_DateOnly

sealed class FB_Common__TypeMapping__TYPE_DATE__as_DateOnly
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping_D3__TYPE_DATE__as_DateOnly;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__TYPE_DATE__as_DateOnly(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__TYPE_DATE__as_DateOnly::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__TYPE_DATE__as_DateOnly(parameters);
 }//Clone
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  System.DateOnly typedValue=(DateOnly)value;

  string resultStr;

  resultStr  ="date '";

  resultStr +=typedValue.ToString("yyyy-MM-dd",FB_Common__TypeMappingConfig.CvtCulture);
 ...
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__LcpiDataOleDb__OleDbDataReader__GetDateOnly,null));

  return Structure_MethodInfoCache.MethodInfoOf__LcpiDataOleDb__OleDbDataReader__GetDateOnly;
 }//GetDataReaderMethod
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.TYPE_DATE;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__TYPE_DATE__as_DateOnly
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__TYPE_DATE__as_DateOnly
