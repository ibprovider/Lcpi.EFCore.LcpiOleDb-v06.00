...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractYear

sealed class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractYear
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateOnly__ext__ExtractYear,
      new FB_Common__Sql_ETranslator__DateOnly__ext__ExtractYear());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateOnly__ext__ExtractYear()
 {
 }//FB_Common__Sql_ETranslator__DateOnly__ext__ExtractYear
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateOnly__ext__ExtractYear));
