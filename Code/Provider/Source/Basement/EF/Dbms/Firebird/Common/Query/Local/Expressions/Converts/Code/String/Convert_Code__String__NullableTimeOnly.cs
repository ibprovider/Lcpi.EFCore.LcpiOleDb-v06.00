...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__String__NullableTimeOnly

sealed class Convert_Code__String__NullableTimeOnly
 :Core.Core_ValueCvt<T_SOURCE       ,T_TARGET>
 ,Core.Core_ValueCvt<System.Object  ,T_TARGET>
{
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__String__NullableTimeOnly)
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__String__NullableTimeOnly
  Instance
   =new Convert_Code__String__NullableTimeOnly();

 //-----------------------------------------------------------------------
 private Convert_Code__String__NullableTimeOnly()
 {
 }//Convert_Code__String__NullableTimeOnly
 ...
 private static T_TARGET Exec(T_SOURCE v)
 {
  ...
  return FB_CVT_CODE.Convert_Code__STRING__TYPE_TIME_as_TimeOnly.Exec(v);
 }//Exec
};//class Convert_Code__String__NullableTimeOnly
