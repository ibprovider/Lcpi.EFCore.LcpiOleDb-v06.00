...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__OP_SUB

//
// ! \todo Field for improving. We may define and use exact tables with result data types.
//

sealed class FB_Common__Sql_ENode_Function__SQL__OP_SUB
 :FB_Common__Sql_ENode_Function
 ,FB_Common__Sql_ETag__RequiresBrackets
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__OP_SUB;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__OP_SUB
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::FB_Common__Sql_ENode_Function__SQL__OP_SUB(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::FB_Common__Sql_ENode_Function__SQL__OP_SUB\n"
   +" (leftExpression  : {0},\n"
   +"  rightExpression : {1})",
    leftExpression,
    rightExpression);
                                    ...
                                    RelationalTypeMapping resultTypeMapping)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__OP_SUB
          (leftExpression,
           rightExpression,
           resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__OP_SUB::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("SQL_OP_SUB(");
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_SUB::Helper__Accept__GenerateSql(...)");
#endif
