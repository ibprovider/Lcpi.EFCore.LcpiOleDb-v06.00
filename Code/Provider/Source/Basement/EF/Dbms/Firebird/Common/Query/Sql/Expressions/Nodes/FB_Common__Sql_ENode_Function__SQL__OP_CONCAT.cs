...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__OP_CONCAT

sealed class FB_Common__Sql_ENode_Function__SQL__OP_CONCAT
 :FB_Common__Sql_ENode_Function
 ,FB_Common__Sql_ETag__RequiresBrackets
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__OP_CONCAT;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__OP_CONCAT
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::FB_Common__Sql_ENode_Function__SQL__OP_CONCAT(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::FB_Common__Sql_ENode_Function__SQL__OP_CONCAT\n"
   +" (leftExpression  : {0},\n"
   +"  rightExpression : {1})",
    leftExpression,
    rightExpression);
                                    ...
                                    SqlExpression         rightExpression)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__OP_CONCAT
          (leftExpression,
           rightExpression);
 }//Create

 //FB_Common__Sql_ETag__RequiresBrackets interface -----------------------
 public bool RequiresBrackets(SqlExpression sqlParentExpression)
 {
  if(sqlParentExpression is FB_Common__Sql_ENode_Function__SQL__OP_CONCAT)
   return false;
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("SQL_OP_CONCAT(");
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_CONCAT::Helper__Accept__GenerateSql(...)");
#endif
