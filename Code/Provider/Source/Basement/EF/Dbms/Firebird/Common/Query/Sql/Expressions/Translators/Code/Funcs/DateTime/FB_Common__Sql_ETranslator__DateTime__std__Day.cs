...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__Day

sealed class FB_Common__Sql_ETranslator__DateTime__std__Day
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateTime__std__Day,
      new FB_Common__Sql_ETranslator__DateTime__std__Day());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__Day()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__Day
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateTime__std__Day);
#endif
