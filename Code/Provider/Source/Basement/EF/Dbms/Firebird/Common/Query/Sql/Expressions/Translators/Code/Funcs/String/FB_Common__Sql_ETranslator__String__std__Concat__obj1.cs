...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__std__Concat__obj1

sealed class FB_Common__Sql_ETranslator__String__std__Concat__obj1
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__std__Concat__obj1,
      new FB_Common__Sql_ETranslator__String__std__Concat__obj1());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__std__Concat__obj1()
 {
 }//FB_Common__Sql_ETranslator__String__std__Concat__obj1
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__std__Concat__obj1));
  ...
  var exprR
   =opData.SqlTreeNodeBuilder.Extension__MakeBinary__Concat__Throw
     (Common.FB_Common__Data.sm_SqlConstantExpression__VARCHAR___EMPTY,
      exprArg0);
