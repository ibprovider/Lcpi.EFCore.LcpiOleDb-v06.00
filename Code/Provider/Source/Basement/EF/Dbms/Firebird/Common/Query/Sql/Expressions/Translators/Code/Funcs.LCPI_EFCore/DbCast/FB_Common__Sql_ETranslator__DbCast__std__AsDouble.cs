...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DbCast__std__AsDouble

sealed class FB_Common__Sql_ETranslator__DbCast__std__AsDouble
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DbCast__std__AsDouble,
      new FB_Common__Sql_ETranslator__DbCast__std__AsDouble());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DbCast__std__AsDouble()
 {
 }//FB_Common__Sql_ETranslator__DbCast__std__AsDouble
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DbCast__std__AsDouble));
