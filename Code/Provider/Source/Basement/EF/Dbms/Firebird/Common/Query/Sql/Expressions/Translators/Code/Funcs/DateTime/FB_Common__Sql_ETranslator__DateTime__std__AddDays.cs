...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__AddDays

sealed class FB_Common__Sql_ETranslator__DateTime__std__AddDays
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateTime__std__AddDays,
      new FB_Common__Sql_ETranslator__DateTime__std__AddDays());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__AddDays()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__AddDays
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddDays));
  ...
  //----------------------------------------
  var exprScale
   =FB_Common__Data.sm_SqlConstantExpression__Int32__MillisecondsInDay;
