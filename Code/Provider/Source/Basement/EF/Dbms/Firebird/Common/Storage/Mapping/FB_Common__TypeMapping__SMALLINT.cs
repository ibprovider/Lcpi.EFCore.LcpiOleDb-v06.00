...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__SMALLINT

sealed class FB_Common__TypeMapping__SMALLINT
 :FB_Common__TypeMapping
 ,FB_Common__ITypeMapping__IsCompatiblyWithIdentity
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__SMALLINT;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__SMALLINT(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__SMALLINT::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__SMALLINT(parameters);
 }//Clone
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  System.Int16 typedValue=(System.Int16)value;
 ...
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetInt16,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetInt16;
 }//GetDataReaderMethod
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.SMALLINT;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__SMALLINT
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__SMALLINT
