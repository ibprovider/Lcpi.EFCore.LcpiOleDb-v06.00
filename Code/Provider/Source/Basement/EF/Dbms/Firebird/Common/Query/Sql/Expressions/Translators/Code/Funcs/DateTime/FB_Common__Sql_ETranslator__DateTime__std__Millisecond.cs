...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__Millisecond

sealed class FB_Common__Sql_ETranslator__DateTime__std__Millisecond
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__DateTime__std__Millisecond,
      new FB_Common__Sql_ETranslator__DateTime__std__Millisecond());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__Millisecond()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__Millisecond
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__DateTime__std__Millisecond);
#endif
