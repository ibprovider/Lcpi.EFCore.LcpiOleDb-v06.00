...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateTime__std__AddMinutes

sealed class FB_Common__Sql_ETranslator__DateTime__std__AddMinutes
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateTime__std__AddMinutes,
      new FB_Common__Sql_ETranslator__DateTime__std__AddMinutes());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateTime__std__AddMinutes()
 {
 }//FB_Common__Sql_ETranslator__DateTime__std__AddMinutes
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddMinutes));
