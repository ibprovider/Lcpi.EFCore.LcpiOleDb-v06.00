...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__CHAR1

sealed class FB_Common__TypeMapping__CHAR1
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__CHAR1;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__CHAR1(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 //-----------------------------------------------------------------------
 public static bool Is(string storeTypeNameBase,int length)
 {
  Debug.Assert(!Object.ReferenceEquals(storeTypeNameBase,null));

  if(!Structure_ADP.EqualDatabaseTypeName(storeTypeNameBase,c_StoreTypeNameBase))
   return false;
  ...
  return true;
 }//Is - storeTypeNameBase, length

 //-----------------------------------------------------------------------
 public static bool Is(Type clrType,string storeTypeNameBase,int length)
 {
  Debug.Assert(!Object.ReferenceEquals(clrType,null));
  Debug.Assert(!Object.ReferenceEquals(storeTypeNameBase,null));
  ...
  if(!Is(storeTypeNameBase,length))
   return false;

  return true;
 }//Is - clrType, storeTypeNameBase, length
 ...
 private static RelationalTypeMapping Helper__Create(string charsetName)
 {
  ...
  return new FB_Common__TypeMapping__CHAR1(parameters);
 }//Helper__Create
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__CHAR1::Clone(...)");
#endif
 ...
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetChar,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetChar;
 }//GetDataReaderMethod
 ...
 private static readonly RelationalTypeMapping
  sm_Instance_default
   =new FB_Common__TypeMapping__CHAR1
