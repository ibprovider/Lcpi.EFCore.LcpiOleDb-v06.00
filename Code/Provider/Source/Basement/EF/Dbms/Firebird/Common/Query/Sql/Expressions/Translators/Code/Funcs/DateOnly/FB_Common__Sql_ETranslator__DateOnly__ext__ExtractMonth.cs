...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractMonth

sealed class FB_Common__Sql_ETranslator__DateOnly__ext__ExtractMonth
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DateOnly__ext__ExtractMonth,
      new FB_Common__Sql_ETranslator__DateOnly__ext__ExtractMonth());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DateOnly__ext__ExtractMonth()
 {
 }//FB_Common__Sql_ETranslator__DateOnly__ext__ExtractMonth
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__DateOnly__ext__ExtractMonth));
