...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator_Op2__NotEqual

sealed class FB_Common__Sql_ETranslator_Op2__NotEqual
 :FB_Common__Sql_ETranslator_Op2
{
 public static readonly FB_Common__Sql_ETranslator_Op2
  Instance
   =new FB_Common__Sql_ETranslator_Op2__NotEqual();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator_Op2__NotEqual()
 {
 }//FB_Common__Sql_ETranslator_Op2__NotEqual

 //FB_Common__Sql_ETranslator_Op2 interface ------------------------------
 public override SqlExpression Translate(in tagOpData opData)
 {
  Debug.Assert(opData.OperationType==LcpiOleDb__ExpressionType.NotEqual);
  ...
  //------------------------------------------------------------
  var result
   =Nodes.FB_Common__Sql_ENode_Binary__NotEqual.Create
     (sqlLeft,
      sqlRight,
      resultTypeMapping);
