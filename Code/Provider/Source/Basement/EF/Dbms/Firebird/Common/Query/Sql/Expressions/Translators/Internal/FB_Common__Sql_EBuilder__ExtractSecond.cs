...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_EBuilder__ExtractSecond

static class FB_Common__Sql_EBuilder__ExtractSecond
{
 public static SqlExpression Exec(SqlExpression exprSource)
 {
  ...
  var nodeExtract
   =Nodes.FB_Common__Sql_ENode_Function__SQL__EXTRACT.Create__Second
     (exprSource);
