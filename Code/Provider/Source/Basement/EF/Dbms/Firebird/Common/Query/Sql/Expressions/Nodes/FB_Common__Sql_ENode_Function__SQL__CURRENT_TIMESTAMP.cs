...
sealed class FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP;

 //-----------------------------------------------------------------------
 private const int c_ArgCount=0;

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP(...) - clone");
#endif
 ...
 private FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP()
  :this("CURRENT_TIMESTAMP",
        ...
        Common.FB_Common__TypeMappingCache.TypeMapping__TIMESTAMP.ClrType,
        Common.FB_Common__TypeMappingCache.TypeMapping__TIMESTAMP)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP()");
#endif
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::VisitChildren\n"
   +" ({0})",
    visitor);
#endif
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("CURRENT_TIMESTAMP");
 }//Print
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CURRENT_TIMESTAMP::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("CURRENT_TIMESTAMP");
