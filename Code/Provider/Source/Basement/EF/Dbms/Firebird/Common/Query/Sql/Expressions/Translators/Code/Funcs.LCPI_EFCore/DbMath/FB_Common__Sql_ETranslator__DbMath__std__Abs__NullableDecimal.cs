...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DbMath__std__Abs__NullableDecimal

static class FB_Common__Sql_ETranslator__DbMath__std__Abs__NullableDecimal
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DbMath__std__Abs__NullableDecimal,
      Internal.FB_Common__Sql_ETranslator__SQL__ABS.Instance);
};//class FB_Common__Sql_ETranslator__DbMath__std__Abs__NullableDecimal
