...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__SQL__SIGN

sealed class FB_Common__Sql_ETranslator__SQL__SIGN
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall
  Instance
   =new FB_Common__Sql_ETranslator__SQL__SIGN();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__SQL__SIGN()
 {
 }//FB_Common__Sql_ETranslator__SQL__SIGN
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  //----------------------------------------
  return Nodes.FB_Common__Sql_ENode_Function__SQL__SIGN.Create
          (exprArg0);
 }//Translate
};//class FB_Common__Sql_ETranslator__SQL__SIGN
