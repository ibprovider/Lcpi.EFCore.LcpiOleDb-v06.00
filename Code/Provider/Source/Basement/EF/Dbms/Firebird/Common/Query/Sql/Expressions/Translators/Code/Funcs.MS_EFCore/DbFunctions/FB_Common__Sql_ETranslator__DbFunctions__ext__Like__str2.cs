...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DbFunctions__ext__Like__str2

sealed class FB_Common__Sql_ETranslator__DbFunctions__ext__Like__str2
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__MS_EFCore__DbFunctions__ext__Like__match_pattern,
      new FB_Common__Sql_ETranslator__DbFunctions__ext__Like__str2());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__DbFunctions__ext__Like__str2()
 {
 }//FB_Common__Sql_ETranslator__DbFunctions__ext__Like__str2
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__MS_EFCore__DbFunctions__ext__Like__match_pattern));
  ...
  //----------------------------------------
  var result
   =Nodes.FB_Common__Sql_ENode_Function__SQL__LIKE.Create
     (exprMatch,
      exprPattern);
