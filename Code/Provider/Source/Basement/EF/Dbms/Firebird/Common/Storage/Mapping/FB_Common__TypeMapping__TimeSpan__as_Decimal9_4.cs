...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__TimeSpan__as_Decimal9_4

// Mapping of System.TimeSpan to NUMERIC(9,4)

sealed class FB_Common__TypeMapping__TimeSpan__as_Decimal9_4
 :FB_Common__TypeMapping
 ,LcpiOleDb__IGetUnderlyingTypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__TimeSpan__as_Decimal9_4;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__TimeSpan__as_Decimal9_4(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__TimeSpan__as_Decimal9_4::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__TimeSpan__as_Decimal9_4(parameters);
 }//Clone
 ...
 private static RelationalTypeMappingParameters Helper__CreateDefaultRTMP()
 {
  ...
  var CTMP
   =new CoreTypeMappingParameters
     (/*clrType*/              sm_ClrType,
      /*converter*/            ValueConversion.FB_Common__ValueConversion__TimeSpanToDecimal9_4.Instance,
      /*comparer*/             null,
      /*keyComparer*/          null,
 ...
 private static readonly RelationalTypeMapping
  sm_UnderlyingTypeMapping
   =FB_Common__TypeMappingCache.TypeMapping__NUMERIC_9_4;

 //-----------------------------------------------------------------------
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__TimeSpan__as_Decimal9_4
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__TimeSpan__as_Decimal9_4
