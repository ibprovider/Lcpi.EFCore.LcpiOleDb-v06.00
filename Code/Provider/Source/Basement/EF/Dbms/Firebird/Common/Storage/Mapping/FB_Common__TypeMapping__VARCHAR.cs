...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__VARCHAR

sealed class FB_Common__TypeMapping__VARCHAR
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__VARCHAR;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__VARCHAR(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Helper__Create
                                           (int    length,
                                            string charsetName)
 {
  var parameters
  ...
  return new FB_Common__TypeMapping__VARCHAR(parameters);
 }//Helper__Create
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__VARCHAR::Clone(...)");
#endif
