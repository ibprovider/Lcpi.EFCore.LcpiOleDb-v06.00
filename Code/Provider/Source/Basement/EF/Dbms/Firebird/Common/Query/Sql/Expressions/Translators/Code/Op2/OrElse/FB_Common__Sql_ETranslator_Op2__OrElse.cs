...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator_Op2__OrElse

sealed class FB_Common__Sql_ETranslator_Op2__OrElse
 :FB_Common__Sql_ETranslator_Op2
{
 public static readonly FB_Common__Sql_ETranslator_Op2
  Instance
   =new FB_Common__Sql_ETranslator_Op2__OrElse();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator_Op2__OrElse()
 {
 }//FB_Common__Sql_ETranslator_Op2__OrElse

 //FB_Common__Sql_ETranslator_Op2 interface ------------------------------
 public override SqlExpression Translate(in tagOpData opData)
 {
#if DEBUG
  if(opData.OperationType==LcpiOleDb__ExpressionType.OrElse)
  {
   //OK
  }
  else
  if(opData.OperationType==LcpiOleDb__ExpressionType.Or)
  {
  ...
  //------------------------------------------------------------
  var r
   =Nodes.FB_Common__Sql_ENode_Binary__OrElse.Create
     (opData.SqlLeft,
      opData.SqlRight,
