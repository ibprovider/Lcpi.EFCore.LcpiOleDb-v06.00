...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__std__Replace__str

sealed class FB_Common__Sql_ETranslator__String__std__Replace__str
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__std__Replace__str_str,
      new FB_Common__Sql_ETranslator__String__std__Replace__str());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__std__Replace__str()
 {
 }//FB_Common__Sql_ETranslator__String__std__Replace__str
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__std__Replace__str_str));
