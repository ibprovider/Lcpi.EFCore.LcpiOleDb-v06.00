...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__ROUND

sealed class FB_Common__Sql_ENode_Function__SQL__ROUND
 :FB_Common__Sql_ENode_Function
 ,Tags.FB_Common__Sql_ETag__ReturnsIntegerNumber
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__ROUND;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__ROUND
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__ROUND::FB_Common__Sql_ENode_Function__SQL__ROUND(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__ROUND::FB_Common__Sql_ENode_Function__SQL__ROUND\n"
   +" (valueExpression  : {0},\n"
   +"  resultType       : {1})",
    valueExpression,
    resultTypeMapping.ClrType);
...
//-----------------------------------------------------------------------
 public static SqlExpression Create(SqlExpression valueExpression)
 {
  ...
  if(valueExpression is FB_Common__Sql_ENode_Function__SQL__ROUND e)
  {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__ROUND
              (valueExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__ROUND::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__ROUND::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__ROUND::VisitChildren";
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__ROUND::Print(...)");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__ROUND::Helper__Accept__GenerateSql(...)");
#endif
                                           ...
                                           (SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__ROUND::Helper__BuildResultTypeMapping";
