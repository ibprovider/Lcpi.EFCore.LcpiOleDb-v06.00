...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__std__IsNullOrWhiteSpace

sealed class FB_Common__Sql_ETranslator__String__std__IsNullOrWhiteSpace
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__std__IsNullOrWhiteSpace,
      new FB_Common__Sql_ETranslator__String__std__IsNullOrWhiteSpace());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__std__IsNullOrWhiteSpace()
 {
 }//FB_Common__Sql_ETranslator__String__std__IsNullOrWhiteSpace
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__std__IsNullOrWhiteSpace));
  ...
  //----------------------------------------
  var expr3_trim
   =new Nodes.FB_Common__Sql_ENode_Function__SQL__TRIM
     (exprArg0);
