...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__OP_DIV

//
// ! \todo Field for improving. We may define and use exact tables with result data types.
//

sealed class FB_Common__Sql_ENode_Function__SQL__OP_DIV
 :FB_Common__Sql_ENode_Function
 ,FB_Common__Sql_ETag__RequiresBrackets
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__OP_DIV;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__OP_DIV
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::FB_Common__Sql_ENode_Function__SQL__OP_DIV(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::FB_Common__Sql_ENode_Function__SQL__OP_DIV\n"
   +" (leftExpression  : {0},\n"
   +"  rightExpression : {1})",
    leftExpression,
    rightExpression);
                                    ...
                                    RelationalTypeMapping resultTypeMapping)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__OP_DIV
          (leftExpression,
           rightExpression,
           resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__OP_DIV::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("SQL_OP_DIV(");
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__OP_DIV::Helper__Accept__GenerateSql(...)");
#endif
