...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__DbMath__std__Truncate__NullableDecimal

static class FB_Common__Sql_ETranslator__DbMath__std__Truncate__NullableDecimal
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__DbMath__std__Truncate__NullableDecimal,
      Internal.FB_Common__Sql_ETranslator__SQL__TRUNC.Instance);
};//class FB_Common__Sql_ETranslator__DbMath__std__Truncate__NullableDecimal
