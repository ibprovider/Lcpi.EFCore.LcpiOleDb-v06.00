...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__String__std__TrimEnd__chars

sealed class FB_Common__Sql_ETranslator__String__std__TrimEnd__chars
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__String__std__TrimEnd__chars,
      new FB_Common__Sql_ETranslator__String__std__TrimEnd__chars());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__String__std__TrimEnd__chars()
 {
 }//FB_Common__Sql_ETranslator__String__std__TrimEnd__chars
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId.Equals(Structure_MethodInfoCache.MethodInfoOf__String__std__TrimEnd__chars));
                                                           ...
                                                           SqlExpression ch1)
 {
  ...
  return new Nodes.FB_Common__Sql_ENode_Function__SQL__TRIM_END__ch1
          (value,
           ch1);
