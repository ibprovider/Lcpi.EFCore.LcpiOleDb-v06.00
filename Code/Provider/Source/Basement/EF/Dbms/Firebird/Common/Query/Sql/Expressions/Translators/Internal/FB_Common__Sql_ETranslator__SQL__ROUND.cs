...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__SQL__ROUND

sealed class FB_Common__Sql_ETranslator__SQL__ROUND
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall
  Instance
   =new FB_Common__Sql_ETranslator__SQL__ROUND();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__SQL__ROUND()
 {
 }//FB_Common__Sql_ETranslator__SQL__ROUND
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  //----------------------------------------
  return Nodes.FB_Common__Sql_ENode_Function__SQL__ROUND.Create
          (exprArg0);
 }//Translate
};//class FB_Common__Sql_ETranslator__SQL__ROUND
