...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH

sealed class FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH;
 ...
 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH\n"
   +" (valueExpression: {0})",
    valueExpression);
#endif
 ...
 public static SqlExpression Create(SqlExpression valueExpression)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH
          (valueExpression,
           resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::VisitChildren";
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("CHARACTER_LENGTH(");
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__CHARACTER_LENGTH::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("CHARACTER_LENGTH(");
