...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__CHAR

sealed class FB_Common__TypeMapping__CHAR
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__CHAR;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__CHAR(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
                                            ...
                                            string                       charsetName)
 {
  ...
  return new FB_Common__TypeMapping__CHAR(parameters);
 }//Create - mappingInfo
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__CHAR::Clone(...)");
#endif
