...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__INTEGER

sealed class FB_Common__TypeMapping__INTEGER
 :FB_Common__TypeMapping
 ,FB_Common__ITypeMapping__IsCompatiblyWithIdentity
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__INTEGER;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__INTEGER(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__INTEGER::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__INTEGER(parameters);
 }//Clone
 ...
 protected override string GenerateNonNullSqlLiteral(object value)
 {
  ...
  System.Int32 typedValue=(Int32)value;
 ...
 {
  Debug.Assert(!Object.ReferenceEquals(Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetInt32,null));

  return Structure_MethodInfoCache.MethodInfoOf__SystemDataCommon__DbDataReader__GetInt32;
 }//GetDataReaderMethod
 ...
 private const string c_StoreTypeNameBase
  =FB_Common__SqlDataTypeNames.INTEGER;
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
  =new FB_Common__TypeMapping__INTEGER
    (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__INTEGER
