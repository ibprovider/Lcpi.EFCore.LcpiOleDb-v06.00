...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__CHAR__as_chars

sealed class FB_Common__TypeMapping__CHAR__as_chars
 :FB_Common__TypeMapping
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__CHAR__as_chars;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__CHAR__as_chars(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
                                            ...
                                            string                       charsetName)
 {
  ...
  return new FB_Common__TypeMapping__CHAR__as_chars(parameters);
 }//Create - mappingInfo
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__CHAR__as_chars::Clone(...)");
#endif
