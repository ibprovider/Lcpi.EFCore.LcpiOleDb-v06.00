...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__TimeOnly__std__Minute

sealed class FB_Common__Sql_ETranslator__TimeOnly__std__Minute
 ...
 public static readonly FB_Common__Sql_ETranslator_Member.tagDescr
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Minute,
      new FB_Common__Sql_ETranslator__TimeOnly__std__Minute());

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__TimeOnly__std__Minute()
 {
 }//FB_Common__Sql_ETranslator__TimeOnly__std__Minute
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Minute);
#endif
