...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__TypeMapping__BLOB_BINARY

sealed class FB_Common__TypeMapping__BLOB_BINARY
 :FB_Common__TypeMapping
 ,FB_Common__ITypeMapping__BLOB
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__TypeMapping__BLOB_BINARY;

 //-----------------------------------------------------------------------
 private FB_Common__TypeMapping__BLOB_BINARY(in RelationalTypeMappingParameters parameters)
  :base(parameters)
 {
 }
 ...
 protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__TypeMapping__BLOB_BINARY::Clone(...)");
#endif
  ...
  return new FB_Common__TypeMapping__BLOB_BINARY(parameters);
 }//Clone
 ...
 //-----------------------------------------------------------------------
 private const string c_StoreTypeName
  =c_StoreTypeNameBase+" SUB_TYPE BINARY";
 ...
 private static readonly RelationalTypeMapping
  sm_Instance
   =new FB_Common__TypeMapping__BLOB_BINARY
     (Helper__CreateDefaultRTMP());
};//class FB_Common__TypeMapping__BLOB_BINARY
