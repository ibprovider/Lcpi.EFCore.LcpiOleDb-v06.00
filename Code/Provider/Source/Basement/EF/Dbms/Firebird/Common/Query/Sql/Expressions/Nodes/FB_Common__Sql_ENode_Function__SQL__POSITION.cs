...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ENode_Function__SQL__POSITION

sealed class FB_Common__Sql_ENode_Function__SQL__POSITION
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_Common__Sql_ENode_Function__SQL__POSITION;
 ...
 private const int c_ArgIdx__seek=1;

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ENode_Function__SQL__POSITION
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__POSITION::FB_Common__Sql_ENode_Function__SQL__POSITION(...) - clone");
#endif
 ...
 private FB_Common__Sql_ENode_Function__SQL__POSITION
                                           (SqlExpression valueExpression,
                                            SqlExpression seekExpression)
  :this("POSITION",
        new[]{valueExpression,seekExpression},
        FB_Common__TypeMappingCache.TypeMapping__INT32.ClrType,
        FB_Common__TypeMappingCache.TypeMapping__INT32)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__POSITION::FB_Common__Sql_ENode_Function__SQL__POSITION\n"
   +" (valueExpression: {0},\n"
   +"  fromExpression : {1})",
    valueExpression,
    seekExpression);
  ...
  Debug.Assert(!Object.ReferenceEquals(seekExpression,null));
  ...
  Debug.Assert(Object.ReferenceEquals(this.Arguments[c_ArgIdx__seek],seekExpression));
 }//FB_Common__Sql_ENode_Function__SQL__POSITION
                                    ...
                                    SqlExpression seekExpression)
 {
  ...
  return new FB_Common__Sql_ENode_Function__SQL__POSITION
          (valueExpression,
           seekExpression);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_Common__Sql_ENode_Function__SQL__POSITION::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_Common__Sql_ENode_Function__SQL__POSITION::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_Common__Sql_ENode_Function__SQL__POSITION::VisitChildren";
  ...
  Expression newSeekExpression_e  = visitor.Visit(this.Arguments[c_ArgIdx__seek]);
  ...
  Debug.Assert(!Object.ReferenceEquals(newSeekExpression,null));
  ...
  for(;;)
  {
   ...
   if(newSeekExpression!=this.Arguments[c_ArgIdx__seek])
    break;
  ...
  return new FB_Common__Sql_ENode_Function__SQL__POSITION
              (this.Name,
               new[]{newValueExpression,newSeekExpression},
               this.Type,
               this.TypeMapping);
 }//VisitChildren
                                              ...
                                              IReadOnlyList<SqlExpression> arguments)
 {
  ...
  Debug.Assert(c_ArgIdx__seek==1);

  Check.Arg_NotNull
   (c_ErrSrcID,
    nameof(Update),
    nameof(arguments)+"[1]",
    arguments[c_ArgIdx__seek]);
  ...
  for(;;)
  {
   ...
   if(!Object.ReferenceEquals(this.Arguments[c_ArgIdx__seek],arguments[c_ArgIdx__seek]))
    break;
 ...
 protected override void Print(ExpressionPrinter expressionPrinter)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__POSITION::Print(...)");
#endif
  ...
  //------------------------------------------------------------
  expressionPrinter.Append("POSITION(");
  expressionPrinter.Visit(this.Arguments[c_ArgIdx__seek]);
 ...
 private Expression Helper__Accept__GenerateSql(Sql.FB_Common__QuerySqlGenerator querySqlGenerator)
 {
#if TRACE
  Core.Core_Trace.Method
   ("FB_Common__Sql_ENode_Function__SQL__POSITION::Helper__Accept__GenerateSql(...)");
#endif
  ...
  //------------------------------------------------------------
  querySqlGenerator.Sql.Append("POSITION(");

  querySqlGenerator.Visit(this.Arguments[c_ArgIdx__seek]);
 ...
 private void DEBUG__CheckState()
 {
  ...
  Debug.Assert(!Object.ReferenceEquals(this.Arguments[c_ArgIdx__seek],null));
 }//DEBUG__CheckState
#endif
