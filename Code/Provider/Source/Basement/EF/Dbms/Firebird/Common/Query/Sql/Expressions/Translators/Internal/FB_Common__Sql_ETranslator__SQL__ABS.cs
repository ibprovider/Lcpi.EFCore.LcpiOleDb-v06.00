...
////////////////////////////////////////////////////////////////////////////////
//class FB_Common__Sql_ETranslator__SQL__ABS

sealed class FB_Common__Sql_ETranslator__SQL__ABS
 :FB_Common__Sql_ETranslator_MethodCall
{
 public static readonly FB_Common__Sql_ETranslator_MethodCall
  Instance
   =new FB_Common__Sql_ETranslator__SQL__ABS();

 //-----------------------------------------------------------------------
 private FB_Common__Sql_ETranslator__SQL__ABS()
 {
 }//FB_Common__Sql_ETranslator__SQL__ABS
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(!Object.ReferenceEquals(exprArg0.TypeMapping.ClrType,null));

  //----------------------------------------
  return Nodes.FB_Common__Sql_ENode_Function__SQL__ABS.Create
          (exprArg0);
 }//Translate
};//class FB_Common__Sql_ETranslator__SQL__ABS
