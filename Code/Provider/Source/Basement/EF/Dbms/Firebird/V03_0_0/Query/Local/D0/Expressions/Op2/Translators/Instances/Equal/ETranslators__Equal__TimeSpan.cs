...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__Equal__TimeSpan

static class ETranslators__Equal__TimeSpan
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__TimeSpan
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___TimeSpan__TimeSpan.MethodInfo_V_V),
      Code.Op2_Code__Equal___TimeSpan__TimeSpan.Instance);

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableTimeSpan
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___TimeSpan__NullableTimeSpan.MethodInfo_V_V),
      Code.Op2_Code__Equal___TimeSpan__NullableTimeSpan.Instance);
};//class ETranslators__Equal__TimeSpan
