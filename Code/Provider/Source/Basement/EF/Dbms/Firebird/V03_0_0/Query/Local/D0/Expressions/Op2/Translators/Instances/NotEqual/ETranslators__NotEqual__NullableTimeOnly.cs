...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__NotEqual__NullableTimeOnly

static class ETranslators__NotEqual__NullableTimeOnly
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__TimeOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___NullableTimeOnly__TimeOnly.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___NullableTimeOnly__TimeOnly.Instance);

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableTimeOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___NullableTimeOnly__NullableTimeOnly.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___NullableTimeOnly__NullableTimeOnly.Instance);
};//class ETranslators__NotEqual__NullableTimeOnly
