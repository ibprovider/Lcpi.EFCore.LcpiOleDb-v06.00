...
////////////////////////////////////////////////////////////////////////////////
//class SSCode_Unary_Convert__CastAs__FloatToDecimal

sealed class SSCode_Unary_Convert__CastAs__FloatToDecimal
 :FB_Common__Sql_ENode_Unary__Convert.SSCode
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D3__Sql_ENode__SSCode_Unary_Convert__CastAs__FloatToDecimal;

 //-----------------------------------------------------------------------
 public static readonly FB_Common__Sql_ENode_Unary__Convert.SSCode
  Instance
   =new SSCode_Unary_Convert__CastAs__FloatToDecimal();

 //-----------------------------------------------------------------------
 private SSCode_Unary_Convert__CastAs__FloatToDecimal()
 {
 }//SSCode_Unary_Convert__CastAs__FloatToDecimal
                                  ...
                                  FB_Common__Sql_ENode_Unary__Convert sqlNode)
 {
  ...
  Debug.Assert(sqlNode.Operand.TypeMapping.DbType==DbType.Single ||
               sqlNode.Operand.TypeMapping.DbType==DbType.Double);
