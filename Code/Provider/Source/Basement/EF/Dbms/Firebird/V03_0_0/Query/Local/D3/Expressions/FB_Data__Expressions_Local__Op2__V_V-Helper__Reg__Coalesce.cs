...
{
 private static LcpiOleDb__LocalEval_Op2__Map Helper__Reg__Coalesce(LcpiOleDb__LocalEval_Op2__Map Map)
 {
  Debug.Assert(!Object.ReferenceEquals(Map,null));

  Map
   .Reg(LcpiOleDb__ExpressionType.Coalesce)

   .Add(Common_ETRS.ETranslators__Coalesce__NullableBoolean.sm_Instance__NullableBoolean)
