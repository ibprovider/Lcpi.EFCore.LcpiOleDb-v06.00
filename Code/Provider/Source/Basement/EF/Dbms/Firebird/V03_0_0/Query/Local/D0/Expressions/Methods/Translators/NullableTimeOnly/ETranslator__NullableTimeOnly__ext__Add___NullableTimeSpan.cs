...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeOnly__ext__Add___NullableTimeSpan

sealed class ETranslator__NullableTimeOnly__ext__Add___NullableTimeSpan
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableTimeOnly__ext__Add___NullableTimeSpan();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeOnly__ext__Add___NullableTimeSpan()
  :base(Structure_MethodIdCache.MethodIdOf__NullableTimeOnly__ext__Add___NullableTimeSpan)
 {
 }//ETranslator__NullableTimeOnly__ext__Add___NullableTimeSpan
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableTimeOnly__ext__Add___NullableTimeSpan);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__NullableTimeOnly__Add___NullableTimeSpan.MethodInfo,
      node_Arg0,
      node_Arg1);
