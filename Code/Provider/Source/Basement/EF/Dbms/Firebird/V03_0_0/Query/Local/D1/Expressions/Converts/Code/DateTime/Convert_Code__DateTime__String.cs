...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Query.Local.D1.Expressions.Converts.Code{
////////////////////////////////////////////////////////////////////////////////
 ...
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 ...
 {
  return FB_CVT_CODE.Convert_Code__TIMESTAMP__STRING___D1.Exec(v);
 }//Exec
};//class Convert_Code__DateTime__String
