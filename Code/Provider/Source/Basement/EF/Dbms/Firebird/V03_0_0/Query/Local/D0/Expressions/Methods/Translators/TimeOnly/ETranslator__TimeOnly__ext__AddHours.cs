...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeOnly__ext__AddHours

sealed class ETranslator__TimeOnly__ext__AddHours
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__TimeOnly__ext__AddHours();

 //-----------------------------------------------------------------------
 private ETranslator__TimeOnly__ext__AddHours()
  :base(Structure_MethodIdCache.MethodIdOf__TimeOnly__ext__AddHours)
 {
 }//ETranslator__TimeOnly__ext__AddHours
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__TimeOnly__ext__AddHours);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__TimeOnly__AddHours___NullableDouble.MethodInfo,
      node_Arg0,
      node_Arg1);
