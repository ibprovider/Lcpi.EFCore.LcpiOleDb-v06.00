...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__NotEqual___NullableDateTime__DateTime

sealed class Op2_Code__NotEqual___NullableDateTime__DateTime
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__NotEqual___NullableDateTime__DateTime
  Instance
   =new Op2_Code__NotEqual___NullableDateTime__DateTime();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__NotEqual___NullableDateTime__DateTime)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__NotEqual___NullableDateTime__DateTime()
 {
 }//Op2_Code__NotEqual___NullableDateTime__DateTime
