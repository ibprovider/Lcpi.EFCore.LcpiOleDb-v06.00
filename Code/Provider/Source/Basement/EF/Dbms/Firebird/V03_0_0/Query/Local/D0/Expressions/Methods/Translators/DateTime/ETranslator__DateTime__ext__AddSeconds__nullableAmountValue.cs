...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__ext__AddSeconds__nullableAmountValue

sealed class ETranslator__DateTime__ext__AddSeconds__nullableAmountValue
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__ext__AddSeconds__nullableAmountValue();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__ext__AddSeconds__nullableAmountValue()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__ext__AddSeconds)
 {
 }//ETranslator__DateTime__ext__AddSeconds__nullableAmountValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__ext__AddSeconds);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddSeconds__nullableAmountValue.MethodInfo,
          node_Arg0,
          node_Arg1);
