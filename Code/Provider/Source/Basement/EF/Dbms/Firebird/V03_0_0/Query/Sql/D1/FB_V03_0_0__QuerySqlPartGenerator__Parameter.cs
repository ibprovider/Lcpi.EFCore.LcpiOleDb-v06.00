 ...
 :Firebird.Common.Query.Sql.FB_Common__IQuerySqlPartGenerator__Parameter
{
 ...
 private static bool Helper__CanCastParam(SqlParameterExpression sqlParameterExpression)
 {
  ...
  {
   //No way for first dialect

   return false;
  }//if

  if(clearClrType==Structure_TypeCache.TypeOf__System_TimeOnly)
  {
   //No way for first dialect
  ...
  //
  // [2021-09-29] TimeSpan now processed as NUMERIC(9,4)
  //
  // if(clearClrType==Structure_TypeCache.TypeOf__System_TimeSpan)
  // {
  //  return false;
  // }//if
 ...
 private static string Helper__GetTargetSqlTypeName(SqlParameterExpression sqlParameterExpression)
 {
  ...
  if(clearClrType==Structure_TypeCache.TypeOf__System_Int64)
   return FB_V03_0_0__Consts.c_TypeOf_BIGINT_D1;
