...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__GreaterThanOrEqual__NullableTimeOnly

static class ETranslators__GreaterThanOrEqual__NullableTimeOnly
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__TimeOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThanOrEqual___NullableTimeOnly__TimeOnly.MethodInfo_V_V));

 //----------------------------------------- NULLABLE
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableTimeOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThanOrEqual___NullableTimeOnly__NullableTimeOnly.MethodInfo_V_V));
};//class ETranslators__GreaterThanOrEqual__NullableTimeOnly
