...
sealed partial class FB_V03_0_0__DataFor_BinaryOperatorTranslatorProvider
{
 private static void Helper__Reg__Divide(tagOp2Set op2Set)
 {
  ...
  op2Set
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int16     ,Structure_TypeCache.TypeOf__System_Int16     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int16     ,Structure_TypeCache.TypeOf__System_Int32     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int16     ,Structure_TypeCache.TypeOf__System_Int64     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int16     ,Structure_TypeCache.TypeOf__System_Decimal   ,sm_TD__Divide__Double___ByForce)
   ...
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int32     ,Structure_TypeCache.TypeOf__System_Int16     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int32     ,Structure_TypeCache.TypeOf__System_Int32     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int32     ,Structure_TypeCache.TypeOf__System_Int64     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int32     ,Structure_TypeCache.TypeOf__System_Decimal   ,sm_TD__Divide__Double___ByForce)
   ...
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int64     ,Structure_TypeCache.TypeOf__System_Int16     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int64     ,Structure_TypeCache.TypeOf__System_Int32     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int64     ,Structure_TypeCache.TypeOf__System_Int64     ,sm_TD__Divide__Int64)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Int64     ,Structure_TypeCache.TypeOf__System_Decimal   ,sm_TD__Divide__Double___ByForce)
   ...
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Decimal   ,Structure_TypeCache.TypeOf__System_Single    ,sm_TD__Divide__Double)
   .Add(LcpiOleDb__ExpressionType.Divide       ,Structure_TypeCache.TypeOf__System_Decimal   ,Structure_TypeCache.TypeOf__System_Double    ,sm_TD__Divide__Double)
