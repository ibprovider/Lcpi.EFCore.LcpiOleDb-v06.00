...
partial class FB_V03_0_0__MigrationsSqlGenerator
{
                                  ...
                                  MigrationCommandListBuilder builder)
 {
  const string c_methodSign
   =nameof(Generate)+"("+nameof(CreateSequenceOperation)+"...)";
  ...
  try // [catch]
  {
   ...
   m_MigrationsSvc__GenerateCreateSequence.GenerateCreateSequence
    (this.Dependencies,
     operation,
     model,
     builder);
  ...
  catch(Exception e)
  {
   ...
   exc.add_error
    (lcpi.lib.com.HResultCode.E_FAIL,
     c_ErrSrcID,
     ErrMessageID.msql_gen_err__failed_to_generate_create_sequence_statement__1);
