...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__AddMilliseconds

sealed class ETranslator__DateTime__std__AddMilliseconds
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__std__AddMilliseconds();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__AddMilliseconds()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__std__AddMilliseconds)
 {
 }//ETranslator__DateTime__std__AddMilliseconds
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddMilliseconds);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddMilliseconds.MethodInfo,
          node_Object,
          node_Arg0);
