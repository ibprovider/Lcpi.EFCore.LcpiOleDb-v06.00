...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Query.Sql.D1.Expressions.Nodes{
////////////////////////////////////////////////////////////////////////////////
//using
...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG

sealed class FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG;

 //-----------------------------------------------------------------------
 private const string c_FuncName="AVG";
 ...
 //-----------------------------------------------------------------------
 private FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG\n"
   +" (valueExpression  : {0},\n"
   +"  resultType       : {1})",
    valueExpression,
    resultTypeMapping.ClrType);
...
//-----------------------------------------------------------------------
 public static SqlExpression Create(SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  if(valueExpression is FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG e)
  {
#if DEBUG
   e.DEBUG__CheckState();
#endif
  ...
  return new FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG
              (valueExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::VisitChildren";
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::Print(...)");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::Helper__Accept__GenerateSql(...)");
#endif
                                           ...
                                           (SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__Sql_ENode_Function__SQL__AVG::Helper__BuildResultTypeMapping";
 ...
 private static RelationalTypeMapping Helper__GetResultTypeMapping__Decimal(SqlExpression sqlArg)
 {
  ...
  if(!sqlArgTypeMapping.Precision.HasValue)
  {
   ...
   return
    Common.Storage.Mapping.FB_Common__TypeMapping__NUMERIC.Create
     (/*precision*/Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int32,
      /*scale*/0);
  }//if

  Debug.Assert(sqlArgTypeMapping.Precision.HasValue);

  if(sqlArgTypeMapping.Precision.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int16)
  {
   //Based on SMALLINT
   ...
   if(!sqlArgTypeMapping.Scale.HasValue)
   {
    return
     Common.Storage.Mapping.FB_Common__TypeMapping__NUMERIC.Create
      (/*precision*/Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int16,
       /*scale*/0);
   }//if

   Debug.Assert(sqlArgTypeMapping.Scale.HasValue);
   Debug.Assert(sqlArgTypeMapping.Scale.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int16);
  ...
  if(sqlArgTypeMapping.Precision.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int32)
  {
   //Based on INTEGER
   ...
   Debug.Assert(sqlArgTypeMapping.Scale.HasValue);
   Debug.Assert(sqlArgTypeMapping.Scale.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int32);
  ...
  Debug.Assert(sqlArgTypeMapping.Precision.HasValue);
  Debug.Assert(sqlArgTypeMapping.Precision.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int64);

  if(!sqlArgTypeMapping.Scale.HasValue)
  {
   return
    Common.Storage.Mapping.FB_Common__TypeMapping__NUMERIC.Create
     (/*precision*/Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int64,
      /*scale*/0);
  }//if

  Debug.Assert(sqlArgTypeMapping.Scale.HasValue);
  Debug.Assert(sqlArgTypeMapping.Scale.Value<=Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int64);
