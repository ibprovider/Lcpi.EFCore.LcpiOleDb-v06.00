...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeOnly__ext__AddMinutes

sealed class ETranslator__TimeOnly__ext__AddMinutes
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__TimeOnly__ext__AddMinutes();

 //-----------------------------------------------------------------------
 private ETranslator__TimeOnly__ext__AddMinutes()
  :base(Structure_MethodIdCache.MethodIdOf__TimeOnly__ext__AddMinutes)
 {
 }//ETranslator__TimeOnly__ext__AddMinutes
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__TimeOnly__ext__AddMinutes);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__TimeOnly__AddMinutes___NullableDouble.MethodInfo,
      node_Arg0,
      node_Arg1);
