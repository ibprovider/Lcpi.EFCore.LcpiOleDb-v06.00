...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Storage.D3{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D3__TypeMappingSource
 ...
 :FB_V03_0_0__TypeMappingSource__Base
{
 ...
 //-----------------------------------------------------------------------
 public FB_V03_0_0_D3__TypeMappingSource(TypeMappingSourceDependencies           dependencies,
                         ...
                         in RelationalTypeMappingInfo mappingInfo)
 {
  const string c_bugcheck_src
   ="FB_V03_0_0_D3__TypeMappingSource::Internal__FindMapping__ByStoreDataTypeInfo";
 ...
 //Selector methods ------------------------------------------------------
 private static RelationalTypeMapping Helper__Select__BLOB__SUBTYPE_TEXT
                        (in T_FB_DATATYPE_DESCR       storeDataTypeInfo,
                         in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Helper__Select__CHAR
                        (in T_FB_DATATYPE_DESCR       storeDataTypeInfo,
                         in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Helper__Select__VARCHAR
                        (in T_FB_DATATYPE_DESCR       storeDataTypeInfo,
                         in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //Factory methods -------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BIGINT
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BINARY
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BLOB_BINARY
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BLOB_TEXT
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BLOB_TEXT__as_chars
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__BOOLEAN
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__CHAR
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__CHAR__as_chars
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__CHAR1
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__DECIMAL
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__DOUBLE
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__FLOAT
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__GUID__as_bytes
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__INTEGER
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__NUMERIC
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__SMALLINT
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__TimeSpan__as_Decimal18_4
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
  return Common.Storage.Mapping.FB_Common__TypeMapping__TimeSpan__as_Decimal18_4.Create(mappingInfo);
 }//Internal__GetTypeMapping__TimeSpan__as_Decimal18_4

 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__TIMESTAMP
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__VARBINARY
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__VARCHAR
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__VARCHAR__as_chars
                                           (in RelationalTypeMappingInfo mappingInfo,
                                            string                       charsetName)
 {
 ...
 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__TYPE_DATE__as_DateOnly
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
  return Common.Storage.Mapping.D3.FB_Common__TypeMapping__TYPE_DATE__as_DateOnly.Create(mappingInfo);
 }//Internal__GetTypeMapping__TYPE_DATE__as_DateOnly

 //-----------------------------------------------------------------------
 private static RelationalTypeMapping Internal__GetTypeMapping__TYPE_TIME__as_TimeOnly
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
  return Common.Storage.Mapping.D3.FB_Common__TypeMapping__TYPE_TIME__as_TimeOnly.Create(mappingInfo);
