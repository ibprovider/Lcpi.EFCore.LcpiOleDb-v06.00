...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__ext__AddMinutes

sealed class ETranslator__NullableDateTime__ext__AddMinutes
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateTime__ext__AddMinutes();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__ext__AddMinutes()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateTime__ext__AddMinutes)
 {
 }//ETranslator__NullableDateTime__ext__AddMinutes
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateTime__ext__AddMinutes);
  ...
  var r=Expression.Call
         (Code.Method_Code__NullableDateTime__AddMinutes.MethodInfo,
          node_Arg0,
          node_Arg1);
