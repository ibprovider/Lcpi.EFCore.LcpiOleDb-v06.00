...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__ext__AddSeconds

sealed class ETranslator__NullableDateTime__ext__AddSeconds
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateTime__ext__AddSeconds();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__ext__AddSeconds()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateTime__ext__AddSeconds)
 {
 }//ETranslator__NullableDateTime__ext__AddSeconds
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateTime__ext__AddSeconds);
  ...
  var r=Expression.Call
         (Code.Method_Code__NullableDateTime__AddSeconds.MethodInfo,
          node_Arg0,
          node_Arg1);
