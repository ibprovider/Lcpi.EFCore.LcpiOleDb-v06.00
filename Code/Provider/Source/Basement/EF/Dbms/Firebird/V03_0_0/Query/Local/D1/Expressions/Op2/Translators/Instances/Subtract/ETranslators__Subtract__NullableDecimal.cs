...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__Subtract__NullableDecimal

static class ETranslators__Subtract__NullableDecimal
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__Decimal
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Subtract___NullableDecimal__Decimal.MethodInfo_V_V));

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableDecimal
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Subtract___NullableDecimal__NullableDecimal.MethodInfo_V_V));
};//class ETranslators__Subtract__NullableDecimal
