...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeOnly__ext__AddMinutes

sealed class ETranslator__NullableTimeOnly__ext__AddMinutes
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableTimeOnly__ext__AddMinutes();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeOnly__ext__AddMinutes()
  :base(Structure_MethodIdCache.MethodIdOf__NullableTimeOnly__ext__AddMinutes)
 {
 }//ETranslator__NullableTimeOnly__ext__AddMinutes
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableTimeOnly__ext__AddMinutes);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__NullableTimeOnly__AddMinutes___NullableDouble.MethodInfo,
      node_Arg0,
      node_Arg1);
