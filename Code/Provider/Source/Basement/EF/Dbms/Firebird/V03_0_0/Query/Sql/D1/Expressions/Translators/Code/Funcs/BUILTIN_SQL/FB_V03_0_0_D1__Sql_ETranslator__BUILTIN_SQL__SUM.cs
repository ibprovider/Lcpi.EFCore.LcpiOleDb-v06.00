...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D1__Sql_ETranslator__BUILTIN_SQL__SUM

sealed class FB_V03_0_0_D1__Sql_ETranslator__BUILTIN_SQL__SUM
 :FB_Common__Sql_ETranslator_MethodCall
{
  ...
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__BUILTIN_SQL__SUM,
      new FB_V03_0_0_D1__Sql_ETranslator__BUILTIN_SQL__SUM());

 //-----------------------------------------------------------------------
 private FB_V03_0_0_D1__Sql_ETranslator__BUILTIN_SQL__SUM()
 {
 }//FB_V03_0_0_D1__Sql_ETranslator__BUILTIN_SQL__SUM
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  //------------------------------------------------------------
  var r
   =Nodes.FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM.Create
     (exprArg0);
