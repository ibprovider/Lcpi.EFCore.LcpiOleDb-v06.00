...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__AddDays

sealed class ETranslator__DateTime__std__AddDays
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__std__AddDays();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__AddDays()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__std__AddDays)
 {
 }//ETranslator__DateTime__std__AddDays
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddDays);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddDays.MethodInfo,
          node_Object,
          node_Arg0);
