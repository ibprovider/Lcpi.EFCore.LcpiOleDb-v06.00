...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__AddHours

sealed class ETranslator__DateTime__std__AddHours
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__std__AddHours();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__AddHours()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__std__AddHours)
 {
 }//ETranslator__DateTime__std__AddHours
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddHours);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddHours.MethodInfo,
          node_Object,
          node_Arg0);
