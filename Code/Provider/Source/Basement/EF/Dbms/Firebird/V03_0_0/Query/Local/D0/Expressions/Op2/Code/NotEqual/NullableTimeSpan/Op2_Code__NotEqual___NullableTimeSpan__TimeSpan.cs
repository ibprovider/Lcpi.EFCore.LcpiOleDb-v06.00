...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__NotEqual___NullableTimeSpan__TimeSpan

sealed class Op2_Code__NotEqual___NullableTimeSpan__TimeSpan
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__NotEqual___NullableTimeSpan__TimeSpan
  Instance
   =new Op2_Code__NotEqual___NullableTimeSpan__TimeSpan();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__NotEqual___NullableTimeSpan__TimeSpan)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__NotEqual___NullableTimeSpan__TimeSpan()
 {
 }//Op2_Code__NotEqual___NullableTimeSpan__TimeSpan
