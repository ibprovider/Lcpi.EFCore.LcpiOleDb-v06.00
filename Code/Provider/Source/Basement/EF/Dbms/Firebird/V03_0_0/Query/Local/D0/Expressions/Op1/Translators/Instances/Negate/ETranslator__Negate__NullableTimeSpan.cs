...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Query.Local.D0.Expressions.Op1.Translators.Instances{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__Negate__NullableTimeSpan

static class ETranslator__Negate__NullableTimeSpan
{
 public static readonly LOCAL_EVAL__Op1__ETranslator__Std__Simple__Descr
  Instance
   =new LOCAL_EVAL__Op1__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op1__ETranslator__Std__Simple(Code.Op1_Code__Negate___NullableTimeSpan.MethodInfo_V));
};//class ETranslator__Negate__NullableTimeSpan
