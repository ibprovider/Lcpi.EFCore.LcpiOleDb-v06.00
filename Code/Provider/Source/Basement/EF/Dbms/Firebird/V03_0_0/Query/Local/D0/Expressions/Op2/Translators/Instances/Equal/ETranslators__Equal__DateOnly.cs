 ...
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__DateTime
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___DateOnly__DateTime.MethodInfo_V_V),
      Code.Op2_Code__Equal___DateOnly__DateTime.Instance);
};//class ETranslators__Equal__DateOnly
