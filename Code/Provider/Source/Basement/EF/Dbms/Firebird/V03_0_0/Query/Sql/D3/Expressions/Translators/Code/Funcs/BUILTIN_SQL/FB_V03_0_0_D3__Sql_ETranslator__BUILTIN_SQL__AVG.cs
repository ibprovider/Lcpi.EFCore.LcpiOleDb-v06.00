...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D3__Sql_ETranslator__BUILTIN_SQL__AVG

sealed class FB_V03_0_0_D3__Sql_ETranslator__BUILTIN_SQL__AVG
 :FB_Common__Sql_ETranslator_MethodCall
{
  ...
  Instance
   =new FB_Common__Sql_ETranslator_MethodCall.tagDescr
     (Structure_MethodIdCache.MethodIdOf__BUILTIN_SQL__AVG,
      new FB_V03_0_0_D3__Sql_ETranslator__BUILTIN_SQL__AVG());

 //-----------------------------------------------------------------------
 private FB_V03_0_0_D3__Sql_ETranslator__BUILTIN_SQL__AVG()
 {
 }//FB_V03_0_0_D3__Sql_ETranslator__BUILTIN_SQL__AVG
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
  ...
  //------------------------------------------------------------
  var r
   =Nodes.FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG.Create
     (exprArg0);
