...
using FB_D1_ETRS
 =Firebird.V03_0_0.Query.Local.D1.Expressions.Converts.Translators.Instances;
...
static class FB_Data__Expressions_Local__Converts
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_Convert__Map
  Data
   ...
   /*D1*/ .Add(FB_D1_ETRS .ETranslators__From_String.sm_TO__NullableDateTime)
   ...
   /*D1*/ .Add(FB_D1_ETRS .ETranslators__From_DateTime.sm_TO__String)
