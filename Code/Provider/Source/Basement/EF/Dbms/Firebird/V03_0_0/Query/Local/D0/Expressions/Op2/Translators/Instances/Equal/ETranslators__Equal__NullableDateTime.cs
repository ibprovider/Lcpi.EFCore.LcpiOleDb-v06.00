...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__Equal__NullableDateTime

static class ETranslators__Equal__NullableDateTime
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__DateTime
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___NullableDateTime__DateTime.MethodInfo_V_V),
      Code.Op2_Code__Equal___NullableDateTime__DateTime.Instance);

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableDateTime
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___NullableDateTime__NullableDateTime.MethodInfo_V_V),
      Code.Op2_Code__Equal___NullableDateTime__NullableDateTime.Instance);
};//class ETranslators__Equal__NullableDateTime
