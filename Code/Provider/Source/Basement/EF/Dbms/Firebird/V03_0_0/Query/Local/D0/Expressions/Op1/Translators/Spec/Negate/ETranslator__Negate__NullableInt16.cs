...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__Negate__NullableInt16

sealed class ETranslator__Negate__NullableInt16
 :Root.Query.Local.LcpiOleDb__LocalEval_UnaryTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__NullableInt16>
  Instance
   =new Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__NullableInt16>
     (new ETranslator__Negate__NullableInt16());

 //-----------------------------------------------------------------------
 private ETranslator__Negate__NullableInt16()
 {
 }//ETranslator__Negate__NullableInt16
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.Operand.Type==Structure.Structure_TypeCache.TypeOf__System_NullableInt16);

  //----------------------------------------
  var exprResult
   =opData.ExpressionServices.Extension__MakeBinary__Subtract__Throw
     (FB_Common__Data.sm_ConstantExpression__Int16__ZERO,
      opData.Operand);
