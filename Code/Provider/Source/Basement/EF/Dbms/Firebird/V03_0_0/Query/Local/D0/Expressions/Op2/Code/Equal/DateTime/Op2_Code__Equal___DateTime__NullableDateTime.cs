...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___DateTime__NullableDateTime

sealed class Op2_Code__Equal___DateTime__NullableDateTime
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__Equal___DateTime__NullableDateTime
  Instance
   =new Op2_Code__Equal___DateTime__NullableDateTime();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___DateTime__NullableDateTime)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___DateTime__NullableDateTime()
 {
 }//Op2_Code__Equal___DateTime__NullableDateTime
