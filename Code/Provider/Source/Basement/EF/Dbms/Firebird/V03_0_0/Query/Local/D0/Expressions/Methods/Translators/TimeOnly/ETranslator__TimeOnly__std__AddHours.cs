...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeOnly__std__AddHours

sealed class ETranslator__TimeOnly__std__AddHours
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__TimeOnly__std__AddHours();

 //-----------------------------------------------------------------------
 private ETranslator__TimeOnly__std__AddHours()
  :base(Structure_MethodIdCache.MethodIdOf__TimeOnly__std__AddHours)
 {
 }//ETranslator__TimeOnly__std__AddHours
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__TimeOnly__std__AddHours);
  ...
  var r
   =Expression.Call
      (Code.Method_Code__TimeOnly__AddHours___Double.MethodInfo,
       node_Object,
       node_Arg0);
