...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__ext__AddHours

sealed class ETranslator__NullableDateTime__ext__AddHours
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateTime__ext__AddHours();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__ext__AddHours()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateTime__ext__AddHours)
 {
 }//ETranslator__NullableDateTime__ext__AddHours
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateTime__ext__AddHours);
  ...
  var r=Expression.Call
         (Code.Method_Code__NullableDateTime__AddHours.MethodInfo,
          node_Arg0,
          node_Arg1);
