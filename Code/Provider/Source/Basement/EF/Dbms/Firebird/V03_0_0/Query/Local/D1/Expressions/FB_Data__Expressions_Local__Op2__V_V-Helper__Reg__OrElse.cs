...
{
 private static LcpiOleDb__LocalEval_Op2__Map Helper__Reg__OrElse(LcpiOleDb__LocalEval_Op2__Map Map)
 {
  Debug.Assert(!Object.ReferenceEquals(Map,null));

  Map
   .Reg(LcpiOleDb__ExpressionType.OrElse)

   .Add(Common_ETRS.ETranslators__OrElse__Boolean.sm_Instance__Boolean)

   .Add(Common_ETRS.ETranslators__OrElse__Boolean.sm_Instance__NullableBoolean)

   .Add(Common_ETRS.ETranslators__OrElse__NullableBoolean.sm_Instance__Boolean)
   .Add(Common_ETRS.ETranslators__OrElse__NullableBoolean.sm_Instance__NullableBoolean)
