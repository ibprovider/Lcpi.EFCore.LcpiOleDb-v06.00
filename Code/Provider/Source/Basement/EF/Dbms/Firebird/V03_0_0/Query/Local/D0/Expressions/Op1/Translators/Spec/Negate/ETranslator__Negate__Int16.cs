...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__Negate__Int16

sealed class ETranslator__Negate__Int16
 :Root.Query.Local.LcpiOleDb__LocalEval_UnaryTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__Int16>
  Instance
   =new Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__Int16>
     (new ETranslator__Negate__Int16());

 //-----------------------------------------------------------------------
 private ETranslator__Negate__Int16()
 {
 }//ETranslator__Negate__Int16
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.Operand.Type==Structure.Structure_TypeCache.TypeOf__System_Int16);
