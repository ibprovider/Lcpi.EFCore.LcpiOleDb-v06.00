...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D2__TypeMappingSourceForDDL

sealed class FB_V03_0_0_D2__TypeMappingSourceForDDL
 :FB_V03_0_0_D2__TypeMappingSource__Base
{
 private static ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D2__TypeMappingSourceForDDL;

 //-----------------------------------------------------------------------
 public FB_V03_0_0_D2__TypeMappingSourceForDDL(TypeMappingSourceDependencies           dependencies,
 ...
 //-----------------------------------------------------------------------
 protected override RelationalTypeMapping Internal__GetTypeMapping__TimeSpan__as_Decimal18_4
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
 ...
 protected override RelationalTypeMapping Internal__GetTypeMapping__TYPE_DATE__as_DateOnly
                                           (in RelationalTypeMappingInfo mappingInfo)
 {
  Helper__ThrowError__CnDialectNotAllowUsageTypeInDDL
   ("DATE");
 ...
 //helper methods --------------------------------------------------------
 private static void Helper__ThrowError__CnDialectNotAllowUsageTypeInDDL
                                           (string databaseTypeName)
 {
  ThrowError.TypeMappingErr__CnDialectNotAllowUsageTypeInDDL
   (c_ErrSrcID,
    2,
    databaseTypeName);
 }//Helper__ThrowError__CnDialectNotAllowUsageTypeInDDL
