...
using Code1
 =D1.Expressions.Nodes.SSCodes.Unary_Convert;
  ...
  Helper__Create_ETR_Convert()
 {
  var ETR
   =new FB_COMMON_ETRS_CODE.FB_Common__Sql_ETranslator_Unary__Convert()
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Byte         , Structure_TypeCache.TypeOf__System_Int64       , true  , Code1.SSCode_Unary_Convert__CastAs__ToInt64.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Int16        , Structure_TypeCache.TypeOf__System_Int64       , true  , Code1.SSCode_Unary_Convert__CastAs__ToInt64.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Int32        , Structure_TypeCache.TypeOf__System_Int64       , true  , Code1.SSCode_Unary_Convert__CastAs__ToInt64.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Int64        , Structure_TypeCache.TypeOf__System_Int64       , true  , Code1.SSCode_Unary_Convert__CastAs__ToInt64.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Single       , Structure_TypeCache.TypeOf__System_Int64       , false , Code1.SSCode_Unary_Convert__CastAs__ToInt64_WithTrunc.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Double       , Structure_TypeCache.TypeOf__System_Int64       , false , Code1.SSCode_Unary_Convert__CastAs__ToInt64_WithTrunc.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_Decimal      , Structure_TypeCache.TypeOf__System_Int64       , false , Code1.SSCode_Unary_Convert__CastAs__ToInt64_WithTrunc.Instance)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_DateTime     , Structure_TypeCache.TypeOf__System_String      , false , Code0.SSCode_Unary_Convert__CastAs__ToVarCharN.Instance__FromTS__D1)
     ...
     //.Reg(Structure_TypeCache.TypeOf__System_String     , Structure_TypeCache.TypeOf__System_TimeSpan        , false , /*NO WAY. D3 ONLY*/)
     //.Reg(Structure_TypeCache.TypeOf__System_String     , Structure_TypeCache.TypeOf__System_TimeOnly        , false , /*NO WAY. D3 ONLY*/)
     ...
     .Reg(Structure_TypeCache.TypeOf__System_String       , Structure_TypeCache.TypeOf__System_Int64       , false , Code1.SSCode_Unary_Convert__CastAs__ToInt64_WithTrunc.Instance)
