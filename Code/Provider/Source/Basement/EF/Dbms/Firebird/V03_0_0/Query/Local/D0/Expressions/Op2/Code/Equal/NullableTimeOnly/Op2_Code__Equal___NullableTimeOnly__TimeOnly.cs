...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___NullableTimeOnly__TimeOnly

sealed class Op2_Code__Equal___NullableTimeOnly__TimeOnly
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__Equal___NullableTimeOnly__TimeOnly
  Instance
   =new Op2_Code__Equal___NullableTimeOnly__TimeOnly();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___NullableTimeOnly__TimeOnly)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___NullableTimeOnly__TimeOnly()
 {
 }//Op2_Code__Equal___NullableTimeOnly__TimeOnly
