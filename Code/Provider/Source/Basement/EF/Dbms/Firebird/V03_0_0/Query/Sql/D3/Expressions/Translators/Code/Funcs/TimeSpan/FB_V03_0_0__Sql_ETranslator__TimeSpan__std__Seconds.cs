...
sealed class FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Seconds
 :FB_Common__Sql_ETranslator_Member
{
  ...
  Instance
   =new FB_Common__Sql_ETranslator_Member.tagDescr
     (Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Seconds,
      new FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Seconds());

 //-----------------------------------------------------------------------
 private FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Seconds()
 {
 }//FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Seconds
 ...
 public override SqlExpression Translate(in tagOpData opData)
 {
...
#if DEBUG
  opData.DEBUG_CheckMemberId(Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Seconds);
#endif
  ...
  //
  // Generated SQL:
  //  - CAST( (TRUNC(exprInstance) MOD secondInMinute) AS INTEGER)
  //
  // Expected result:
  //  - INTEGER
  //
