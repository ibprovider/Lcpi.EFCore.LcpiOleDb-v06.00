 ...
 private static readonly tagItems
  sm_Items
   =new tagItems()
     ...
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__DateTime__std__Today_d3.Instance)
     ...
     /*TimeSpan*/
     .Add(FB_V03_0_0__SqlTranslators__D3.Code.FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Hours.Instance)
     .Add(FB_V03_0_0__SqlTranslators__D3.Code.FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Minutes.Instance)
     .Add(FB_V03_0_0__SqlTranslators__D3.Code.FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Seconds.Instance)
     .Add(FB_V03_0_0__SqlTranslators__D3.Code.FB_V03_0_0__Sql_ETranslator__TimeSpan__std__Milliseconds.Instance)
     ...
     /*NullableInt64*/
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableInt64__std__Value.Instance_d3)
     ...
     /*NullableTimeSpan*/
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableTimeSpan__std__Value.Instance_d3)
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableTimeSpan__std__HasValue.Instance)

     /*NullableTimeOnly*/
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableTimeOnly__std__Value.Instance_d3)
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableTimeOnly__std__HasValue.Instance)

     /*NullableDateOnly*/
     .Add(FB_Common_SqlTranslators.Code.FB_Common__Sql_ETranslator__NullableDateOnly__std__Value.Instance_d3)
