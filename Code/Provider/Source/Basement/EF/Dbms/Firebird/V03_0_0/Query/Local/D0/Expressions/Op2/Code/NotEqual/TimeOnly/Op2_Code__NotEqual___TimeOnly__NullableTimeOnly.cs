...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__NotEqual___TimeOnly__NullableTimeOnly

sealed class Op2_Code__NotEqual___TimeOnly__NullableTimeOnly
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__NotEqual___TimeOnly__NullableTimeOnly
  Instance
   =new Op2_Code__NotEqual___TimeOnly__NullableTimeOnly();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo MethodInfo_V_V
  =typeof(Op2_Code__NotEqual___TimeOnly__NullableTimeOnly)
    .GetTypeInfo()
    .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__NotEqual___TimeOnly__NullableTimeOnly()
 {
 }//Op2_Code__NotEqual___TimeOnly__NullableTimeOnly
