...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM

sealed class FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM;
 ...
 //-----------------------------------------------------------------------
 private FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM\n"
   +" (valueExpression  : {0},\n"
   +"  resultType       : {1})",
    valueExpression,
    resultTypeMapping.ClrType);
...
//-----------------------------------------------------------------------
 public static SqlExpression Create(SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  if(valueExpression is FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM e)
  {
#if DEBUG
   e.DEBUG__CheckState();
#endif
  ...
  return new FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM
              (valueExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::VisitChildren";
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::Print(...)");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::Helper__Accept__GenerateSql(...)");
#endif
                                           ...
                                           (SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__Sql_ENode_Function__SQL__SUM::Helper__BuildResultTypeMapping";
 ...
 private static RelationalTypeMapping Helper__GetResultTypeMapping__Decimal(SqlExpression sqlArg)
 {
  ...
  Debug.Assert(sqlArgTypeMapping.Precision.HasValue);
  Debug.Assert(sqlArgTypeMapping.Precision.Value>Core.Engines.Dbms.IscBase.IscBase_Const.c_SqlPrecision__NUMERIC__Int32);
