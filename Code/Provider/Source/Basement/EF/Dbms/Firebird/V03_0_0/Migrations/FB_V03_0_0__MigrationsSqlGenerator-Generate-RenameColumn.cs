...
partial class FB_V03_0_0__MigrationsSqlGenerator
{
                                  ...
                                  MigrationCommandListBuilder builder)
 {
  const string c_methodSign
   =nameof(Generate)+"("+nameof(RenameColumnOperation)+"...)";
  ...
  //----------------------------------------------------------------------
  if(System.StringComparer.Ordinal.Equals(operation.Name,operation.NewName))
  {
   //Ignore operation
  ...
  builder.Append(" TO ");
  builder.Append(this.Dependencies.SqlGenerationHelper.DelimitIdentifier(operation.NewName));
