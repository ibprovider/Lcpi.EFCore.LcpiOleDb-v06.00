...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__GreaterThanOrEqual__TimeSpan

static class ETranslators__GreaterThanOrEqual__TimeSpan
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__TimeSpan
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThanOrEqual___TimeSpan__TimeSpan.MethodInfo_V_V));

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableTimeSpan
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThanOrEqual___TimeSpan__NullableTimeSpan.MethodInfo_V_V));
};//class ETranslators__GreaterThanOrEqual__TimeSpan
