...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___TimeOnly__TimeOnly

sealed class Op2_Code__Equal___TimeOnly__TimeOnly
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___TimeOnly__TimeOnly
  Instance
   =new Op2_Code__Equal___TimeOnly__TimeOnly();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___TimeOnly__TimeOnly)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___TimeOnly__TimeOnly()
 {
 }//Op2_Code__Equal___TimeOnly__TimeOnly
