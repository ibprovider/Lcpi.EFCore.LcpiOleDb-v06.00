 ...
 :Svcs.FB_V03_0_0__MigrationsSvc__GenerateCreateSequence
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Basement_EF_Dbms_Firebird_V03_0_0_Migrations_D1_Internal_SvcImpls___FB_V03_0_0__MigrationsSvcImpl__GenerateCreateSequence;
               ...
               MigrationCommandListBuilder           builder)
 {
  ...
  if(correctedStartValue<int.MinValue || int.MaxValue<correctedStartValue)
  {
   ThrowError.MSqlGenErr__OverflowInCalculationOfAdjustedSequenceStartValue
    (c_ErrSrcID,
     operation);
