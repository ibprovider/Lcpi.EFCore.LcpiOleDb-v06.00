...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG

sealed class FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG
 :FB_Common__Sql_ENode_Function
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG;
 ...
 //-----------------------------------------------------------------------
 private FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG
        ...
        resultTypeMapping)
 {
  ...
  Core.Core_Trace.Method
   ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG(...) - clone");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG\n"
   +" (valueExpression  : {0},\n"
   +"  resultType       : {1})",
    valueExpression,
    resultTypeMapping.ClrType);
...
//-----------------------------------------------------------------------
 public static SqlFunctionExpression Create(SqlExpression valueExpression)
 {
  Debug.Assert(!Object.ReferenceEquals(valueExpression,null));
  ...
  //------------------------------------------------------------
  if(valueExpression is FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG e)
  {
#if DEBUG
   e.DEBUG__CheckState();
#endif
  ...
  return new FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG
              (valueExpression,
               resultTypeMapping);
 }//Create
...
#if TRACE
   Core.Core_Trace.Method
    ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::get_CanReduce - false");
#endif
 ...
 protected override Expression Accept(ExpressionVisitor visitor)
 {
  ...
  Core.Core_Trace.Method_Enter
   ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::Accept"
   +" (visitorType: {0})",
    visitor.GetType());
#endif
 ...
 protected override Expression VisitChildren(ExpressionVisitor visitor)
 {
  ...
  const string c_bugcheck_src
   ="FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::VisitChildren";
  ...
  return Create(newValueExpression);
 }//VisitChildren
                                              ...
                                              IReadOnlyList<SqlExpression> arguments)
 {
  ...
  return Create(arguments[c_ArgIdx__value]); //throw
 }//Update
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::Print(...)");
#endif
...
#if TRACE
  Core.Core_Trace.Method
   ("FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::Helper__Accept__GenerateSql(...)");
#endif
                                           ...
                                           (SqlExpression valueExpression)
 {
  ...
  //------------------------------------------------------------
  const string c_bugcheck_src
   ="FB_V03_0_0_D3__Sql_ENode_Function__SQL__AVG::Helper__BuildResultTypeMapping";
