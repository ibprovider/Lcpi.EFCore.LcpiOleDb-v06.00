...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__GreaterThan__DateTime

static class ETranslators__GreaterThan__DateTime
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__DateTime
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThan___DateTime__DateTime.MethodInfo_V_V));

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableDateTime
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__GreaterThan___DateTime__NullableDateTime.MethodInfo_V_V));
};//class ETranslators__GreaterThan__DateTime
