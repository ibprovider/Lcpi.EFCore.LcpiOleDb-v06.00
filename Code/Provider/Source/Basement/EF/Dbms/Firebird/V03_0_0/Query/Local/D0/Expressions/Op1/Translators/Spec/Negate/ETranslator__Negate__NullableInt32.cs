...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__Negate__NullableInt32

sealed class ETranslator__Negate__NullableInt32
 :Root.Query.Local.LcpiOleDb__LocalEval_UnaryTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__NullableInt32>
  Instance
   =new Root.Query.Local.LcpiOleDb__LocalEval_Op1__Descr<ETranslator__Negate__NullableInt32>
     (new ETranslator__Negate__NullableInt32());

 //-----------------------------------------------------------------------
 private ETranslator__Negate__NullableInt32()
 {
 }//ETranslator__Negate__NullableInt32
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.Operand.Type==Structure.Structure_TypeCache.TypeOf__System_NullableInt32);
