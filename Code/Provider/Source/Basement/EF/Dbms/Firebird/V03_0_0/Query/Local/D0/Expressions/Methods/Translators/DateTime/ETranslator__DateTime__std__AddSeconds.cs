...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__AddSeconds

sealed class ETranslator__DateTime__std__AddSeconds
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__std__AddSeconds();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__AddSeconds()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__std__AddSeconds)
 {
 }//ETranslator__DateTime__std__AddSeconds
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddSeconds);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddSeconds.MethodInfo,
          node_Object,
          node_Arg0);
