...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD

sealed class FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD
 :FB_Common__Sql_ETranslator_Op1
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD;

 //-----------------------------------------------------------------------
 public static readonly FB_Common__Sql_ETranslator_Op1
  Instance
   =new FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD();

 //-----------------------------------------------------------------------
 private FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD()
 {
 ...
 private static RelationalTypeMapping Helper__GetResultTypeMapping(SqlExpression sqlSource)
 {
  ...
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__Sql_ETranslator_Op1__Negate__STD::Helper__GetResultTypeMapping";
  ...
  if(sqlSourceType==Structure_TypeCache.TypeOf__System_TimeSpan)   // <--- D1!!!
  {
   //[2021-10-11] Expected
   Debug.Assert(!Object.ReferenceEquals(sqlSource.TypeMapping,null));
   Debug.Assert(Object.ReferenceEquals(sqlSource.TypeMapping,FB_Common__TypeMappingCache.TypeMapping__TimeSpan__as_Decimal9_4));

   return FB_Common__TypeMappingCache.TypeMapping__TimeSpan__as_Decimal9_4;
  }//if TimeSpan
