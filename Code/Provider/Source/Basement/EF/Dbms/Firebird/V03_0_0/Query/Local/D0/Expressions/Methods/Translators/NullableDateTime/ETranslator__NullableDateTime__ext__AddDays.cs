...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__ext__AddDays

sealed class ETranslator__NullableDateTime__ext__AddDays
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateTime__ext__AddDays();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__ext__AddDays()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateTime__ext__AddDays)
 {
 }//ETranslator__NullableDateTime__ext__AddDays
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateTime__ext__AddDays);
  ...
  var r=Expression.Call
         (Code.Method_Code__NullableDateTime__AddDays.MethodInfo,
          node_Arg0,
          node_Arg1);
