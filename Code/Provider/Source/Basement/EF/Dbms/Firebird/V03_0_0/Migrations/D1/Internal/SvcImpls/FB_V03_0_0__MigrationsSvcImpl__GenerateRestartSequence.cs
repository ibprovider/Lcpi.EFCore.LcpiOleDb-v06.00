...
namespace Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Migrations.D1.Internal.SvcImpls{
////////////////////////////////////////////////////////////////////////////////
 ...
 :Svcs.FB_V03_0_0__MigrationsSvc__GenerateRestartSequence
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Basement_EF_Dbms_Firebird_V03_0_0_Migrations_D1_Internal_SvcImpls___FB_V03_0_0__MigrationsSvcImpl__GenerateRestartSequence;
               ...
               MigrationCommandListBuilder           builder)
 {
  ...
  //---------------------------------------- Base verification
  {
   ...
   if(operation.StartValue<FIREBIRD_SEQUENCE_DATATYPE.MinValue || FIREBIRD_SEQUENCE_DATATYPE.MaxValue<operation.StartValue)
   {
    ErrorUtils.Add
     (ref sourceDataErrs,
      ErrorRecordCreator.MSqlGenErr__IncorrectStartValueOfSequence
       (c_ErrSrcID,
        operation.Name,
...
////////////////////////////////////////////////////////////////////////////////
}//Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Dbms.Firebird.V03_0_0.Migrations.D1.Internal.SvcImpls
