...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___TimeSpan__NullableTimeSpan

sealed class Op2_Code__Equal___TimeSpan__NullableTimeSpan
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__Equal___TimeSpan__NullableTimeSpan
  Instance
   =new Op2_Code__Equal___TimeSpan__NullableTimeSpan();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___TimeSpan__NullableTimeSpan)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___TimeSpan__NullableTimeSpan()
 {
 }//Op2_Code__Equal___TimeSpan__NullableTimeSpan
