...
////////////////////////////////////////////////////////////////////////////////
//class FB_V03_0_0_D1__TypeMappingSource__Base
 ...
 :FB_V03_0_0__TypeMappingSource__Base
{
 ...
 //-----------------------------------------------------------------------
 public FB_V03_0_0_D1__TypeMappingSource__Base(TypeMappingSourceDependencies           dependencies,
                         ...
                         in RelationalTypeMappingInfo mappingInfo)
 {
  const string c_bugcheck_src
   ="FB_V03_0_0_D1__TypeMappingSource__Base::Internal__FindMapping__ByStoreDataTypeInfo";
  ...
  {
   if(Common.Storage.Mapping.FB_Common__TypeMapping__TimeSpan__as_Decimal9_4.Is(mappingInfo.ClrType,mappingInfo.StoreTypeNameBase,mappingInfo.Precision.Value,mappingInfo.Scale.Value))
    return Internal__GetTypeMapping__TimeSpan__as_Decimal9_4(mappingInfo);
  }//if
                        ...
                        (in RelationalTypeMappingInfo mappingInfo)
 {
  ...
  if(Common.Storage.Mapping.FB_Common__TypeMapping__TimeSpan__as_Decimal9_4.Is(mappingInfo.ClrType))
   return Internal__GetTypeMapping__TimeSpan__as_Decimal9_4(mappingInfo);
 ...
 //-----------------------------------------------------------------------
 protected abstract RelationalTypeMapping Internal__GetTypeMapping__TimeSpan__as_Decimal9_4
                                           (in RelationalTypeMappingInfo mappingInfo);
