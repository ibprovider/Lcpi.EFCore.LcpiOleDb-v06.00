...
{
 private static bool Helper__TryRewrite_Op2_Equal
                                           (Expression     left,
                                            Expression     right,
                                            out Expression rewritedExpression)
 {
  ...
  //--------------------------------------------------
  {
   ...
   //
   // Result:
   //  object.Equals(left[0],right[0]) and object.Equals(left[1],right[1]) and  ...
   //
   // Restrictions:
   ...
   if(left is NewArrayExpression left_t)
   {
    ...
    return Helper__RewriteBuilder__TryBuildEqualComparisonOfObjectCollections
     (leftExpressions,
      rightExpressions,
