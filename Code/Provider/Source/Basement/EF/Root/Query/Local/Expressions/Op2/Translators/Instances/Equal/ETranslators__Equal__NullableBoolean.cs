 ...
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
  sm_Instance__String
   =new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx(Code.Op2_Code__Equal___NullableBoolean__String.MethodInfo_V_V),
      Code.Op2_Code__Equal___NullableBoolean__String.Instance);
  ...
  sm_Instance__NullableBoolean
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__Equal___NullableBoolean__NullableBoolean.MethodInfo_V_V),
      Code.Op2_Code__Equal___NullableBoolean__NullableBoolean.Instance);
};//class ETranslators__Equal__NullableBoolean
