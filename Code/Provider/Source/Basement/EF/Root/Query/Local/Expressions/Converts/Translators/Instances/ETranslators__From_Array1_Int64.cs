...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__From_Array1_Int64

static class ETranslators__From_Array1_Int64
{
 public static readonly LOCAL_EVAL__Convert__Descr
  sm_TO__IEnumerable_Int64
   =new LOCAL_EVAL__Convert__Descr
     (new LOCAL_EVAL__Convert__ETranslator__STD__SIMPLE(Code.Convert_Code__Array1_Int64__Enumerable_Int64.MethodInfo),
      null);
};//class ETranslators__From_Array1_Int64
