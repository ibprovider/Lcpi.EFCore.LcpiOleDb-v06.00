...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateOnly__ext__AddYears

sealed class ETranslator__NullableDateOnly__ext__AddYears
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateOnly__ext__AddYears();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateOnly__ext__AddYears()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateOnly__ext__AddYears)
 {
 }//ETranslator__NullableDateOnly__ext__AddYears
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateOnly__ext__AddYears);
  ...
  var r=Expression.Call
         (Code.Method_Code__NullableDateOnly__AddYears.MethodInfo,
          node_Arg0,
          node_Arg1);
