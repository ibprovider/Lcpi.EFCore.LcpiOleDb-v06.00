...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__String__std__Contains

sealed class ETranslator__String__std__Contains
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__String__std__Contains();

 //-----------------------------------------------------------------------
 private ETranslator__String__std__Contains()
  :base(Structure_MethodIdCache.MethodIdOf__String__std__Contains)
 {
 }//ETranslator__String__std__Contains
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__String__std__Contains);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__String__Contains.MethodInfo,
      node_Object,
      node_Arg0);
