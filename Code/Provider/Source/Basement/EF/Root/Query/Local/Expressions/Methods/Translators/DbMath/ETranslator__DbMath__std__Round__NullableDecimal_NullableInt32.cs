...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DbMath__std__Round__NullableDecimal_NullableInt32

sealed class ETranslator__DbMath__std__Round__NullableDecimal_NullableInt32
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DbMath__std__Round__NullableDecimal_NullableInt32();

 //-----------------------------------------------------------------------
 private ETranslator__DbMath__std__Round__NullableDecimal_NullableInt32()
  :base(Structure_MethodIdCache.MethodIdOf__DbMath__std__Round__NullableDecimal_NullableInt32)
 {
 }//ETranslator__DbMath__std__Round__NullableDecimal_NullableInt32
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DbMath__std__Round__NullableDecimal_NullableInt32);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__Math__Round__NullableDecimal_NullableInt32.MethodInfo,
      node_Arg0,
      node_Arg1);
