...
////////////////////////////////////////////////////////////////////////////////
//class Op2_MasterCode__ArrayIndex___Array_Byte__Int64

static class Op2_MasterCode__ArrayIndex___Array_Byte__Int64
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Op2_MasterCode__ArrayIndex___Array_Byte__Int64;
 ...
 public static T_RESULT Exec(T_ARG1_E[] a,T_ARG2 b)
 {
  ...
  // [2021-05-31] Expected.
  //
  // Compiler translates 'a[b]' to 'a[(int)b]', where '(int)b' it is checked conversion.
  //
  Debug.Assert(a.Length<=System.Int32.MaxValue);
