...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__vrt__DayOfYear

sealed class ETranslator__NullableDateTime__vrt__DayOfYear
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableDateTime__vrt__DayOfYear();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__vrt__DayOfYear()
  :base(Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__DayOfYear)
 {
 }//ETranslator__NullableDateTime__vrt__DayOfYear
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__DayOfYear);
#endif
