...
////////////////////////////////////////////////////////////////////////////////
//class Method_Code__Math__Abs__NullableInt16

static class Method_Code__Math__Abs__NullableInt16
{
 private static readonly System.Reflection.MethodInfo sm_MethodInfo
  =typeof(Method_Code__Math__Abs__NullableInt16)
    .GetTypeInfo()
    .GetDeclaredMethod(nameof(Exec));

 //-----------------------------------------------------------------------
 private static Nullable<Int16> Exec(Nullable<Int16> value)
 {
  if(!value.HasValue)
   return null;
