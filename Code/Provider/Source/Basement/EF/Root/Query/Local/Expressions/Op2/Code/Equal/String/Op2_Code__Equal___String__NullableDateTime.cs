...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___String__NullableDateTime

sealed class Op2_Code__Equal___String__NullableDateTime
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___String__NullableDateTime
  Instance
   =new Op2_Code__Equal___String__NullableDateTime();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___String__NullableDateTime)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___String__NullableDateTime()
 {
