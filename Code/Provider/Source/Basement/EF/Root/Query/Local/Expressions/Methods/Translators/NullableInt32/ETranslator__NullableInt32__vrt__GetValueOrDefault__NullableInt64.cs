...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt32__vrt__GetValueOrDefault__NullableInt64

sealed class ETranslator__NullableInt32__vrt__GetValueOrDefault__NullableInt64
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableInt32__vrt__GetValueOrDefault__NullableInt64();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt32__vrt__GetValueOrDefault__NullableInt64()
  :base(Structure_MethodIdCache.MethodIdOf__NullableInt32__vrt__GetValueOrDefault__NullableInt64)
 {
 }//ETranslator__NullableInt32__vrt__GetValueOrDefault__NullableInt64
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodIdCache.MethodIdOf__NullableInt32__vrt__GetValueOrDefault__NullableInt64);
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableInt32__GetValueOrDefault__NullableInt64.MethodInfo,
      node_Object,
      node_Arg0);
