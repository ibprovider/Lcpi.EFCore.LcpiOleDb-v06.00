...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__From_NullableTimeSpan

static class ETranslators__From_NullableTimeSpan
{
 public static readonly LOCAL_EVAL__Convert__Descr
  sm_TO__Object
   =new LOCAL_EVAL__Convert__Descr
     (new LOCAL_EVAL__Convert__ETranslator__STD__SIMPLE(Code.Convert_Code__NullableTimeSpan__Object.MethodInfo),
      null);
};//class ETranslators__From_NullableTimeSpan
