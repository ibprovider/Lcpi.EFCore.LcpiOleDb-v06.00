...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Guid__NullableGuid

sealed class Convert_Code__Guid__NullableGuid
 :Core.Core_ValueCvt<T_SOURCE      ,T_TARGET>
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Guid__NullableGuid)
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__Guid__NullableGuid
  Instance
   =new Convert_Code__Guid__NullableGuid();

 //-----------------------------------------------------------------------
 private Convert_Code__Guid__NullableGuid()
 {
 }//Convert_Code__Guid__NullableGuid
