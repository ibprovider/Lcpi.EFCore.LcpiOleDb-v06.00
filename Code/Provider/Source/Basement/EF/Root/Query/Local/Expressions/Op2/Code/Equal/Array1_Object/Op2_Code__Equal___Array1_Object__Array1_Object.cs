...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___Array1_Object__Array1_Object

sealed class Op2_Code__Equal___Array1_Object__Array1_Object
 :Core.Core_Op2<T_ARG1_E[],T_ARG2_E[],T_RESULT>
 ,Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___Array1_Object__Array1_Object
  Instance
   =new Op2_Code__Equal___Array1_Object__Array1_Object();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___Array1_Object__Array1_Object)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___Array1_Object__Array1_Object()
 {
 }//Op2_Code__Equal___Array1_Object__Array1_Object
                                  ...
                                  T_ARG2_E[]             b)
 {
  ...
  //----------------------------------------
  return MasterCode.Op2_MasterCode__Equal___Array1_generic__Array1_generic<T_ARG1_E,T_ARG2_E>.Exec
          (opCtx,
           a,
           b);
 }//Exec_V_V
