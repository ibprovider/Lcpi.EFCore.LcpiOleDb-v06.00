...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___DateOnly__DateOnly

sealed class Op2_Code__Equal___DateOnly__DateOnly
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
 ,Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___DateOnly__DateOnly
  Instance
   =new Op2_Code__Equal___DateOnly__DateOnly();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___DateOnly__DateOnly)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___DateOnly__DateOnly()
 {
 }//Op2_Code__Equal___DateOnly__DateOnly
