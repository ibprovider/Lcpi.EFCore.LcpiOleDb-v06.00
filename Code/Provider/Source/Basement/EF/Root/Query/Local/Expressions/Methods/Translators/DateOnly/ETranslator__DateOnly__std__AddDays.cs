...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateOnly__std__AddDays

sealed class ETranslator__DateOnly__std__AddDays
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateOnly__std__AddDays();

 //-----------------------------------------------------------------------
 private ETranslator__DateOnly__std__AddDays()
  :base(Structure_MethodIdCache.MethodIdOf__DateOnly__std__AddDays)
 {
 }//ETranslator__DateOnly__std__AddDays
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateOnly__std__AddDays);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__DateOnly__AddDays.MethodInfo,
      node_Object,
      node_Arg0);
