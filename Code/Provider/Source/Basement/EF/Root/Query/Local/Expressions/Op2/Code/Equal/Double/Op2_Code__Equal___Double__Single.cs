...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___Double__Single

sealed class Op2_Code__Equal___Double__Single
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___Double__Single
  Instance
   =new Op2_Code__Equal___Double__Single();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___Double__Single)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___Double__Single()
 {
 }//Op2_Code__Equal___Double__Single
