...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___Object__Object

sealed class Op2_Code__Equal___Object__Object
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Op2_Code__Equal___Object__Object;

 //-----------------------------------------------------------------------
 public static readonly Op2_Code__Equal___Object__Object
  Instance
   =new Op2_Code__Equal___Object__Object();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___Object__Object)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___Object__Object()
 {
 }//Op2_Code__Equal___Object__Object
                                  ...
                                  T_ARG2                 b)
 {
  ...
  const string c_bugcheck_src
   ="Op2_Code__Equal___Object__Object::Exec_V_V";
  ...
  //
  // [2021-02-14] Protection for recursive call.
  //
  Debug.Assert
