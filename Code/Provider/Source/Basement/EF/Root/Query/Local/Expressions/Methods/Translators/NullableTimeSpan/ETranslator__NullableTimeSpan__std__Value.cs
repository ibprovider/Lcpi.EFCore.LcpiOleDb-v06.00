...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeSpan__std__Value

sealed class ETranslator__NullableTimeSpan__std__Value
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeSpan__std__Value();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeSpan__std__Value()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__std__Value)
 {
 }//ETranslator__NullableTimeSpan__std__Value
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(System.Nullable<System.TimeSpan>.Value));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableTimeSpan);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__std__Value);
#endif
