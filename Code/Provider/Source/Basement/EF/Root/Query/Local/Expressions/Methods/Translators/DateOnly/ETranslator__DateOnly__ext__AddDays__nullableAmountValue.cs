...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateOnly__ext__AddDays__nullableAmountValue

sealed class ETranslator__DateOnly__ext__AddDays__nullableAmountValue
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateOnly__ext__AddDays__nullableAmountValue();

 //-----------------------------------------------------------------------
 private ETranslator__DateOnly__ext__AddDays__nullableAmountValue()
  :base(Structure_MethodIdCache.MethodIdOf__DateOnly__ext__AddDays)
 {
 }//ETranslator__DateOnly__ext__AddDays__nullableAmountValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateOnly__ext__AddDays);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateOnly__AddDays__nullableAmountValue.MethodInfo,
          node_Arg0,
          node_Arg1);
