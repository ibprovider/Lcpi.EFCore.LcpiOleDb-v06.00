...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___Double__Decimal

sealed class Op2_Code__Equal___Double__Decimal
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___Double__Decimal
  Instance
   =new Op2_Code__Equal___Double__Decimal();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___Double__Decimal)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___Double__Decimal()
 {
 }//Op2_Code__Equal___Double__Decimal
