...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeOnly__std__Hour

sealed class ETranslator__TimeOnly__std__Hour
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__TimeOnly__std__Hour();

 //-----------------------------------------------------------------------
 private ETranslator__TimeOnly__std__Hour()
  :base(Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Hour)
 {
 }//ETranslator__TimeOnly__std__Hour
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__TimeOnly__std__Hour);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__TimeOnly__Hour.MethodInfo,
      node_Object);
