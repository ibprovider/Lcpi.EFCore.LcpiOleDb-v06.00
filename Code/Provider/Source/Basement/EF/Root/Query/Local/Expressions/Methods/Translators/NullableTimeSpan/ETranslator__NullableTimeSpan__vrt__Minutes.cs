...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeSpan__vrt__Minutes

sealed class ETranslator__NullableTimeSpan__vrt__Minutes
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeSpan__vrt__Minutes();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeSpan__vrt__Minutes()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Minutes)
 {
 }//ETranslator__NullableTimeSpan__vrt__Minutes
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Minutes);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableTimeSpan__Minutes.MethodInfo,
      node_Object);
