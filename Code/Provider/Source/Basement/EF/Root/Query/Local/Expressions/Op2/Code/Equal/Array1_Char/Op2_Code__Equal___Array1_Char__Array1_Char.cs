...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___Array1_Char__Array1_Char

sealed class Op2_Code__Equal___Array1_Char__Array1_Char
 :Core.Core_Op2<T_ARG1_E[],T_ARG2_E[],T_RESULT>
 ,Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___Array1_Char__Array1_Char
  Instance
   =new Op2_Code__Equal___Array1_Char__Array1_Char();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___Array1_Char__Array1_Char)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___Array1_Char__Array1_Char()
 {
 }//Op2_Code__Equal___Array1_Char__Array1_Char
 ...
 private static T_RESULT Exec_V_V(T_ARG1_E[] a,T_ARG2_E[] b)
 {
  ...
  //----------------------------------------
  return MasterCode.Op2_MasterCode__Equal___Array1_Char__Array1_Char.Exec
          (a,
           b);
 }//Exec_V_V
};//class Op2_Code__Equal___Array1_Char__Array1_Char
