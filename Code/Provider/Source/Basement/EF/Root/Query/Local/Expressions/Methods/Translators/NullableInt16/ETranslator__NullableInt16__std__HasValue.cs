...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt16__std__HasValue

sealed class ETranslator__NullableInt16__std__HasValue
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableInt16__std__HasValue();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt16__std__HasValue()
  :base(Structure_MemberIdCache.MemberIdOf__NullableInt16__std__HasValue)
 {
 }//ETranslator__NullableInt16__std__HasValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(System.Nullable<System.Int16>.HasValue));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableInt16);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableInt16__std__HasValue);
#endif
