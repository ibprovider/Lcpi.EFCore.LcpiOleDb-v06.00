...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___String__String

sealed class Op2_Code__Equal___String__String
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
 ,Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___String__String
  Instance
   =new Op2_Code__Equal___String__String();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___String__String)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___String__String()
 {
 }//Op2_Code__Equal___String__String
 ...
 private static T_RESULT Exec_V_V(T_ARG1 a,T_ARG2 b)
 {
  ...
  //----------------------------------------
  return MasterCode.Op2_MasterCode__Equal___String__String.Exec
          (a,
           b);
 }//Exec_V_V
};//class Op2_Code__Equal___String__String
