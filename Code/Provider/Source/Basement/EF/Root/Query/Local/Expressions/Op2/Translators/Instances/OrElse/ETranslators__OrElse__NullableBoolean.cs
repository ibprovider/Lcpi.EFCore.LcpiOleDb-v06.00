...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__OrElse__NullableBoolean

static class ETranslators__OrElse__NullableBoolean
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__Boolean
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__OrElse___NullableBoolean__Boolean.MethodInfo_V_V));

 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableBoolean
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__OrElse___NullableBoolean__NullableBoolean.MethodInfo_V_V));
};//class ETranslators__OrElse__NullableBoolean
