...
////////////////////////////////////////////////////////////////////////////////
//class Method_Code__Math__Round__NullableDecimal

static class Method_Code__Math__Round__NullableDecimal
{
 private static readonly System.Reflection.MethodInfo sm_MethodInfo
  =typeof(Method_Code__Math__Round__NullableDecimal)
    .GetTypeInfo()
 ...
 private static Nullable<Decimal> Exec(Nullable<Decimal> value)
 {
  ...
  return structure_lib.DecimalUtils.Round(value.Value,0);
 }//Exec
