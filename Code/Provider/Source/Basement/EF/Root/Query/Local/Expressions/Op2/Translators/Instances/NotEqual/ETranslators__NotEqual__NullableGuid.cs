...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__NotEqual__NullableGuid

static class ETranslators__NotEqual__NullableGuid
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__Guid
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___NullableGuid__Guid.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___NullableGuid__Guid.Instance);

 //-------------------------------------------------------- NULLABLE
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableGuid
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___NullableGuid__NullableGuid.MethodInfo_V_V));
};//class ETranslators__NotEqual__NullableGuid
