...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__Minute

sealed class ETranslator__DateTime__std__Minute
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__DateTime__std__Minute();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__Minute()
  :base(Structure_MemberIdCache.MemberIdOf__DateTime__std__Minute)
 {
 }//ETranslator__DateTime__std__Minute
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__DateTime__std__Minute);
#endif
