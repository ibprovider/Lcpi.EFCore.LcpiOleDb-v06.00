...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__Millisecond

sealed class ETranslator__DateTime__std__Millisecond
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__DateTime__std__Millisecond();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__Millisecond()
  :base(Structure_MemberIdCache.MemberIdOf__DateTime__std__Millisecond)
 {
 }//ETranslator__DateTime__std__Millisecond
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__DateTime__std__Millisecond);
#endif
