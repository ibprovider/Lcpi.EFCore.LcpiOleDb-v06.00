...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeSpan__std__Milliseconds

sealed class ETranslator__TimeSpan__std__Milliseconds
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__TimeSpan__std__Milliseconds();

 //-----------------------------------------------------------------------
 private ETranslator__TimeSpan__std__Milliseconds()
  :base(Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Milliseconds)
 {
 }//ETranslator__TimeSpan__std__Milliseconds
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Milliseconds);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__TimeSpan__Milliseconds.MethodInfo,
      node_Object);
