...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Object__NullableTimeOnly

static class Convert_Code__Object__NullableTimeOnly
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Cvt_Code__Object__NullableTimeOnly;

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Object__NullableTimeOnly)
     .GetTypeInfo()
                              ...
                              T_SOURCE              v)
 {
  ...
  const string c_bugcheck_src
   ="Convert_Code__Object__NullableTimeOnly::Exec(cvtCtx,Object)";
