...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt64__vrt__GetValueOrDefault__Double

sealed class ETranslator__NullableInt64__vrt__GetValueOrDefault__Double
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableInt64__vrt__GetValueOrDefault__Double();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt64__vrt__GetValueOrDefault__Double()
  :base(Structure_MethodIdCache.MethodIdOf__NullableInt64__vrt__GetValueOrDefault__Double)
 {
 }//ETranslator__NullableInt64__vrt__GetValueOrDefault__Double
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodIdCache.MethodIdOf__NullableInt64__vrt__GetValueOrDefault__Double);
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableInt64__GetValueOrDefault__Double.MethodInfo,
      node_Object,
      node_Arg0);
