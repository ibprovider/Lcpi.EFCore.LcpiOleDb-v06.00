...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Object__NullableDouble

static class Convert_Code__Object__NullableDouble
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Cvt_Code__Object__NullableDouble;

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Object__NullableDouble)
     .GetTypeInfo()
                              ...
                              T_SOURCE              v)
 {
  ...
  const string c_bugcheck_src
   ="Convert_Code__Object__NullableDouble::Exec(cvtCtx,Object)";
