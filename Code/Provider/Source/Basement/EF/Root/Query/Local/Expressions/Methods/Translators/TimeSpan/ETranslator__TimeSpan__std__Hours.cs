...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__TimeSpan__std__Hours

sealed class ETranslator__TimeSpan__std__Hours
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__TimeSpan__std__Hours();

 //-----------------------------------------------------------------------
 private ETranslator__TimeSpan__std__Hours()
  :base(Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Hours)
 {
 }//ETranslator__TimeSpan__std__Hours
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__TimeSpan__std__Hours);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__TimeSpan__Hours.MethodInfo,
      node_Object);
