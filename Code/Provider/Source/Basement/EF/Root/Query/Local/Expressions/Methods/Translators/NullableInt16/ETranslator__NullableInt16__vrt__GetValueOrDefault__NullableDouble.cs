...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt16__vrt__GetValueOrDefault__NullableDouble

sealed class ETranslator__NullableInt16__vrt__GetValueOrDefault__NullableDouble
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableInt16__vrt__GetValueOrDefault__NullableDouble();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt16__vrt__GetValueOrDefault__NullableDouble()
  :base(Structure_MethodIdCache.MethodIdOf__NullableInt16__vrt__GetValueOrDefault__NullableDouble)
 {
 }//ETranslator__NullableInt16__vrt__GetValueOrDefault__NullableDouble
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodIdCache.MethodIdOf__NullableInt16__vrt__GetValueOrDefault__NullableDouble);
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableInt16__GetValueOrDefault__NullableDouble.MethodInfo,
      node_Object,
      node_Arg0);
