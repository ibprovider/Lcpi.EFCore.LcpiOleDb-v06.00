...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__LessThanOrEqual__DateOnly

static class ETranslators__LessThanOrEqual__DateOnly
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__DateOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__LessThanOrEqual___DateOnly__DateOnly.MethodInfo_V_V));

 //----------------------------------------- NULLABLE
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableDateOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__LessThanOrEqual___DateOnly__NullableDateOnly.MethodInfo_V_V));
};//class ETranslators__LessThanOrEqual__DateOnly
