...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__NotEqual__DateOnly

static class ETranslators__NotEqual__DateOnly
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__DateOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___DateOnly__DateOnly.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___DateOnly__DateOnly.Instance);
 ...
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
  sm_Instance__String
   =new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx(Code.Op2_Code__NotEqual___DateOnly__String.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___DateOnly__String.Instance);

 //-------------------------------------------------------- NULLABLE
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableDateOnly
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___DateOnly__NullableDateOnly.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___DateOnly__NullableDateOnly.Instance);
};//class ETranslators__NotEqual__DateOnly
