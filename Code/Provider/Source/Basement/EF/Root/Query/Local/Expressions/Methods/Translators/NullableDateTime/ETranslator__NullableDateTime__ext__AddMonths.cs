...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__ext__AddMonths

sealed class ETranslator__NullableDateTime__ext__AddMonths
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableDateTime__ext__AddMonths();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__ext__AddMonths()
  :base(Structure_MethodIdCache.MethodIdOf__NullableDateTime__ext__AddMonths)
 {
 }//ETranslator__NullableDateTime__ext__AddMonths
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__NullableDateTime__ext__AddMonths);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__NullableDateTime__AddMonths.MethodInfo,
      node_Arg0,
      node_Arg1);
