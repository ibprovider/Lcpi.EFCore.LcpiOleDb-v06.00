...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__String__std__IndexOf__str

sealed class ETranslator__String__std__IndexOf__str
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__String__std__IndexOf__str();

 //-----------------------------------------------------------------------
 private ETranslator__String__std__IndexOf__str()
  :base(Structure_MethodIdCache.MethodIdOf__String__std__IndexOf__str)
 {
 }//ETranslator__String__std__IndexOf__str
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__String__std__IndexOf__str);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__String__IndexOf__str.MethodInfo,
      node_Object,
      node_Arg0);
