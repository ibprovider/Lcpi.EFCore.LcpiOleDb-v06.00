...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateOnly__vrt__Month

sealed class ETranslator__NullableDateOnly__vrt__Month
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableDateOnly__vrt__Month();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateOnly__vrt__Month()
  :base(Structure_MemberIdCache.MemberIdOf__NullableDateOnly__vrt__Month)
 {
 }//ETranslator__NullableDateOnly__vrt__Month
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(DateOnly.Month));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableDateOnly);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableDateOnly__vrt__Month);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableDateOnly__Month.MethodInfo,
      node_Object);
