...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableBoolean__std__HasValue

sealed class ETranslator__NullableBoolean__std__HasValue
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableBoolean__std__HasValue();

 //-----------------------------------------------------------------------
 private ETranslator__NullableBoolean__std__HasValue()
  :base(Structure_MemberIdCache.MemberIdOf__NullableBoolean__std__HasValue)
 {
 }//ETranslator__NullableBoolean__std__HasValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(System.Nullable<System.Boolean>.HasValue));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableBoolean);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableBoolean__std__HasValue);
#endif
