...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeOnly__vrt__Minute

sealed class ETranslator__NullableTimeOnly__vrt__Minute
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeOnly__vrt__Minute();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeOnly__vrt__Minute()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeOnly__vrt__Minute)
 {
 }//ETranslator__NullableTimeOnly__vrt__Minute
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeOnly__vrt__Minute);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableTimeOnly__Minute.MethodInfo,
      node_Object);
