...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___SByte__Byte

sealed class Op2_Code__Equal___SByte__Byte
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__Equal___SByte__Byte
  Instance
   =new Op2_Code__Equal___SByte__Byte();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___SByte__Byte)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___SByte__Byte()
 {
 }//Op2_Code__Equal___SByte__Byte
