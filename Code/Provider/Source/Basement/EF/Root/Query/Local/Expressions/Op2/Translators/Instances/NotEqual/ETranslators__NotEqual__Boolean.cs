...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__NotEqual__Boolean

static class ETranslators__NotEqual__Boolean
{
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__Boolean
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___Boolean__Boolean.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___Boolean__Boolean.Instance);
 ...
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
  sm_Instance__String
   =new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx(Code.Op2_Code__NotEqual___Boolean__String.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___Boolean__String.Instance);

 //-------------------------------------------------------- NULLABLE
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
  sm_Instance__NullableBoolean
   =new LOCAL_EVAL__Op2__ETranslator__Std__Simple__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__Simple(Code.Op2_Code__NotEqual___Boolean__NullableBoolean.MethodInfo_V_V),
      Code.Op2_Code__NotEqual___Boolean__NullableBoolean.Instance);
};//class ETranslators__NotEqual__Boolean
