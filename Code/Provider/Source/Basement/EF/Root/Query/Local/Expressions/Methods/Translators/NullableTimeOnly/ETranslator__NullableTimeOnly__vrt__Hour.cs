...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeOnly__vrt__Hour

sealed class ETranslator__NullableTimeOnly__vrt__Hour
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeOnly__vrt__Hour();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeOnly__vrt__Hour()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeOnly__vrt__Hour)
 {
 }//ETranslator__NullableTimeOnly__vrt__Hour
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(TimeOnly.Hour));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableTimeOnly);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeOnly__vrt__Hour);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableTimeOnly__Hour.MethodInfo,
      node_Object);
