 ...
 public static readonly LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
  sm_Instance__String
   =new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx__Descr
     (new LOCAL_EVAL__Op2__ETranslator__Std__WithOpCtx(Code.Op2_Code__Equal___NullableTimeOnly__String.MethodInfo_V_V),
      Code.Op2_Code__Equal___NullableTimeOnly__String.Instance);
};//class ETranslators__Equal__NullableTimeOnly
