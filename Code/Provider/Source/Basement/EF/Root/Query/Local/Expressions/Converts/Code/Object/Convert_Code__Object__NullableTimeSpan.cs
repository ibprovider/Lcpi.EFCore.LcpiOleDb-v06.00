...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Object__NullableTimeSpan

static class Convert_Code__Object__NullableTimeSpan
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Cvt_Code__Object__NullableTimeSpan;

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Object__NullableTimeSpan)
     .GetTypeInfo()
                              ...
                              T_SOURCE              v)
 {
  ...
  const string c_bugcheck_src
   ="Convert_Code__Object__NullableTimeSpan::Exec(cvtCtx,Object)";
