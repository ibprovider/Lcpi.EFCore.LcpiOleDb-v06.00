...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateOnly__std__DayOfWeek

sealed class ETranslator__DateOnly__std__DayOfWeek
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__DateOnly__std__DayOfWeek();

 //-----------------------------------------------------------------------
 private ETranslator__DateOnly__std__DayOfWeek()
  :base(Structure_MemberIdCache.MemberIdOf__DateOnly__std__DayOfWeek)
 {
 }//ETranslator__DateOnly__std__DayOfWeek
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__DateOnly__std__DayOfWeek);
#endif
