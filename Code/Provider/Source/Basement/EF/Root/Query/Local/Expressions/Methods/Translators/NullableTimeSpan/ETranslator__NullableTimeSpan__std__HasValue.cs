...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeSpan__std__HasValue

sealed class ETranslator__NullableTimeSpan__std__HasValue
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeSpan__std__HasValue();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeSpan__std__HasValue()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__std__HasValue)
 {
 }//ETranslator__NullableTimeSpan__std__HasValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(System.Nullable<System.TimeSpan>.HasValue));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableTimeSpan);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__std__HasValue);
#endif
