...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__NotEqual___String__DateTime

sealed class Op2_Code__NotEqual___String__DateTime
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__NotEqual___String__DateTime
  Instance
   =new Op2_Code__NotEqual___String__DateTime();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__NotEqual___String__DateTime)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__NotEqual___String__DateTime()
 {
 }//Op2_Code__NotEqual___String__DateTime
