...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__ext__AddYears__nullableAmountValue

sealed class ETranslator__DateTime__ext__AddYears__nullableAmountValue
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__ext__AddYears__nullableAmountValue();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__ext__AddYears__nullableAmountValue()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__ext__AddYears)
 {
 }//ETranslator__DateTime__ext__AddYears__nullableAmountValue
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__ext__AddYears);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddYears__nullableAmountValue.MethodInfo,
          node_Arg0,
          node_Arg1);
