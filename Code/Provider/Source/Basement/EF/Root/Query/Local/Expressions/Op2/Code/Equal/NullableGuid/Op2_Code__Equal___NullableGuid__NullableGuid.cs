...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__Equal___NullableGuid__NullableGuid

sealed class Op2_Code__Equal___NullableGuid__NullableGuid
 :Core.Core_Op2<T_ARG1,T_ARG2,T_RESULT>
{
 public static readonly Op2_Code__Equal___NullableGuid__NullableGuid
  Instance
   =new Op2_Code__Equal___NullableGuid__NullableGuid();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__Equal___NullableGuid__NullableGuid)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__Equal___NullableGuid__NullableGuid()
 {
 }//Op2_Code__Equal___NullableGuid__NullableGuid
