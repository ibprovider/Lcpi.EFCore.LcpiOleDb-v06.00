...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateOnly__std__Month

sealed class ETranslator__DateOnly__std__Month
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__DateOnly__std__Month();

 //-----------------------------------------------------------------------
 private ETranslator__DateOnly__std__Month()
  :base(Structure_MemberIdCache.MemberIdOf__DateOnly__std__Month)
 {
 }//ETranslator__DateOnly__std__Month
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__DateOnly__std__Month);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__DateOnly__Month.MethodInfo,
      node_Object);
