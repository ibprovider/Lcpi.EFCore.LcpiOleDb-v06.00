...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__String__std__Replace__str_str

sealed class ETranslator__String__std__Replace__str_str
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__String__std__Replace__str_str();

 //-----------------------------------------------------------------------
 private ETranslator__String__std__Replace__str_str()
  :base(Structure_MethodIdCache.MethodIdOf__String__std__Replace__str_str)
 {
 }//ETranslator__String__std__Replace__str_str
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__String__std__Replace__str_str);
  ...
  Debug.Assert(opData.Arguments[1].Type==Structure_TypeCache.TypeOf__System_String);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__String__Replace___str__str.MethodInfo,
      node_Object,
      node_Arg0,
      node_Arg1);
