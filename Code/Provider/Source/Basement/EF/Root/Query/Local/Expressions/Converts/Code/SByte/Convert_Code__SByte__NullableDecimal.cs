...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__SByte__NullableDecimal

sealed class Convert_Code__SByte__NullableDecimal
 :Core.Core_ValueCvt<T_SOURCE      ,T_TARGET>
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__SByte__NullableDecimal)
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__SByte__NullableDecimal
  Instance
   =new Convert_Code__SByte__NullableDecimal();

 //-----------------------------------------------------------------------
 private Convert_Code__SByte__NullableDecimal()
 {
 }//Convert_Code__SByte__NullableDecimal
