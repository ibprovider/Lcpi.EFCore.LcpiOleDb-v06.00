...
////////////////////////////////////////////////////////////////////////////////
//class ETranslators__From_NullableDateTime

static class ETranslators__From_NullableDateTime
{
 public static readonly LOCAL_EVAL__Convert__Descr
  sm_TO__Object
   =new LOCAL_EVAL__Convert__Descr
     (new LOCAL_EVAL__Convert__ETranslator__STD__SIMPLE(Code.Convert_Code__NullableDateTime__Object.MethodInfo),
      null);

 public static readonly LOCAL_EVAL__Convert__Descr
  sm_TO__String
   =new LOCAL_EVAL__Convert__Descr
     (new LOCAL_EVAL__Convert__ETranslator__STD__WITH_CVT_CTX(Code.Convert_Code__NullableDateTime__String.MethodInfo),
      null);
};//class ETranslators__From_NullableDateTime
