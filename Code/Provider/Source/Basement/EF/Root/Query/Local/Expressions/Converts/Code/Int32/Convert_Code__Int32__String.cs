...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Int32__String

sealed class Convert_Code__Int32__String
 :Core.Core_ValueCvt<T_SOURCE      ,T_TARGET>
 ,Core.Core_ValueCvt<System.Object ,T_TARGET>
{
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Int32__String)
 ...
 //-----------------------------------------------------------------------
 public static readonly Convert_Code__Int32__String
  Instance
   =new Convert_Code__Int32__String();

 //-----------------------------------------------------------------------
 private Convert_Code__Int32__String()
 {
 }//Convert_Code__Int32__String
 ...
 {
  return MasterCode.Convert_MasterCode__Int32__String.Exec
          (v);
 }//Exec
};//class Convert_Code__Int32__String
