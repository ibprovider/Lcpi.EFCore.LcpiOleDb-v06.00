...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeSpan__vrt__Seconds

sealed class ETranslator__NullableTimeSpan__vrt__Seconds
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeSpan__vrt__Seconds();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeSpan__vrt__Seconds()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Seconds)
 {
 }//ETranslator__NullableTimeSpan__vrt__Seconds
 ...
 public override Expression Translate(in tagOpData opData)
 {
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Seconds);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableTimeSpan__Seconds.MethodInfo,
      node_Object);
