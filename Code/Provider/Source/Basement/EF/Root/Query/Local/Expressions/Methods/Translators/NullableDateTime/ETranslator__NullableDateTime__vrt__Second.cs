...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__vrt__Second

sealed class ETranslator__NullableDateTime__vrt__Second
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableDateTime__vrt__Second();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__vrt__Second()
  :base(Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__Second)
 {
 }//ETranslator__NullableDateTime__vrt__Second
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__Second);
#endif
