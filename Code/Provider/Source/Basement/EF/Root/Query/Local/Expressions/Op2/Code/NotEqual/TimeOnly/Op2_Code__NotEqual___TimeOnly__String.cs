...
////////////////////////////////////////////////////////////////////////////////
//class Op2_Code__NotEqual___TimeOnly__String

sealed class Op2_Code__NotEqual___TimeOnly__String
 :Core.Core_Op2<object,object,T_RESULT>
{
 public static readonly Op2_Code__NotEqual___TimeOnly__String
  Instance
   =new Op2_Code__NotEqual___TimeOnly__String();

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo_V_V
   =typeof(Op2_Code__NotEqual___TimeOnly__String)
     .GetTypeInfo()
     .GetDeclaredMethod(nameof(Exec_V_V));

 //-----------------------------------------------------------------------
 private Op2_Code__NotEqual___TimeOnly__String()
 {
 }//Op2_Code__NotEqual___TimeOnly__String
