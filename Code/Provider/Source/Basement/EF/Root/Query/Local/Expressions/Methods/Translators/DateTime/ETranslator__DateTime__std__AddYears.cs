...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__AddYears

sealed class ETranslator__DateTime__std__AddYears
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateTime__std__AddYears();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__AddYears()
  :base(Structure_MethodIdCache.MethodIdOf__DateTime__std__AddYears)
 {
 }//ETranslator__DateTime__std__AddYears
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateTime__std__AddYears);
  ...
  var r=Expression.Call
         (Code.Method_Code__DateTime__AddYears.MethodInfo,
          node_Object,
          node_Arg0);
