...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateTime__std__Month

sealed class ETranslator__DateTime__std__Month
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__DateTime__std__Month();

 //-----------------------------------------------------------------------
 private ETranslator__DateTime__std__Month()
  :base(Structure_MemberIdCache.MemberIdOf__DateTime__std__Month)
 {
 }//ETranslator__DateTime__std__Month
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__DateTime__std__Month);
#endif
