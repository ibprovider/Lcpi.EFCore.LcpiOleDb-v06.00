...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt64__vrt__GetValueOrDefault__Int64

sealed class ETranslator__NullableInt64__vrt__GetValueOrDefault__Int64
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableInt64__vrt__GetValueOrDefault__Int64();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt64__vrt__GetValueOrDefault__Int64()
  :base(Structure_MethodIdCache.MethodIdOf__NullableInt64__vrt__GetValueOrDefault__Int64)
 {
 }//ETranslator__NullableInt64__vrt__GetValueOrDefault__Int64
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodIdCache.MethodIdOf__NullableInt64__vrt__GetValueOrDefault__Int64);
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableInt64__GetValueOrDefault__Int64.MethodInfo,
      node_Object,
      node_Arg0);
