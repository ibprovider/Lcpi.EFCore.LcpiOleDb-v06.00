...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__DateOnly__std__AddMonths

sealed class ETranslator__DateOnly__std__AddMonths
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__DateOnly__std__AddMonths();

 //-----------------------------------------------------------------------
 private ETranslator__DateOnly__std__AddMonths()
  :base(Structure_MethodIdCache.MethodIdOf__DateOnly__std__AddMonths)
 {
 }//ETranslator__DateOnly__std__AddMonths
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodInfoCache.MethodInfoOf__DateOnly__std__AddMonths);
  ...
  var r
   =Expression.Call
     (Code.Method_Code__DateOnly__AddMonths.MethodInfo,
      node_Object,
      node_Arg0);
