...
////////////////////////////////////////////////////////////////////////////////
//class Method_Code__Math__Sign__NullableSingle

static class Method_Code__Math__Sign__NullableSingle
{
 private static readonly System.Reflection.MethodInfo sm_MethodInfo
  =typeof(Method_Code__Math__Sign__NullableSingle)
    .GetTypeInfo()
    .GetDeclaredMethod(nameof(Exec));

 //-----------------------------------------------------------------------
 private static Nullable<Int32> Exec(Nullable<Single> value)
 {
  if(!value.HasValue)
   return null;
 ...
 public static MethodCallExpression CreateCallExpression(Expression e)
 {
  ...
  Debug.Assert(e.Type==Structure.Structure_TypeCache.TypeOf__System_NullableSingle);
