...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableTimeSpan__vrt__Hours

sealed class ETranslator__NullableTimeSpan__vrt__Hours
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableTimeSpan__vrt__Hours();

 //-----------------------------------------------------------------------
 private ETranslator__NullableTimeSpan__vrt__Hours()
  :base(Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Hours)
 {
 }//ETranslator__NullableTimeSpan__vrt__Hours
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MemberId.MemberName==nameof(TimeSpan.Hours));
  Debug.Assert(opData.Expression.Type==Structure_TypeCache.TypeOf__System_NullableTimeSpan);

#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableTimeSpan__vrt__Hours);
#endif
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableTimeSpan__Hours.MethodInfo,
      node_Object);
