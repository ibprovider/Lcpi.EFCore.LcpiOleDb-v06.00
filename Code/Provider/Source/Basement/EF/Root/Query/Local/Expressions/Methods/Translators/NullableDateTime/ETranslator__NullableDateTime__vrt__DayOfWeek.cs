...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableDateTime__vrt__DayOfWeek

sealed class ETranslator__NullableDateTime__vrt__DayOfWeek
 :LcpiOleDb__LocalEval_MemberTranslator
{
 public static readonly LcpiOleDb__LocalEval_MemberTranslator
  Instance
   =new ETranslator__NullableDateTime__vrt__DayOfWeek();

 //-----------------------------------------------------------------------
 private ETranslator__NullableDateTime__vrt__DayOfWeek()
  :base(Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__DayOfWeek)
 {
 }//ETranslator__NullableDateTime__vrt__DayOfWeek
...
#if DEBUG
  Debug.Assert(opData.MemberId==Structure_MemberIdCache.MemberIdOf__NullableDateTime__vrt__DayOfWeek);
#endif
