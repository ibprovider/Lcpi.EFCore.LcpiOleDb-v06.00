...
////////////////////////////////////////////////////////////////////////////////
//class ETranslator__NullableInt16__vrt__HasFlag__NullableInt16

sealed class ETranslator__NullableInt16__vrt__HasFlag__NullableInt16
 :Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
{
 public static readonly Root.Query.Local.LcpiOleDb__LocalEval_MethodCallTranslator
  Instance
   =new ETranslator__NullableInt16__vrt__HasFlag__NullableInt16();

 //-----------------------------------------------------------------------
 private ETranslator__NullableInt16__vrt__HasFlag__NullableInt16()
  :base(Structure_MethodIdCache.MethodIdOf__NullableInt16__vrt__HasFlag__NullableInt16)
 {
 }//ETranslator__NullableInt16__vrt__HasFlag__NullableInt16
 ...
 public override Expression Translate(in tagOpData opData)
 {
  ...
  Debug.Assert(opData.MethodId==Structure_MethodIdCache.MethodIdOf__NullableInt16__vrt__HasFlag__NullableInt16);
  ...
  var result
   =Expression.Call
     (Code.Method_Code__NullableInt16__HasFlag__NullableInt16.MethodInfo,
      node_Object,
      node_Arg0);
