...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__Object__NullableSingle

static class Convert_Code__Object__NullableSingle
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Root_Query_Local_Expressions__Cvt_Code__Object__NullableSingle;

 //-----------------------------------------------------------------------
 public static readonly System.Reflection.MethodInfo
  MethodInfo
   =typeof(Convert_Code__Object__NullableSingle)
     .GetTypeInfo()
                              ...
                              T_SOURCE              v)
 {
  ...
  const string c_bugcheck_src
   ="Convert_Code__Object__NullableSingle::Exec(cvtCtx,Object)";
