...
////////////////////////////////////////////////////////////////////////////////
//class Convert_Code__STRING__TIMESTAMP___D1

static class Convert_Code__STRING__TIMESTAMP___D1
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Core_Engines_Dbms_FB_Common_Mirror__Convert_Code__STRING__TIMESTAMP___D1;
 ...
 public static System.DateTime Exec(System.String strValue)
 {
  ...
  var r1
   =Helpers.Convert_Helper__ParserPart__STRING_DATE___D1.Exec
    (strValue,
     offset,
     out part_Year,
     out part_Month,
  ...
  if(r1.Code!=Helpers.Convert_Helper__ParserPart__STRING_DATE___D1.ExecResultCode.Ok)
  {
  ...
  Debug.Assert(r1.Code==Helpers.Convert_Helper__ParserPart__STRING_DATE___D1.ExecResultCode.Ok);
...
};//Convert_Code__STRING__TIMESTAMP___D1
