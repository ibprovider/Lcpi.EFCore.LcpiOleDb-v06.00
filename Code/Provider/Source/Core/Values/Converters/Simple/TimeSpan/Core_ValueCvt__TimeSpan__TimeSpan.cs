...
////////////////////////////////////////////////////////////////////////////////
//class Core_ValueCvt__TimeSpan__TimeSpan

sealed class Core_ValueCvt__TimeSpan__TimeSpan
 :Core_ValueCvt<object,object>
{
 public static readonly Core_ValueCvt__TimeSpan__TimeSpan
  Instance
   =new Core_ValueCvt__TimeSpan__TimeSpan();
                  ...
                  out object       targetValue)
 {
  ...
  Debug.Assert(targetValue.GetType()==Structure_TypeCache.TypeOf__System_TimeSpan);
 }//Exec
};//class Core_ValueCvt__TimeSpan__TimeSpan
