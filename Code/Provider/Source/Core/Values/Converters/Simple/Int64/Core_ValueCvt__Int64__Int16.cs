...
////////////////////////////////////////////////////////////////////////////////
//class Core_ValueCvt__Int64__Int16

sealed class Core_ValueCvt__Int64__Int16
 :Core_ValueCvt<object,object>
{
 private const ErrSourceID
  c_ErrSrcID
   =ErrSourceID.Core_ValueCvt__Int64__Int16;

 //-----------------------------------------------------------------------
 public static readonly Core_ValueCvt__Int64__Int16
  Instance
   =new Core_ValueCvt__Int64__Int16();
                  ...
                  out object       targetValue)
 {
  ...
  {
   //ERROR - can't convert Int64 value into Int16 value
