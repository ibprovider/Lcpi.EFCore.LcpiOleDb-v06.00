...
using LcpiOleDb__ExpressionType
    =Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.LcpiOleDb__ExpressionType;
...
namespace Lcpi.EXT.Microsoft.EntityFrameworkCore.Query
{
    ...
    /*public*/ class RelationalQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
    {
        ...
        private readonly Internal.RelationalProjectionBindingExpressionVisitor _projectionBindingExpressionVisitor;
        ...
        /// <param name="lcpi_sqlTreeNodeBuilder"> SQL tree builder. </param>
            ...
            : base(dependencies, queryCompilationContext, subquery: false)
        {
            ...
            Check.NotNull(lcpi_sqlTreeNodeBuilder, nameof(lcpi_sqlTreeNodeBuilder));
            ...
            _projectionBindingExpressionVisitor = new Internal.RelationalProjectionBindingExpressionVisitor(this, _sqlTranslator);
            ...
            : base(parentVisitor.Dependencies, parentVisitor.QueryCompilationContext, subquery: true)
        {
            ...
            m_lcpi_sqlTreeNodeBuilder = parentVisitor.m_lcpi_sqlTreeNodeBuilder;
        }
            ...
            Type resultType)
        {
            ...
            // LCPI: Research. Check the "always non-null".
            Debug.Assert(!Object.ReferenceEquals(projection,null));
            Debug.Assert(projection is SqlExpression);

            // LCPI:
            // SqlExpression.Type always describes NOT NULL data type
            // Expected that we work with INT/DOUBLE/DECIMAL
            Debug.Assert(!projection.Type.IsNullableValueType());

            /* LCPI */ var resultType_u
            /* LCPI */  =Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.LcpiOleDb__Extensions__Type.Extension__GetUnderlyingValueType(resultType);

            /* LCPI */ Debug.Assert(!Object.ReferenceEquals(resultType_u,null));

            /* LCPI */ if(projection.Type != resultType_u)
            /* LCPI */ {
            /* LCPI */  projection
            /* LCPI */   =m_lcpi_sqlTreeNodeBuilder.MakeUnary
            /* LCPI */     (LcpiOleDb__ExpressionType.Convert,
            /* LCPI */      projection,
            /* LCPI */      resultType_u);
            /* LCPI */ }//if
            ...
            if (throwWhenEmpty)
            {
                ...
                // LCPI
                Debug.Assert(Object.ReferenceEquals(selectExpression,source.QueryExpression));
