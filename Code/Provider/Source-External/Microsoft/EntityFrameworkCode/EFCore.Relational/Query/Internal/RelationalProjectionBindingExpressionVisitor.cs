...
namespace Lcpi.EXT.Microsoft.EntityFrameworkCore.Query.Internal
{
    ...
    /*public*/ class RelationalProjectionBindingExpressionVisitor : ExpressionVisitor
    {
        ...
        public override Expression? Visit(Expression? expression)
        {
            ...
            if (expression is Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Basement.EF.Root.Query.Expressions.LcpiOleDb__SqlStubExpression stubExpression)
            {
                //
                // [2021-12-07]
                //
                //  Unwrapping our SqlStubExpression.
                //
                //  It resolves a problem with specification test
                //    NorthwindMiscellaneousQueryTestBase.Context_based_client_method
                //    NorthwindMiscellaneousQueryTestBase.Client_code_using_instance_in_anonymous_type
                //

                System.Diagnostics.Debug.Assert(!Object.ReferenceEquals(stubExpression.InnerExpression, null));

                var r1 = this.Visit(stubExpression.InnerExpression);

                if (r1 == QueryCompilationContext.NotTranslatedExpression)
                    return r1;
                ...
                if (Object.ReferenceEquals(r1, null))
                    throw new InvalidOperationException(CoreStrings.TranslationFailed(stubExpression.InnerExpression.Print()));

                System.Diagnostics.Debug.Assert(!Object.ReferenceEquals(r1, null));

                var r2 = Expression.Convert(r1, stubExpression.Type);

                System.Diagnostics.Debug.Assert(!Object.ReferenceEquals(r2, null));
