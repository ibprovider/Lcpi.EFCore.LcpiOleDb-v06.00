...
//LCPI: using Microsoft.EntityFrameworkCore.Utilities;
...
namespace Lcpi.EXT.Microsoft.EntityFrameworkCore.Query.Internal
{
    ...
    /// </summary>
    /*LCPI: public*/ class QueryOptimizingExpressionVisitor : ExpressionVisitor
    {
        ...
        //----------------------------------------------------------------
        protected enum LCPI__OptimizationRule
        {
         VisitMethodCall__PreOpt_001    =11,

         VisitMethodCall__PreOpt_002    =21,

         VisitMethodCall__PreOpt_003    =31,

         VisitMethodCall__PostOpt_001   =101,
        };//enum LCPI__OptimizationRule

        //----------------------------------------------------------------
        protected virtual bool LCPI__GetPermissionForOptimization(LCPI__OptimizationRule optRule)
        {
         return true;
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
                ...
                || Equals(_endsWithMethodInfo, methodCallExpression.Method))
            {
                    ...
                    && stringValue == string.Empty)
                {
                    ...
                    if(!this.LCPI__GetPermissionForOptimization(LCPI__OptimizationRule.VisitMethodCall__PreOpt_001))
                ...
                && (left is ParameterExpression || right is ParameterExpression))
            {
                ...
                if (methodInfo.Equals(EnumerableMethods.AnyWithPredicate)
                    && !negated)
                {
                    if(!this.LCPI__GetPermissionForOptimization(LCPI__OptimizationRule.VisitMethodCall__PreOpt_002))
                        return methodCallExpression;
            ...
            {
                if(!this.LCPI__GetPermissionForOptimization(LCPI__OptimizationRule.VisitMethodCall__PreOpt_003))
                    return methodCallExpression;
            ...
            {
                if(!this.LCPI__GetPermissionForOptimization(LCPI__OptimizationRule.VisitMethodCall__PostOpt_001))
                    return methodCallExpression;
