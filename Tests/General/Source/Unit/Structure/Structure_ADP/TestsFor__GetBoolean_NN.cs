...
////////////////////////////////////////////////////////////////////////////////
//class TestsFor__GetBoolean_NN

public static class TestsFor__GetBoolean_NN
{
 [Test]
 public static void Test_01()
 {
  ...
  var col=table.Columns.Add("ccc",typeof(bool));

  var row=table.NewRow();

  const bool c_test_value=true;
  ...
  Assert.AreEqual
   (c_test_value,
    xEFCore_s.Structure_ADP.GetBoolean_NN
