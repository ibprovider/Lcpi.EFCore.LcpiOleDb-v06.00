...
////////////////////////////////////////////////////////////////////////////////
//class Test_T001__STD

static class Test_T001__STD
{
 private class T_OBJECT
 {
  ...
  //-------------------------------------------------------
  public T Exec2<T>(T x,TestTypes.Enums.EnumInt64 e)
  {
   return x;
  }//Exec2

  public T Exec2<T>(T x,System.Int64 e)
  {
   return x;
  }//Exec2

  //-------------------------------------------------------
  public T Exec3<T>(T x,TestTypes.Enums.EnumInt64 e)
  {
   return x;
  }//Exec3

  //-------------------------------------------------------
  public T Exec4<T>(T x,TestTypes.Enums.EnumInt64 e)
  {
   return x;
  }//Exec4

  static public T Exec4<T>(T x,System.Int64 e)
  {
   return x;
  }//Exec4
 };//class T_OBJECT
  ...
  catch(structure_lib.exceptions.t_invalid_operation_exception e)
  {
   ...
   CheckErrors.CheckErrorRecord__common_err__cant_remap_generic_method_4
    (TestUtils.GetRecord(e,0),
     ...
     "EFCore_LcpiOleDb_Tests.General.Unit.Structure.Structure_SwitchToUnderlying.Exec__MethodInfo.Test_T001__STD+T_OBJECT.Exec3<EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt16>(EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt16, EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt64)",
     "EFCore_LcpiOleDb_Tests.General.Unit.Structure.Structure_SwitchToUnderlying.Exec__MethodInfo.Test_T001__STD+T_OBJECT",
 ...
 public static void Test_ERR002__Exec4()
 {
  ...
  catch(structure_lib.exceptions.t_invalid_operation_exception e)
  {
   ...
   CheckErrors.CheckErrorRecord__common_err__cant_remap_generic_method_4
    (TestUtils.GetRecord(e,0),
     CheckErrors.c_src__EFCoreDataProvider__Structure_SwitchToUnderlying,
     "EFCore_LcpiOleDb_Tests.General.Unit.Structure.Structure_SwitchToUnderlying.Exec__MethodInfo.Test_T001__STD+T_OBJECT.Exec4<EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt16>(EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt16, EFCore_LcpiOleDb_Tests.General.TestTypes.Enums.EnumInt64)",
     "EFCore_LcpiOleDb_Tests.General.Unit.Structure.Structure_SwitchToUnderlying.Exec__MethodInfo.Test_T001__STD+T_OBJECT",
     "System.Int16, System.Int64",
     "System.Int16");
