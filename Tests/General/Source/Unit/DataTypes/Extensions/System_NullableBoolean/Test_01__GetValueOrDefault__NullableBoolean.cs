...
namespace EFCore_LcpiOleDb_Tests.General.Unit.DataTypes.Extensions.System_NullableBoolean{
////////////////////////////////////////////////////////////////////////////////
//class Test_01__GetValueOrDefault__NullableBoolean

public static class Test_01__GetValueOrDefault__NullableBoolean
{
#if(!DEBUG)
 [Test]
 public static void Test_01__TryCall()
 {
  System.Boolean? d=true;

  System.Boolean? defaultValue=false;
  ...
  catch(structure_lib.exceptions.t_invalid_operation_exception e)
  {
   ...
   CheckErrors.CheckErrorRecord__common_err__direct_call_of_linq_method_not_allowed_1
    (TestUtils.GetRecord(e,0),
     CheckErrors.c_src__EFCoreDataProvider__DataTypes_Extensions__System_NullableBoolean,
