...
namespace EFCore_LcpiOleDb_Tests.General.Unit.DataTypes.Extensions.System_NullableTimeOnly{
////////////////////////////////////////////////////////////////////////////////
//using
...
////////////////////////////////////////////////////////////////////////////////
//class Test_02__AddHours

public static class Test_02__AddHours
{
#if(!DEBUG)
 [Test]
  ...
  catch(structure_lib.exceptions.t_invalid_operation_exception e)
  {
   ...
   CheckErrors.CheckErrorRecord__common_err__direct_call_of_linq_method_not_allowed_1
    (TestUtils.GetRecord(e,0),
     CheckErrors.c_src__EFCoreDataProvider__DataTypes_Extensions__System_NullableTimeOnly,
