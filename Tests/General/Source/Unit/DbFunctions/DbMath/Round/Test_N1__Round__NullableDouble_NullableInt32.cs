...
////////////////////////////////////////////////////////////////////////////////
//class Test_N1__Round__nullableDouble_nullableScale

public static class Test_N1__Round__nullableDouble_nullableScale
{
#if(!DEBUG)
 [Test]
  ...
  catch(structure_lib.exceptions.t_invalid_operation_exception e)
  {
   ...
   CheckErrors.CheckErrorRecord__common_err__direct_call_of_linq_method_not_allowed_1
    (TestUtils.GetRecord(e,0),
     ...
     "Round(Nullable<Double>, Nullable<Int32>)");
