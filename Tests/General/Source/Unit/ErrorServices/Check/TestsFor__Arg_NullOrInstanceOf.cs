...
////////////////////////////////////////////////////////////////////////////////
//class TestsFor__Arg_NullOrInstanceOf

public static class TestsFor__Arg_NullOrInstanceOf
{
 class TBase
 {
 };//class TBase
 ...
 public static void Test_01__ok()
 {
  ...
  TObj x
   =xEFCore.Check.Arg_NullOrInstanceOf<TObj,TBase>
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_02__ok__null()
 {
  TObj x
   =xEFCore.Check.Arg_NullOrInstanceOf<TObj,TBase>
     (xEFCore.ErrSourceID.Core_ConnectionOptionsInitializer,
