...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.And.Complete.NullableBoolean.NullableBoolean{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" AND ").N("t",c_NameOf__COL_DATA2).T(") = TRUE) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
       .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" AND ").N("t",c_NameOf__COL_DATA2).T(" AND ").N("t",c_NameOf__COL_DATA2).T(") = TRUE) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_01a01__false__null__eq__false()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
       .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" AND ").N("t",c_NameOf__COL_DATA2).T(") = FALSE) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
 ...
 }//Test_01a01__false__null__eq__false

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_01a02__false__null__eq__true()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_01a02__false__null__eq__false

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_01a03__true__null__eq__false()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_01a03__true__null__eq__false

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_01a04__true__null__eq__true()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_01a04__true__null__eq__true
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_11a01__null__null__eq__false()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_11a01__null__null__eq__false

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_11a01__null__null__eq__true()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_11a01__null__null__eq__true
