...
//
// (short)bigint_column==(short)long_constant
//
using System;
...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.Int64.EnumInt16{
////////////////////////////////////////////////////////////////////////////////

using T_SOURCE_VALUE=System.Int64;
using T_TARGET_VALUE=TestTypes.Enums.EnumInt16;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_TARGET_VALUE c_valueTarget=T_TARGET_VALUE_U.negative__ONE;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_TARGET_VALUE c_valueTarget=T_TARGET_VALUE_U.ZERO;
 ...
 public static void Test_006__p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE c_valueSource=+1;
     const T_TARGET_VALUE c_valueTarget=T_TARGET_VALUE_U.positive__ONE;
