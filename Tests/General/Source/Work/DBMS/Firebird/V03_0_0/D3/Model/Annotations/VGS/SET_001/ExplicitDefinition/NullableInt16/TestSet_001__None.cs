...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Model.Annotations.VGS.SET_001.ExplicitDefinition.NullableInt16{
////////////////////////////////////////////////////////////////////////////////

using T_ID  =System.Nullable<System.Int16>;
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    var expectedSQL1
     =new TestSqlTemplate()
       ...
       .T("    ").N(c_NameOf__COL__ID).T(" SMALLINT NOT NULL,").CRLF()
