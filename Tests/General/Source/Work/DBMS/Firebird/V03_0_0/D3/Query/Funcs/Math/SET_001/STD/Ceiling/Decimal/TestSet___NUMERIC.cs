...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.Math.SET_001.STD.Ceiling.Decimal{
////////////////////////////////////////////////////////////////////////////////
//using
...
public static class TestSet___NUMERIC
{
 ...
 {
  Assert.AreEqual( 1.0M ,System.Math.Ceiling(1.0M));
  Assert.AreEqual( 2.0M ,System.Math.Ceiling(1.1M));
  Assert.AreEqual( 2.0M ,System.Math.Ceiling(1.9M));
  Assert.AreEqual( 2.0M ,System.Math.Ceiling(2.0M));
  Assert.AreEqual(-2.0M ,System.Math.Ceiling(-2.0M));
  Assert.AreEqual(-1.0M ,System.Math.Ceiling(-1.9M));
  Assert.AreEqual(-1.0M ,System.Math.Ceiling(-1.1M));
  Assert.AreEqual(-1.0M ,System.Math.Ceiling(-1.0M));
 }//Test___00
