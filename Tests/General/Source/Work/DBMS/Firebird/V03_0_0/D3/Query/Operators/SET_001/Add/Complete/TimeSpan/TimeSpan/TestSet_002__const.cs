...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.TimeSpan.TimeSpan{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_003__mcs()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(12,10,8);
     T_DATA2 c_value2=new T_DATA2_U(5,3,59)+new T_DATA2_U(1000);
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1+(T_DATA2)(new T_DATA2_U(5,3,59)+new T_DATA2_U(1000)))==((T_DATA2)new T_DATA2_U(17,14,7)+new T_DATA2_U(1000)) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" + CAST(18239.0001 AS NUMERIC(18,4))) = CAST(62047.0001 AS NUMERIC(18,4))) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
