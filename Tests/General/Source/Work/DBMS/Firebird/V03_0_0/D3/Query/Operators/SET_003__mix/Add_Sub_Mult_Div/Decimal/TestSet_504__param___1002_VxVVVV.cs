...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_504__param___1002_VxVVVV

public static class TestSet_504__param___1002_VxVVVV
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     // 16 + 8 - 4 * 2 / 1 + 0 == 16
     var recs=db.testTable.Where(r => (string)(object)(vv1_1+((T_DATA1)vx1_2.Length)-vv1_3*vv1_4/vv1_5+vv1_6)=="16.00000000000000");
