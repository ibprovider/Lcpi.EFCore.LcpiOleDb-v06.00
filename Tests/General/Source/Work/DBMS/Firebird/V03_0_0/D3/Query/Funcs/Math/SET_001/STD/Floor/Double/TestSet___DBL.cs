...
public static class TestSet___DBL
{
 ...
 {
  Assert.AreEqual( 1.0 ,System.Math.Floor(1.0));
  Assert.AreEqual( 1.0 ,System.Math.Floor(1.1));
  Assert.AreEqual( 1.0 ,System.Math.Floor(1.9));
  Assert.AreEqual( 2.0 ,System.Math.Floor(2.0));
  Assert.AreEqual(-2.0 ,System.Math.Floor(-2.0));
  Assert.AreEqual(-2.0 ,System.Math.Floor(-1.9));
  Assert.AreEqual(-2.0 ,System.Math.Floor(-1.1));
  Assert.AreEqual(-1.0 ,System.Math.Floor(-1.0));
 }//Test___00
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Floor(r.DATA)==1 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        ...
        .T("WHERE (FLOOR(").N("n",c_NameOf__COL_DATA).T(") = 1.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Floor(r.DATA)==2 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (FLOOR(").N("n",c_NameOf__COL_DATA).T(") = 2.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Floor(System.Math.Floor(r.DATA))==1 && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Floor(2*System.Math.Floor(r.DATA))==2 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (FLOOR(2.0 * FLOOR(").N("n",c_NameOf__COL_DATA).T(")) = 2.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
