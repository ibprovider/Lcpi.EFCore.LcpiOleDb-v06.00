...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.Object.SET_001.STD.Equals__obj2.Complete.DateOnly.DateTime{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_902__field__field___not_equal()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_902__field__field___not_equal
