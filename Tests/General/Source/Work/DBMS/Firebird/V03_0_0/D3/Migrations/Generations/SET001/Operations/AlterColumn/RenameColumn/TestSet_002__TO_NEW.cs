...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_002__TO_NEW

public static class TestSet_002__TO_NEW
{
 private const string c_NameOf_Table
  ="TEST_TABLE";

 private const string c_NameOf_Column_OLD
  ="OLD_NAME";

 private const string c_NameOf_Column_NEW
  ="NEW_NAME";
 ...
 public static void Test_0001()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("ALTER TABLE ").N(c_NameOf_Table).T(" ALTER COLUMN ").N(c_NameOf_Column_OLD).T(" TO ").N(c_NameOf_Column_NEW).T(";").CRLF();
