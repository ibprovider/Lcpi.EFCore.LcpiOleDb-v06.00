...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).EndsWith('4')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).EndsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).EndsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
