...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.TypeMapping.Group002.BLOB_TEXT{
////////////////////////////////////////////////////////////////////////////////

using TEST_COL_TYPE=String;

////////////////////////////////////////////////////////////////////////////////
//class TestSet__String

public static class TestSet__String
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   [Column("COL_TEXT_BLOB", TypeName="BLOB SUB_TYPE TEXT")]
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    //------------------
    cmd.CommandText="select COL_TEXT_BLOB from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();
