...
//
// (short)double_column==(short)double_param
//
using System;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     object vv=c_valueSource;

     var recs=db.testTable.Where(r => (object)(T_TARGET_VALUE)r.COL_SOURCE==(object)(T_TARGET_VALUE)vv && r.TEST_ID==testID);
 ...
 public static void Test_MM001__min()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=T_TARGET_VALUE_U.MinValue;
     const T_TARGET_VALUE_U c_valueTarget_=+1;
 ...
 public static void Test_MM002__max()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=T_TARGET_VALUE_U.MaxValue;
     const T_TARGET_VALUE_U c_valueTarget_=+1;
 ...
 public static void Test_MM003__minP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=-32768.9D;
     const T_TARGET_VALUE_U c_valueTarget_=+1;
 ...
 public static void Test_MM004__maxP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=32767.9D;
     const T_TARGET_VALUE_U c_valueTarget_=+1;
