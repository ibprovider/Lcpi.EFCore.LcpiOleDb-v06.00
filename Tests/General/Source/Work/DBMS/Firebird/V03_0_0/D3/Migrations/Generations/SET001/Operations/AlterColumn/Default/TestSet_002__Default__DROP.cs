...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_002__Default__DROP

public static class TestSet_002__Default__DROP
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_0002__old_with_defaultValue()
 {
  var operation
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("ALTER TABLE ").N(c_NameOf_Table).T(" ALTER COLUMN ").N(c_NameOf_Column).T(" DROP DEFAULT;").CRLF();

  TestHelper.Exec
   (new[]{operation},
    new[]{expectedSQL});
 }//Test_0002__old_with_defaultValue

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_0003__old_with_defaultValueSql()
 {
  var operation
   =new EF_MnOP.AlterColumnOperation
    {
  ...
  TestHelper.Exec
   (new[]{operation},
    new[]{expectedSQL});
 }//Test_0003__old_with_defaultValueSql
};//class TestSet_002__Default__DROP
