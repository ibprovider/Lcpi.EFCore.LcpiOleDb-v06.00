...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.NotEqual.Complete.NewArray1_Int32.NewArray1_Int32{
////////////////////////////////////////////////////////////////////////////////

using T_ARR1_E =System.Int32;
using T_ARR2_E =System.Int32;
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((3 <> ").N("t",c_NameOf__COL_DATA1).T(") OR (4 <> ").N("t",c_NameOf__COL_DATA2).T(")) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((22 <> ").N("t",c_NameOf__COL_DATA1).T(") OR (44 <> ").N("t",c_NameOf__COL_DATA2).T(")) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
