  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.EndsWith("2"+"3") && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (RIGHT(").N("t",c_NameOf__COL_DATA).T(", 2) = _utf8 '23') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
