 ...
 public static void Test_001__min_m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE_U c_valueSource_=((T_SOURCE_VALUE_U)T_TARGET_VALUE_U.MinValue)-1;
 ...
 public static void Test_002__max_p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE_U c_valueSource_=((T_SOURCE_VALUE_U)T_TARGET_VALUE_U.MaxValue)+1;
     const T_TARGET_VALUE_U c_valueTarget_=-1;
