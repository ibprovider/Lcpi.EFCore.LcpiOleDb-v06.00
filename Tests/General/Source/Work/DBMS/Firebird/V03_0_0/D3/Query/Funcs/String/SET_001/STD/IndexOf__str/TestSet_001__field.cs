    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((POSITION(_utf8 'BC12', ").N("t",c_NameOf__COL_DATA).T(") - 1) = 1) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).T(", ").N("t",c_NameOf__COL_SEEK).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (CAST((POSITION(_utf8 'BC12', ").N("t",c_NameOf__COL_DATA).T(") - 1) AS VARCHAR(20)) = _utf8 '1') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).T(", ").N("t",c_NameOf__COL_SEEK).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (CAST((POSITION(_utf8 'BC12', ").N("t",c_NameOf__COL_DATA).T(") - 1) AS BIGINT) = 1) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).T(", ").N("t",c_NameOf__COL_SEEK).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((POSITION(_utf8 'BC1X', ").N("t",c_NameOf__COL_DATA).T(") - 1) = -1) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
