...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_020__TYPE_TIME__as_TimeOnly

public static class TestSet_020__TYPE_TIME__as_TimeOnly
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public class TEST_MODIFY_ROW_WD
  {
   ...
   public TimeOnly COL_TYPE_TIME { get; set; }
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var cmd=new xdb.OleDbCommand())
    {
     ...
     cmd.CommandText
      ="insert into TEST_MODIFY_ROW_WD (COL_TYPE_TIME) values ('22:03:17')\n"
      +"returning TEST_ID\n"
      +"INTO :TEST_ID";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     foreach(var rec in db.testTable.Where(r=>r.TEST_ID==(Int64)recID))
     {
      ...
      Assert.AreEqual(new TimeOnly(22,3,17),rec.COL_TYPE_TIME);
     }//foreach
