...
public static class TestSet__004__param
{
 ...
 private const T_SOURCE_VALUE_U c_valueSource_MIN=T_SOURCE_VALUE_U.MinValue;
 private const T_SOURCE_VALUE_U c_valueSource_MAX=T_SOURCE_VALUE_U.MaxValue;
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").N("t",c_NameOf__COL_SOURCE).T(" = ").P_R8("__p_0").T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
 ...
 public static void Test_MM001__min()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE_U c_valueSource_=c_valueSource_MIN;
     const T_TARGET_VALUE   c_valueTarget=+1;
