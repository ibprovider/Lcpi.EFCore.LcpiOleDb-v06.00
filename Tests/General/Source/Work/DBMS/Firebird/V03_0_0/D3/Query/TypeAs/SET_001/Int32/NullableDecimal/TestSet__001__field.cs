...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.TypeAs.SET_001.Int32.NullableDecimal{
////////////////////////////////////////////////////////////////////////////////
...
#pragma warning disable CS0458 // The result of the expression is always 'null'
     var recs=db.testTable.Where(r => (r.COL_SOURCE as T_TARGET_VALUE)==-1 && r.TEST_ID==testID);
...
#pragma warning disable CS0458 // The result of the expression is always 'null'
     var recs=db.testTable.Where(r => (r.COL_SOURCE as T_TARGET_VALUE)==0 && r.TEST_ID==testID);
#pragma warning restore CS0458 // The result of the expression is always 'null'
