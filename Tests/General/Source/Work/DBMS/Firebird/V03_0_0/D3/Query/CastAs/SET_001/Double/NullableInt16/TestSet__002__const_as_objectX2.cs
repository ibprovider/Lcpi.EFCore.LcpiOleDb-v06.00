...
//
// (short)double_column==(short)double_constant
//
using System;
...
////////////////////////////////////////////////////////////////////////////////
//class TestSet__002__const_as_objectX2

public static class TestSet__002__const_as_objectX2
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)r.COL_SOURCE==(T_TARGET_VALUE)(object)(object)c_valueSource && r.TEST_ID==testID);
