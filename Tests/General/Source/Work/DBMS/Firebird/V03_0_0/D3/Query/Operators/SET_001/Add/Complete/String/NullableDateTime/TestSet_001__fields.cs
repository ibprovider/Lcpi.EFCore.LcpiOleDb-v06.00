...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.String.NullableDateTime{
////////////////////////////////////////////////////////////////////////////////
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_DATA1 c_value1="asd--";
           T_DATA2 c_value2=new System.DateTime(2020,11,29,15,57,46);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var oldC=Thread.CurrentThread.CurrentCulture;
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1+r.COL_DATA2)=="asd--2020-11-29 15:57:46.0000" && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T(") = _utf8 'asd--2020-11-29 15:57:46.0000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1+(string)(object)r.COL_DATA2)=="asd--2020-11-29 15:57:46.0000" && r.TEST_ID==testID);
