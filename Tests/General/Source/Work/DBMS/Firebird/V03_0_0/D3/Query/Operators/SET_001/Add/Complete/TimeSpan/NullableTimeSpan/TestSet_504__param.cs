 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1_U(0,18,27,32).Add(new T_DATA1_U(1000));
     T_DATA2 vv2=new T_DATA2_U(0,2,3,1,432);

     T_RESULT vr=new T_RESULT_U(0,20,30,33).Add(new T_RESULT_U(4321000));
 ...
 public static void Test_002()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=new T_DATA1_U(0,18,27,32).Add(new T_DATA1_U(1100));
     T_DATA2 vv2=new T_DATA2_U(0,2,3,1,432).Add(new T_DATA2_U(200));
 ...
 public static void Test_003__extract_time()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=new T_DATA1_U(0,18,1,2).Add(new T_DATA2_U(1000));
     T_DATA2 vv2=new T_DATA2_U(0,10,5,7,432);

     T_RESULT vr=new T_RESULT_U(1 /* !!! Now it is !!! */ ,4,6,9,432).Add(new T_RESULT_U(1000));
