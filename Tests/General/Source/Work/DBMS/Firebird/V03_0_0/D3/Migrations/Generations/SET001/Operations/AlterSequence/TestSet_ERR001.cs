  ...
  catch(xEFCore.LcpiOleDb__DataToolException e)
  {
   ...
   CheckErrors.CheckErrorRecord__msql_gen_err__firebird_does_not_support_non_cyclic_sequence__1
    (TestUtils.GetRecord(e,0),
     CheckErrors.c_src__EFCoreDataProvider__Basement_EF_Dbms_Firebird_V03_0_0_Migrations_D3_Internal_SvcImpls___FB_V03_0_0__MigrationsSvcImpl__GenerateAlterSequence,
     c_NameOf_Sequence);
