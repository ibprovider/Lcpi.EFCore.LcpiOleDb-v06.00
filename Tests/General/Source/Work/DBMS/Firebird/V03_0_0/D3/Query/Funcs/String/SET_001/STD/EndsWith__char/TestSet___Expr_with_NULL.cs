...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+"4").EndsWith('4')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+"4\0").EndsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+"4Q").EndsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+"4\0").EndsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
