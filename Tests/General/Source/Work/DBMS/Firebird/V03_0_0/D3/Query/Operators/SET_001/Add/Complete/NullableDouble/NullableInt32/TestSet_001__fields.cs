...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.NullableDouble.NullableInt32{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" + CAST(").N("t",c_NameOf__COL_DATA2).T(" AS DOUBLE PRECISION)) = 11.0) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
