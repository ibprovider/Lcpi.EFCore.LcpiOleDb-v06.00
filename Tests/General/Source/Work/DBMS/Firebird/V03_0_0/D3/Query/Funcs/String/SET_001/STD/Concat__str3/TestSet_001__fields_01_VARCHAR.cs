...
public static class TestSet_001__fields_01_VARCHAR
{
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", CHARACTER_LENGTH(").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") AS ").N("CRL").EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") = _utf8 'ABC'||_utf8 x'00'||_utf8 '123 XYZ  ') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_002__V_N_V()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs
      =db
       .testTable
       .Where(r => string.Concat(r.DATA1,r.DATA2,r.DATA3)=="ABC\0123XYZ  " && r.TEST_ID==testID)
       .Select(x => new{TEST_ID=x.TEST_ID,CRL=string.Concat(x.DATA1,x.DATA2,x.DATA3).Length});
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", CHARACTER_LENGTH(").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") AS ").N("CRL").EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") = _utf8 'ABC'||_utf8 x'00'||_utf8 '123XYZ  ') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", CAST(CHARACTER_LENGTH(").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") AS VARCHAR(20)) AS ").N("CRL").EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N_TXT_NP("t",c_NameOf__COL_DATA2).T("||").N_TXT_NP("t",c_NameOf__COL_DATA3).T(") = _utf8 'ABC'||_utf8 x'00'||_utf8 '123 XYZ  ') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
