...
//
// (double)double_column==(double)explicit_double_value
//
using System;
...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.Double.Double{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").N("t",c_NameOf__COL_SOURCE).T(" = -1.6000000000000001) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
