...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.ArrayIndex.Complete.Array_Byte.NullableInt16{
////////////////////////////////////////////////////////////////////////////////
//using
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2]==40);
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     for(T_DATA2_U iByte=0;iByte!=vv1.Length;++iByte)
     {
      ...
      var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2]==vElementValue);
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     for(T_DATA1_E xElement=0;;++xElement)
     {
      ...
      var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2]==xElement);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => object.Equals(vv1[(T_DATA2_U)(T_DATA2)vv2],null));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2].Equals(null));
 ...
 public static void Test_ERR002__count()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1_E[] vv1=new T_DATA1_E[]{1,2,3};
     T_DATA2     vv2=(T_DATA2_U)vv1.Length;
