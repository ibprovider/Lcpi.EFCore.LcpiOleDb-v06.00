...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Model.Annotations.VGS.SET_001.ExplicitDefinition.DECIMAL{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__None
{
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  {
   [Key]
   [Column(c_NameOf__COL__ID, TypeName="DECIMAL")]
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    var expectedSQL1
     =new TestSqlTemplate()
       ...
       .T("    ").N(c_NameOf__COL__ID).T(" DECIMAL NOT NULL,").CRLF()
