   ...
   =new tagData001[]
     {
      ...
      new tagData001("00000000000000000000000000000.000000001" ,0),
      ...
      try
      {
       ...
       db.CheckTextOfLastExecutedCommand
        (new TestSqlTemplate()
          ...
          .T("WHERE (").P_I4("__Exec_0").T(" = ").N("t",c_NameOf__COL_TARGET).T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
      ...
      catch(InvalidOperationException e)
      {
       ...
       CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
        (TestUtils.GetRecord(e2,0),
         CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Cvt_Code__String__NullableInt32,
