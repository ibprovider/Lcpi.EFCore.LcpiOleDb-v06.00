...
//
// (long)single_column==(long)single_param
//
using System;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_SOURCE_VALUE c_valueSource=9223372036854775807.0F;
     const T_TARGET_VALUE c_valueTarget=+1;
 ...
 public static void Test_MM003__minP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=-9223372036854775808.9F; //not exact
     const T_TARGET_VALUE c_valueTarget=+1;
