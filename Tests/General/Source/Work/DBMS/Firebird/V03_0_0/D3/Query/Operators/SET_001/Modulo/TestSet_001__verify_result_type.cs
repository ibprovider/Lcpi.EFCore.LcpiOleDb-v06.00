...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Modulo{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__verify_result_type
{
 ...
 private static readonly tagData[] sm_Data=
 {
  ...
  new tagData("SMALLINT"          ,  2, "BIGINT"           ,  1, xdb.OleDbType.SmallInt  ,    5,  null),
  ...
  new tagData("INTEGER"           ,  2, "BIGINT"           ,  1, xdb.OleDbType.Integer   ,   10,  null),
  ...
  new tagData("BIGINT"            ,  2, "SMALLINT"         ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "INTEGER"          ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "BIGINT"           ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "FLOAT"            ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "DOUBLE PRECISION" ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "NUMERIC(1)"       ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "NUMERIC(1,0)"     ,  1, xdb.OleDbType.BigInt    ,   19,  null),
  new tagData("BIGINT"            ,  2, "NUMERIC(2,1)"     ,  1, xdb.OleDbType.BigInt    ,   19,  null),

  new tagData("NUMERIC(1)"        ,  2, "SMALLINT"         ,  1, xdb.OleDbType.Numeric   ,    4,  0),
  new tagData("NUMERIC(1)"        ,  2, "INTEGER"          ,  1, xdb.OleDbType.Numeric   ,    4,  0),
  new tagData("NUMERIC(1)"        ,  2, "BIGINT"           ,  1, xdb.OleDbType.Numeric   ,    4,  0),
  ...
  new tagData("NUMERIC(2,0)"      ,  2, "BIGINT"           ,  1, xdb.OleDbType.Numeric   ,    4,  0),
  ...
  new tagData("NUMERIC(2,1)"      ,  2, "BIGINT"           ,  1, xdb.OleDbType.Numeric   ,    4,  0),
