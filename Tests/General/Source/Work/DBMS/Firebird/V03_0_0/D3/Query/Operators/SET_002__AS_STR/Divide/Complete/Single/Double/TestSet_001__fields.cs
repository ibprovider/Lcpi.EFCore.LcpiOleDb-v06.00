    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (CAST((").N("t",c_NameOf__COL_DATA1).T(" / ").N("t",c_NameOf__COL_DATA2).T(") AS VARCHAR("+c_RESULT_VCH_LEN+")) = _utf8 '3.500000000000000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
