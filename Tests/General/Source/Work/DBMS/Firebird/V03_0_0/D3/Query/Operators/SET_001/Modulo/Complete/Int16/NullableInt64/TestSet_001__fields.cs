...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Modulo.Complete.Int16.NullableInt64{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_002__null___eq___value()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
 ...
 }//Test_002__null___eq___value

 //-----------------------------------------------------------------------
 [Test]
 public static void Test_003__null___eq___null()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
