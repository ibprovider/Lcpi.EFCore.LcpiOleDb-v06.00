...
//
// <field_with_null>.AddMilliseconds(...)
//
using System;
using System.Linq;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(1)==null && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(r.COL_INTEGER)==null && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(r.COL_INTEGER)==r.DATA.AddMilliseconds(r.COL_INTEGER) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(str.Length+0.5)==null && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(r.COL_INTEGER)==r.DATA.AddMilliseconds(2) && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((DATEADD(MILLISECOND,CAST(").N("t",c_NameOf__COL_INTEGER).T(" AS DOUBLE PRECISION),").N("t",c_NameOf__COL_DATA).T(") = DATEADD(MILLISECOND,2.0,").N("t",c_NameOf__COL_DATA).T(")) OR (((").N("t",c_NameOf__COL_DATA).IS_NULL().T(") OR (").N("t",c_NameOf__COL_INTEGER).IS_NULL().T(")) AND (").N("t",c_NameOf__COL_DATA).IS_NULL().T("))) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(r.COL_INTEGER)==r.DATA.AddMilliseconds(2).Value && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (DATEADD(MILLISECOND,CAST(").N("t",c_NameOf__COL_INTEGER).T(" AS DOUBLE PRECISION),").N("t",c_NameOf__COL_DATA).T(") = COALESCE(DATEADD(MILLISECOND,2.0,").N("t",c_NameOf__COL_DATA).T("), CAST(_utf8 'TRAP FOR NULL' AS TIMESTAMP))) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(1)==r.DATA.AddMilliseconds(1) && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((DATEADD(MILLISECOND,1.0,").N("t",c_NameOf__COL_DATA).T(") = DATEADD(MILLISECOND,1.0,").N("t",c_NameOf__COL_DATA).T(")) OR (").N("t",c_NameOf__COL_DATA).IS_NULL().T(")) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA==r.DATA.AddMilliseconds(1) && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ((").N("t",c_NameOf__COL_DATA).T(" = DATEADD(MILLISECOND,1.0,").N("t",c_NameOf__COL_DATA).T(")) OR (").N("t",c_NameOf__COL_DATA).IS_NULL().T(")) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
    ...
    TestServices.UnsupportedSQL__DataTypeUnknown
     (tr,
      new TestSqlTemplate()
       .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
       .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
       .T("WHERE DATEADD(MILLISECOND,CAST(").P("__Exec_0").T(" + ").N("t",c_NameOf__COL_INTEGER).T(" AS DOUBLE PRECISION),").N("t",c_NameOf__COL_DATA).T(")").IS_NULL().T(" AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")")
       .BuildSql(cn));
