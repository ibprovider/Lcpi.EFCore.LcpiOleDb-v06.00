...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.TypeMapping.Group002.DECIMAL_02_01{
////////////////////////////////////////////////////////////////////////////////

using TEST_COL_TYPE=Decimal;

////////////////////////////////////////////////////////////////////////////////
//class TestSet__Decimal

public static class TestSet__Decimal
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   [Column("COL_DEC_2_1", TypeName = "DECIMAL(2,1)")]
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   {
    Int64          recID;
    TEST_COL_TYPE  recData=new TEST_COL_TYPE(3.1);
    ...
    //------------------
    cmd.CommandText="select COL_DEC_2_1 from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();

    var rd=cmd.ExecuteReader();

    Assert.IsTrue(rd.Read());

    Assert.AreEqual(recData,rd.GetDecimal(0));
