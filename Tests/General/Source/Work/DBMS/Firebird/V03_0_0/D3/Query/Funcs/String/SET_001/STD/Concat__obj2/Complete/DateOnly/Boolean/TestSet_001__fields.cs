...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.String.SET_001.STD.Concat__obj2.Complete.DateOnly.Boolean{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 private const string c_TypeNameOf__COL_DATA1    ="DATE";
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
           T_DATA1_U c_value1=new T_DATA1_U(2021,12,6);
     const T_DATA2_U c_value2=true;

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => string.Concat(r.COL_DATA1,r.COL_DATA2)=="2021-12-06TRUE" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
       ...
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T("||").N("t",c_NameOf__COL_DATA2).T(") = _utf8 '2021-12-06TRUE') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
