...
public static class TestSet_001__fields__03__N2
{
 ...
 private const string c_NameOf__COL_AMOUNT=DB_TABLE.Columns.COL2_for_TimeSpan;
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N("t",c_NameOf__COL_DATA).T(" + ").N("t",c_NameOf__COL_AMOUNT).T(") = time '15:29:56.0000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
