...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.TimeOnly.SET001.STD.IsBetween{
////////////////////////////////////////////////////////////////////////////////
//using

using T_DATA1  =System.TimeOnly;
using T_DATA2  =System.TimeOnly;
using T_DATA3  =System.TimeOnly;
...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__fields__01__VVV

public static class TestSet_001__fields__01__VVV
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_DATA2 c_data2=new T_DATA2_U(14,27,53);
     T_DATA3 c_data3=new T_DATA3_U(14,27,54);

     System.Int64? testID=Helper__InsertRow(db,c_data1,c_data2,c_data3);

     var recs=db.testTable.Where(r => r.DATA1.IsBetween(r.DATA2,r.DATA3) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE CASE\n"
          ...
          +"END AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
 ...
 public static void Test_02()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,54);
     T_DATA2 c_data2=new T_DATA2_U(14,27,53);
     T_DATA3 c_data3=new T_DATA3_U(14,27,54);
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_03__vicewersa()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,54);
     T_DATA2 c_data2=new T_DATA2_U(14,27,54);
     T_DATA3 c_data3=new T_DATA3_U(14,27,53);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,54);
     T_DATA2 c_data2=new T_DATA2_U(14,27,53);
     T_DATA3 c_data3=new T_DATA3_U(14,27,55);
 ...
 public static void Test_05()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,54);
     T_DATA2 c_data2=new T_DATA2_U(14,27,55);
     T_DATA3 c_data3=new T_DATA3_U(14,27,53);
 ...
 public static void Test_06()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,52);
     T_DATA2 c_data2=new T_DATA2_U(14,27,55);
     T_DATA3 c_data3=new T_DATA3_U(14,27,53);
 ...
 public static void Test_07()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_data1=new T_DATA1_U(14,27,56);
     T_DATA2 c_data2=new T_DATA2_U(14,27,55);
     T_DATA3 c_data3=new T_DATA3_U(14,27,53);
