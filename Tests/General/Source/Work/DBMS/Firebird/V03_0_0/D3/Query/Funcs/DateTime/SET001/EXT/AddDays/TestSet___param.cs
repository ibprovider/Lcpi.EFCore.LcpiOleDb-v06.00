...
public static class TestSet___param
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_DATA vv_src=new System.DateTime(2018,10,9);
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test___param_ui1n___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv_src.AddDays(vv)==new System.DateTime(2018,10,10) && r.TEST_ID==testID);
 ...
 }//Test___param_ui1n___ByEF

 //-----------------------------------------------------------------------
 [Test]
 public static void Test___param_ui1___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
