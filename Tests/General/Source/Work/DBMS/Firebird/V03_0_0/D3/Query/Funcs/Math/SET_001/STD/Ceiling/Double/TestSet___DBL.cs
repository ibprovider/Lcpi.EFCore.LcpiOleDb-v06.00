...
public static class TestSet___DBL
{
 ...
 {
  Assert.AreEqual( 1.0 ,System.Math.Ceiling(1.0));
  Assert.AreEqual( 2.0 ,System.Math.Ceiling(1.1));
  Assert.AreEqual( 2.0 ,System.Math.Ceiling(1.9));
  Assert.AreEqual( 2.0 ,System.Math.Ceiling(2.0));
  Assert.AreEqual(-2.0 ,System.Math.Ceiling(-2.0));
  Assert.AreEqual(-1.0 ,System.Math.Ceiling(-1.9));
  Assert.AreEqual(-1.0 ,System.Math.Ceiling(-1.1));
  Assert.AreEqual(-1.0 ,System.Math.Ceiling(-1.0));
 }//Test___00
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Ceiling(r.DATA)==1 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        ...
        .T("WHERE (CEILING(").N("n",c_NameOf__COL_DATA).T(") = 1.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Ceiling(r.DATA)==2 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (CEILING(").N("n",c_NameOf__COL_DATA).T(") = 2.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Ceiling(System.Math.Ceiling(r.DATA))==2 && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => System.Math.Ceiling(2*System.Math.Ceiling(r.DATA))==4 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (CEILING(2.0 * CEILING(").N("n",c_NameOf__COL_DATA).T(")) = 4.0) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
