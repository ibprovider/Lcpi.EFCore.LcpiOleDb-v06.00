 ...
 public static void Test___01___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA c_data=new System.DateTime(2018,10,9,15,16,17,1);

     System.Int64? testID=Helper__InsertRow(db,c_data);

     System.DateTime? vv_src=null;

     var recs=db.testTable.Where(r => vv_src.ExtractMillisecond()==null && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv_src.ExtractMillisecond()+3==null && r.TEST_ID==testID);
 ...
 public static void Test___03___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA c_data=new System.DateTime(2018,10,9,15,16,17,321);
 ...
 public static void Test___04___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA c_data=new System.DateTime(2018,10,9,15,16,17,234);
 ...
 public static void Test___05___ByDBMS()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA c_data=new System.DateTime(2018,10,9,15,16,17,454);

     System.Int64? testID=Helper__InsertRow(db,c_data,-2);

     System.DateTime? vv_src=null;

     var recs=db.testTable.Where(r => vv_src.ExtractMillisecond()!=452-r.COL_INTEGER && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (").N("t",c_NameOf__COL_INTEGER).IS_NOT_NULL().T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")");
 ...
 public static void Test___06___ByDBMS()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA c_data=new System.DateTime(2018,10,9,15,16,17,357);

     System.Int64? testID=Helper__InsertRow(db,c_data);

     System.DateTime? vv_src=null;

     var recs=db.testTable.Where(r => !(vv_src.ExtractMillisecond()!=357-r.COL_INTEGER) && r.TEST_ID==testID);
