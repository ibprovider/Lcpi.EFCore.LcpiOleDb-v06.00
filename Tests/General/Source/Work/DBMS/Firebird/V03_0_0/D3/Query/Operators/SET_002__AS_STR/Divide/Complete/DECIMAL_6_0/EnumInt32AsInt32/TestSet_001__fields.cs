...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_002__AS_STR.Divide.Complete.DECIMAL_6_0.EnumInt32AsInt32{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 private const string c_NameOf__COL_DATA1        ="COL_DEC_6_0";
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   [Column(c_NameOf__COL_DATA1,TypeName="DECIMAL(6,0)")]
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_DATA2 c_value2=T_DATA2.negative__FOUR;
     ...
     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1/(T_DATA2_AS)r.COL_DATA2)=="-1.750000000000000" && r.TEST_ID==testID);
