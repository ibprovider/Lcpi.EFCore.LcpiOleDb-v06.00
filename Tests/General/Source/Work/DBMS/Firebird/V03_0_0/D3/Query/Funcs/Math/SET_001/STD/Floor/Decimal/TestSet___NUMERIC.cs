...
public static class TestSet___NUMERIC
{
 ...
 {
  Assert.AreEqual( 1.0M ,System.Math.Floor(1.0M));
  Assert.AreEqual( 1.0M ,System.Math.Floor(1.1M));
  Assert.AreEqual( 1.0M ,System.Math.Floor(1.9M));
  Assert.AreEqual( 2.0M ,System.Math.Floor(2.0M));
  Assert.AreEqual(-2.0M ,System.Math.Floor(-2.0M));
  Assert.AreEqual(-2.0M ,System.Math.Floor(-1.9M));
  Assert.AreEqual(-2.0M ,System.Math.Floor(-1.1M));
  Assert.AreEqual(-1.0M ,System.Math.Floor(-1.0M));
 }//Test___00
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
        ...
        .T("WHERE (FLOOR(").N("n",c_NameOf__COL_DATA).T(") = 1) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (FLOOR(").N("n",c_NameOf__COL_DATA).T(") = 2) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("n","TEST_ID").T(", ").N("n",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("n").EOL()
        .T("WHERE (FLOOR(2 * FLOOR(").N("n",c_NameOf__COL_DATA).T(")) = 2) AND (").N("n","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
