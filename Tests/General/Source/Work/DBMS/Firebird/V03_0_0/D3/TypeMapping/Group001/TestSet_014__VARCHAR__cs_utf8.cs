...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_014__VARCHAR__cs_utf8

public static class TestSet_014__VARCHAR__cs_utf8
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public class TEST_MODIFY_ROW_WD
  {
   ...
   [Column(TypeName="VARCHAR(10) CHARACTER SET UTF8")]
   public string COL_VARCHAR_10 { get; set; }
  ...
  using(var cn=LocalCnHelper.CreateCn(c_ex_cn_params))
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var cmd=new xdb.OleDbCommand())
    {
     ...
     cmd.CommandText
      ="insert into TEST_MODIFY_ROW_WD (COL_VARCHAR_10) values ('123456789')\n"
      +"returning TEST_ID\n"
      +"INTO :TEST_ID";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     foreach(var rec in db.testTable.Where(r=>r.TEST_ID==(Int64)recID))
     {
      ...
      Assert.AreEqual("123456789",rec.COL_VARCHAR_10);
     }//foreach rec
