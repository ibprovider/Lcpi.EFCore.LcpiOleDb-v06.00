 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(1,1,1,12,10,11);
     T_DATA2 c_value2=new T_DATA2_U(12,10,11)+new T_DATA2_U(1000);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => (r.COL_DATA1-(T_DATA2)(new T_DATA2_U(12,10,11)+new T_DATA2_U(1000)))==((T_RESULT)new T_RESULT_U(2020,11,27,13,10,8)) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (DATEADD(MILLISECOND,-1000 * CAST(43811.0001 AS NUMERIC(18,4)),").N("t",c_NameOf__COL_DATA1).T(") = timestamp '2020-11-27 13:10:08') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
