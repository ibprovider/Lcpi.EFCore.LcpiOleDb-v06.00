...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith('3')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
