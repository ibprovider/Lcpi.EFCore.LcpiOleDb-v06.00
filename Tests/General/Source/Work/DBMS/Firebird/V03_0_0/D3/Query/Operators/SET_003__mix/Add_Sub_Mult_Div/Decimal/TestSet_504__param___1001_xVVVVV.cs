...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_504__param___1001_xVVVVV

public static class TestSet_504__param___1001_xVVVVV
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     // 16 + 8 - 4 * 2 / 1 + 0 == 16
     var recs=db.testTable.Where(r => (string)(object)(((T_DATA1)vx1_1.Length)+vv1_2-vv1_3*vv1_4/vv1_5+vv1_6)=="16.00000000000000");
