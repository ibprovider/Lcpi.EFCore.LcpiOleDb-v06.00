...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.NullableDouble.Int64{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001__m1_6()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE_U c_valueSource_=-1.6D;
     const T_TARGET_VALUE   c_valueTarget=-1;

     System.Int64? testID=Helper__InsertRow(db,c_valueSource_,c_valueTarget);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)r.COL_SOURCE==(T_TARGET_VALUE)new T_SOURCE_VALUE(-1.6D) && r.TEST_ID==testID);
 ...
 public static void Test_002__m1_5()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE_U c_valueSource_=-1.5D;
     const T_TARGET_VALUE   c_valueTarget=-1;

     System.Int64? testID=Helper__InsertRow(db,c_valueSource_,c_valueTarget);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)r.COL_SOURCE==(T_TARGET_VALUE)new T_SOURCE_VALUE(-1.5D) && r.TEST_ID==testID);
 ...
 public static void Test_003__m1_4()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE_U c_valueSource_=-1.4D;
     const T_TARGET_VALUE   c_valueTarget=-1;

     System.Int64? testID=Helper__InsertRow(db,c_valueSource_,c_valueTarget);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)r.COL_SOURCE==(T_TARGET_VALUE)new T_SOURCE_VALUE(-1.4D) && r.TEST_ID==testID);
