...
public static class TestSet_001
{
 ...
 private const string c_NameOf__SQL_TYPE_FOR_ARG2="NUMERIC(18,4)";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(") AND (COALESCE(").N("t",c_NameOf__COL_DATA).T(", CAST(_utf8 'TRAP FOR NULL' AS "+c_NameOf__SQL_TYPE_FOR_ARG2+")) = CAST(14582.0000 AS NUMERIC(18,4)))");
