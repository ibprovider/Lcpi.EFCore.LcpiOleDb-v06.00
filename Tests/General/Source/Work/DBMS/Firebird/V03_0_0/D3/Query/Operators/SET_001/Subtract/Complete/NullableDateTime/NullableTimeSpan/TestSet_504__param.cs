...
public static class TestSet_504__param
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_DATA2 vv2=new T_DATA2_U(0,2,3,1,432).Add(new T_DATA2_U(300));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_RESULT vr=new T_RESULT_U(2021,1,31,22,24,30).AddTicks(5681000);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_RESULT vr=new T_RESULT_U(2021,1,27,22,24,30).AddTicks(5681000);
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_004__non_zero_days_count__negative()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1_U(2021,2,1,18,27,32).AddTicks(1000);
     T_DATA2 vv2=new T_DATA2_U(0)-new T_DATA2_U(4,20,3,1,432);
