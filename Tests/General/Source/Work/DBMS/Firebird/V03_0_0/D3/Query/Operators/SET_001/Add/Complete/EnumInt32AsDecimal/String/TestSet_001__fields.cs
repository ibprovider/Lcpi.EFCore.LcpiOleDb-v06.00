...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.EnumInt32AsDecimal.String{
////////////////////////////////////////////////////////////////////////////////

using T_DATA1   =TestTypes.Enums.EnumInt32;
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1 c_value1=T_DATA1.positive__SEVEN;
     const T_DATA2 c_value2="--cucu";

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     Assert.AreEqual
      ("positive__SEVEN--cucu",
       c_value1+c_value2);

     var recs=db.testTable.Where(r => ((T_DATA1_AS)r.COL_DATA1+r.COL_DATA2)=="7--cucu" && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((string)(object)(T_DATA1_AS)r.COL_DATA1+r.COL_DATA2)=="7--cucu" && r.TEST_ID==testID);
...
////////////////////////////////////////////////////////////////////////////////
}//namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.EnumInt32AsDecimal.Int16
