...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_P02__field_param

public static class TestSet_P02__field_param
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1<<vv2)==112 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE (BIN_SHL(").N("t",c_NameOf__COL_DATA1).T(", ").P_I4("__vv2_0").T(") = 112) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")");
