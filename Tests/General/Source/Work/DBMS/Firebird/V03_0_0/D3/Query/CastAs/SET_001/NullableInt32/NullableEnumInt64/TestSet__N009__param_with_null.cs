...
////////////////////////////////////////////////////////////////////////////////
//class TestSet__N009__param_with_null

public static class TestSet__N009__param_with_null
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_SOURCE_VALUE vv=null;

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)vv==r.COL_TARGET && r.TEST_ID==testID);
