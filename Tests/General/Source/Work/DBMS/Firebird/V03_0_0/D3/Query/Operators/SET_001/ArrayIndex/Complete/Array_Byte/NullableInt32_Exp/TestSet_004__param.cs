  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2+0]==40);
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     for(T_DATA2_U iByte=0;iByte!=vv1.Length;++iByte)
     {
      ...
      var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2+0]==vElementValue);
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     for(T_DATA1_E xElement=0;;++xElement)
     {
      ...
      var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2+0]==xElement);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => object.Equals(vv1[(T_DATA2_U)(T_DATA2)vv2+0],null));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1[(T_DATA2_U)(T_DATA2)vv2+0].Equals(null));
     ...
     catch(InvalidOperationException e)
     {
      ...
      CheckErrors.CheckErrorRecord__common_err__index_out_of_range__2
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Op2_MasterCode__ArrayIndex___Array_Byte__Int64,
        -1,
        3);
     }//catch
    }//using db
