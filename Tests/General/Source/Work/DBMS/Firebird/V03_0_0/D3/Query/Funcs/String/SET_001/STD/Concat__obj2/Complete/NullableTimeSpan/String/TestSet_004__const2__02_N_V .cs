...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_004__const2__02_N_V 

public static class TestSet_004__const2__02_N_V 
{
 ...
 public static void Test_001()
 {
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     var recs=db.testTable.Where(r => string.Concat(new T_DATA1(),(T_DATA2)"")=="DOES NOT MATTER");
