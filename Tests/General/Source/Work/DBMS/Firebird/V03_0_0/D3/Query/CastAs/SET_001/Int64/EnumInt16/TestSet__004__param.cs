...
//
// (short)bigint_column==(short)long_param
//
using System;
 ...
 public static void Test_MM001__min()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=T_TARGET_VALUE_B.MinValue;
     const T_TARGET_VALUE c_valueTarget=T_TARGET_VALUE_U.positive__ONE;
 ...
 public static void Test_MM002__max()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=T_TARGET_VALUE_B.MaxValue;
     const T_TARGET_VALUE c_valueTarget=T_TARGET_VALUE_U.positive__ONE;
