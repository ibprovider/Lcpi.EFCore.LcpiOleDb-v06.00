...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.DateTime.SET001.STD.AddMilliseconds{
////////////////////////////////////////////////////////////////////////////////
//using
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const long x2=636746400000015000;

     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(1.5)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     //var x1=new System.DateTime(9999,12,31).Ticks;
     //
     //var x2=x1+(12500);

     const long x2=3155378112000013000;

     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(315537811200001.25)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const long x2=3155378112000015000;

     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(315537811200001.5)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     //var x1=new System.DateTime(2018,10,9).Ticks;
     //
     //var x2=x1+(2*10000-7500);

     const long x2=636746400000013000;

     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(r.COL_INTEGER-0.75)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(str.Length)==new System.DateTime(2018,10,9,0,0,0,4) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     //var x1=new System.DateTime(2018,10,9).Ticks;
     //
     //var x2=x1+4*10000+5*1000;

     const long x2=636746400000045000;

     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(str.Length+0.5)==new System.DateTime(x2) && r.TEST_ID==testID);
