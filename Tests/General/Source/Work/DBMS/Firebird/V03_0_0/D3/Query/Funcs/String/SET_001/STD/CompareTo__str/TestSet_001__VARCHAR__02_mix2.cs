...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__VARCHAR__02_mix2

public static class TestSet_001__VARCHAR__02_mix2
{
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     System.Int64 testID=Helper__InsertRow(db,"ABC\0123","ABC\0122");

     var recs=db.testTable.Where(r => r.DATA1.CompareTo(r.DATA2)==1+0 && r.TEST_ID==testID);
 ...
 public static void Test_002()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     System.Int64 testID=Helper__InsertRow(db,"ABC\0123","ABC\0123");

     var recs=db.testTable.Where(r => r.DATA1.CompareTo(r.DATA2)==0+0 && r.TEST_ID==testID);
