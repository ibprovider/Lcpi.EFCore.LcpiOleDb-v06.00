 ...
 public static void Test_001__min_src()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     object vv1=(T_SOURCE_VALUE)(T_SOURCE_VALUE_U)T_SOURCE_VALUE_U.MinValue;
     object vv2=(T_TARGET_VALUE)default;
     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Cvt_MasterCode__Single__Decimal,
 ...
 public static void Test_002__max_src()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
      object vv1=(T_SOURCE_VALUE)(T_SOURCE_VALUE_U)T_SOURCE_VALUE_U.MaxValue;
      object vv2=(T_TARGET_VALUE)default;
