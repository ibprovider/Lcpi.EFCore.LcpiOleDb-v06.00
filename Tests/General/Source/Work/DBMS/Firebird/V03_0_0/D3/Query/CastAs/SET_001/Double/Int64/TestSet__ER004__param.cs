 ...
 public static void Test_001__min_m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     //                         ||
     // I8.MIN: -9223372036854775808
     // R8.MIN: -17976931348623157E+(308-16)

     const T_SOURCE_VALUE c_valueSource=-9223372036854776900D;
     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Cvt_MasterCode__Double__Int64,
 ...
 public static void Test_002__max_p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     //                        ||
     // I8.MAX: 9223372036854775807
     // R8.MAX: 17976931348623157E+(308-16)
     const T_SOURCE_VALUE c_valueSource=9223372036854777900;
     const T_TARGET_VALUE c_valueTarget=-1;
