...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+null).StartsWith('Q')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA+null).StartsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
