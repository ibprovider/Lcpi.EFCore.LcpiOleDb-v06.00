...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.ExclusiveOr.Complete.NullableInt16.NullableInt16{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
       .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
       .T("WHERE (BIN_XOR(").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).T(" + ").N("t",c_NameOf__COL_DATA2).T(") = 1) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_11a01__nullV1_nullV2()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
