 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)new T_SOURCE_VALUE(19,31,53,321)=="19:31:53.3210");
 ...
 public static void Test_002()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)new T_SOURCE_VALUE(19,31,53,0)=="19:31:53.0000");
