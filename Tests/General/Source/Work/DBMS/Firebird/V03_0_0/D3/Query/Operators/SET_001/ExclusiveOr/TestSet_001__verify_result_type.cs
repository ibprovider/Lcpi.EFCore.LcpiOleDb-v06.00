...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.ExclusiveOr{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    using(var cmd=cn.CreateCommand())
    {
     ...
     {
      string sql
       ="select BIN_XOR(CAST("+testData.LeftValue+" AS "+testData.LeftType+"),CAST("+testData.RightValue+" AS "+testData.RightType+")) from DUAL";
