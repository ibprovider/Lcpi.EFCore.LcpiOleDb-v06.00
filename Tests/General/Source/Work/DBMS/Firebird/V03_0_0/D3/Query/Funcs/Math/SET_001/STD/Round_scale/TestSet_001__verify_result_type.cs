...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.Math.SET_001.STD.Round_scale{
////////////////////////////////////////////////////////////////////////////////
   ...
   using(var tr=cn.BeginTransaction())
   {
    using(var cmd=cn.CreateCommand())
    {
     ...
     foreach(var testData in sm_Data)
     {
      ...
      {
       string sql
        ="select ROUND(CAST(1 AS "+testData.ArgType+"),"+scale+") from DUAL";
