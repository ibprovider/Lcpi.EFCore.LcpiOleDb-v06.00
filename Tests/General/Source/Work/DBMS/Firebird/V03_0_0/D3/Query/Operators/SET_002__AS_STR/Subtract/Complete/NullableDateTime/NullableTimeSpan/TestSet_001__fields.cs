...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_002__AS_STR.Subtract.Complete.NullableDateTime.NullableTimeSpan{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,2,1,18,27,32).AddTicks(1000);
     T_DATA2 c_value2=new T_DATA2_U(0,2,3,1,432);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1-r.COL_DATA2)=="2021-02-01 16:24:30.5681" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (CAST(DATEADD(MILLISECOND,-1000 * ").N("t",c_NameOf__COL_DATA2).T(",").N("t",c_NameOf__COL_DATA1).T(") AS VARCHAR(24)) = _utf8 '2021-02-01 16:24:30.5681') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
 ...
 public static void Test_002___check_trunc()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,2,1,18,27,32).AddTicks(1100);
     T_DATA2 c_value2=new T_DATA2_U(0,2,3,1,432).Add(new System.TimeSpan(200));
 ...
 public static void Test_003___change_day()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,2,1,18,27,32).AddTicks(1000);
     T_DATA2 c_value2=new T_DATA2_U(0,20,3,1,432);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1-r.COL_DATA2)=="2021-01-31 22:24:30.5681" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (CAST(DATEADD(MILLISECOND,-1000 * ").N("t",c_NameOf__COL_DATA2).T(",").N("t",c_NameOf__COL_DATA1).T(") AS VARCHAR(24)) = _utf8 '2021-01-31 22:24:30.5681') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
