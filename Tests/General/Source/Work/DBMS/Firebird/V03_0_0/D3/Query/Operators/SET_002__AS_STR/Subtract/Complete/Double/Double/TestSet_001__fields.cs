...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_002__AS_STR.Subtract.Complete.Double.Double{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (CAST((").N("t",c_NameOf__COL_DATA1).T(" - ").N("t",c_NameOf__COL_DATA2).T(") AS VARCHAR(32)) = _utf8 '3.000000000000000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
