  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_DATA[] values=new T_DATA[]{g1,g3,g2};
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ").N("t",c_NameOf__COL_DATA).T(" IN (x'7766C2D22B56D144AB9623D1775E0926', x'7966C2D22B56D144AB9623D1775E0926', x'7866C2D22B56D144AB9623D1775E0926') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (new T_DATA[]{g1,g3,g2}).Contains(r.DATA) && r.TEST_ID==testID);
