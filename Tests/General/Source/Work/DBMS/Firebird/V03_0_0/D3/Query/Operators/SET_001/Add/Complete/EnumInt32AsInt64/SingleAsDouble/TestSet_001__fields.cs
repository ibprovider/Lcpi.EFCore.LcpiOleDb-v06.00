...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.EnumInt32AsInt64.SingleAsDouble{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((T_DATA1_AS)r.COL_DATA1+(T_DATA2_AS)r.COL_DATA2)==11 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((CAST(").N("t",c_NameOf__COL_DATA1).T(" AS DOUBLE PRECISION) + ").N("t",c_NameOf__COL_DATA2).T(") = 11.0) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
