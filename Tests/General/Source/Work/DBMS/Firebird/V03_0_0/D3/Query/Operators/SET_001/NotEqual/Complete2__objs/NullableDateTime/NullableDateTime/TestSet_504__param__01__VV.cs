 ...
 public static void Test_002__equal()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=new T_DATA1_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(0);
     T_DATA2 vv2=new T_DATA2_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(100);
 ...
 public static void Test_003__greater()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=new T_DATA1_U(2021,05,11,12,14,34).AddTicks(1000*1235).AddTicks(0);
     T_DATA2 vv2=new T_DATA2_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(900);
