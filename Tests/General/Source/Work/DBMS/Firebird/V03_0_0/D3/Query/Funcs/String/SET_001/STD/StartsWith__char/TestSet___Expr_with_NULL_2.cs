...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).StartsWith('Q')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).StartsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (null+r.DATA).StartsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
