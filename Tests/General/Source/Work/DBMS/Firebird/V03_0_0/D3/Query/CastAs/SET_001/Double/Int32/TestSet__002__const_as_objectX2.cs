...
//
// (int)double_column==(int)double_constant
//
using System;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(object)r.COL_SOURCE==(T_TARGET_VALUE)(object)(object)c_valueSource && r.TEST_ID==testID);
