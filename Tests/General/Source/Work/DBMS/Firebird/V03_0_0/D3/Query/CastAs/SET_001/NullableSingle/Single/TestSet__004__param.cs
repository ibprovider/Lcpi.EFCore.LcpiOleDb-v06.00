...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.NullableSingle.Single{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet__004__param
{
 ...
 private const T_SOURCE_VALUE_U c_valueSource_MAX=T_TARGET_VALUE.MaxValue;
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").N("t",c_NameOf__COL_SOURCE).T(" = ").P_R4("__vv_0").T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
