...
//                                      IBProvider and Contributors. 06.11.2020.
//
// <field>.AddYears(...)
//
using System;
...
public static class TestSet___mix
{
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.AddYears(str.Length).Year==null && r.TEST_ID==testID);
