...
public static class TestSet___VARCHAR_with_null
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test___field___ByDBMS_____isNull()
 {
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.StartsWith(r.DATA)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
 ...
 }//Test___field___ByDBMS_____isNull

 //-----------------------------------------------------------------------
 [Test]
 public static void Test___field___ByDBMS_____notNull()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
...
#pragma warning restore CS0472
 ...
 }//Test___field___ByDBMS_____notNull
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.StartsWith(r.DATA) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (").N("t",c_NameOf__COL_DATA).T(" STARTING WITH ").N("t",c_NameOf__COL_DATA).T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.StartsWith("ABC")==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.StartsWith("\0ABC")==null && r.TEST_ID==testID);
#pragma warning restore CS0472
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.StartsWith("\0ABD") && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (").N("t",c_NameOf__COL_DATA).T(" STARTING WITH _utf8 x'00'||_utf8 'ABD') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => (r.DATA).StartsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.DATA).StartsWith(vv) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (").N("t",c_NameOf__COL_DATA).T(" STARTING WITH ").P_TXT("__vv_0").T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
    }//using db
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (").N("t",c_NameOf__COL_DATA).T(" STARTING WITH NULL) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
    }//using db
