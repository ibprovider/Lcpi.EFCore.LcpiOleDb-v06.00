...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_002__AS_STR.Subtract.Complete.TimeSpan.TimeSpan{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1(0,18,27,32).Add(new System.TimeSpan(1000));
     T_DATA2 vv2=new T_DATA2(0,2,3,1,432);

     var recs=db.testTable.Where(r => (string)(object)(vv1-vv2)=="16:24:30.5681");
 ...
 public static void Test_002___check_trunc()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=new T_DATA1(0,18,27,32).Add(new System.TimeSpan(1100));
     T_DATA2 vv2=new T_DATA2(0,2,3,1,432).Add(new System.TimeSpan(200));
 ...
 public static void Test_003__extract_time()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1(0,18,27,32).Add(new System.TimeSpan(1100));
     T_DATA2 vv2=new T_DATA2(0,20,3,1,432).Add(new System.TimeSpan(200));

     var recs=db.testTable.Where(r => (string)(object)(vv1-vv2)=="22:24:30.5681");
