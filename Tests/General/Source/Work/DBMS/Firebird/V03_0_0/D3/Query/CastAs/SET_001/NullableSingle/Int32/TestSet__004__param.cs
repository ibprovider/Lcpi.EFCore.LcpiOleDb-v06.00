...
public static class TestSet__004__param
{
 ...
 private const T_SOURCE_VALUE_U c_valueSource_MAX=2.14748300E+09F;/*T_TARGET_VALUE.MaxValue;*/
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (CAST(TRUNC(").N("t",c_NameOf__COL_SOURCE).T(") AS "+c_NameOf__TARGET_SQL_TYPE+") = ").P_I4("__p_0").T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
