...
//
// (long)double_column==(long)double_param
//
using System;
 ...
 public static void Test_MM003__minP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=-9223372036854775808.9D; //not exact
     const T_TARGET_VALUE c_valueTarget=+1;
 ...
 public static void Test_MM004__maxP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=9223372036854775807.9D; //not exact
     const T_TARGET_VALUE c_valueTarget=+1;
