...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.NullableInt32.EnumInt16{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_TARGET_VALUE   c_valueTarget=T_TARGET_VALUE.negative__ONE;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_TARGET_VALUE   c_valueTarget=T_TARGET_VALUE.ZERO;
 ...
 public static void Test_006__p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE_U c_valueSource_=+1;
     const T_TARGET_VALUE   c_valueTarget=T_TARGET_VALUE.positive__ONE;
