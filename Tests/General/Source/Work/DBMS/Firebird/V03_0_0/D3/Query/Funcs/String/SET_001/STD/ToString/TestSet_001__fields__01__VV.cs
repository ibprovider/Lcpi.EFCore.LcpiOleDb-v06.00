...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.String.SET001.STD.ToString{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1_U c_value1="qwerty";

     System.Int64? testID=Helper__InsertRow(db,c_value1);

     var recs=db.testTable.Where(r => (r.COL_DATA1).ToString()=="qwerty" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").N("t",c_NameOf__COL_DATA1).T(" = _utf8 'qwerty') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
