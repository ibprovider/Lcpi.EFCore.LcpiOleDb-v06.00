...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_EXP004__param__MUL

public static class TestSet_EXP004__param__MUL
{
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (string)(object)vv1.GetValueOrDefault(2*(T_DATA_U)vv2)=="123");
