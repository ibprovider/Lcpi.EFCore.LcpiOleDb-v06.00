 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE c_valueSource="2021-02-20 10:01:37.0021";
           T_TARGET_VALUE c_valueTarget=new System.DateTime(2021,02,20,10,01,37).AddTicks(21*1000);

     System.Int64? testID=Helper__InsertRow(db,c_valueSource,c_valueTarget);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)"2021-02-20 10:01:37.0021"==r.COL_TARGET && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (timestamp '2021-02-20 10:01:37.0021' = ").N("t",c_NameOf__COL_TARGET).T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
