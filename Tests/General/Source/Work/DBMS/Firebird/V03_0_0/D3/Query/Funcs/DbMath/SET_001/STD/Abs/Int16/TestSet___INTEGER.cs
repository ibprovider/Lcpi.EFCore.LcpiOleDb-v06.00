  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => xdbfunc.DbMath.Abs((short)r.DATA)==123 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        ...
        .T("WHERE (ABS(CAST(").N("t",c_NameOf__COL_DATA).T(" AS SMALLINT)) = 123) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
