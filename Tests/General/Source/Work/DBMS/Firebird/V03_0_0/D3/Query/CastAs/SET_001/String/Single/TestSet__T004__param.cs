...
//
// (float)string_param==float_column
//
using System;
   ...
   =new tagData001[]
     {
      ...
      new tagData001(".12E-2"     ,0.0012F),

      new tagData001("123E-2"     ,1.23F),
      new tagData001("123.E-2"    ,1.23F),
      ...
      new tagData001("00000000000000000000000000000.000000001" ,1E-9F),
      ...
      catch(InvalidOperationException e)
      {
       ...
       CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
        (TestUtils.GetRecord(e2,0),
         CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Cvt_Code__String__NullableSingle,
