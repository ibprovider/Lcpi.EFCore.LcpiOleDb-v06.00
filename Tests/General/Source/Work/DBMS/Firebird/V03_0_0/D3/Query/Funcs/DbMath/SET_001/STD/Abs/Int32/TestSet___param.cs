...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => xdbfunc.DbMath.Abs(2*xdbfunc.DbMath.Abs(vv_str.Length))==null && r.TEST_ID==testID);
#pragma warning restore CS0472
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test___i2___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => xdbfunc.DbMath.Abs((int)vv_src)==0 && r.TEST_ID==testID);
