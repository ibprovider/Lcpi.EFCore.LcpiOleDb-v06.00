 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1="asd--";
     T_DATA2 vv2=new T_DATA2_U(2020,11,29);

     var recs=db.testTable.Where(r => (vv1+vv2)=="asd--2020-11-29");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (vv1+(string)(object)vv2)=="asd--2020-11-29");
