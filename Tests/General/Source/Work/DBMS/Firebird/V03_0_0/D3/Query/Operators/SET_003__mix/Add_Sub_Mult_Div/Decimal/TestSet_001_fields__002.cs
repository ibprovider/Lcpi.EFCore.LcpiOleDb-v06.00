...
//                                      IBProvider and Contributors. 05.04.2020.
using System;
using System.Data;
...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001_fields__002

public static class TestSet_001_fields__002
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1/(r.COL_DATA2*r.COL_DATA2))=="0.2500000000000000" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").PUSH().N_AS_DBL("t",c_NameOf__COL_DATA1).T(" / ").PUSH().N("t",c_NameOf__COL_DATA2).T(" * ").N("t",c_NameOf__COL_DATA2).W_BRKTS().POP().W_BRKTS().W_CastAsVCH(32).POP().T(" = _utf8 '0.2500000000000000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
