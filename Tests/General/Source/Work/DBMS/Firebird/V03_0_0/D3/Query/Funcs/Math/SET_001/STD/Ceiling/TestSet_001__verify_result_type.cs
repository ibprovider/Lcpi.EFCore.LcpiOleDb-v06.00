...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.Math.SET_001.STD.Ceiling{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__verify_result_type
{
 ...
 {
  new tagData("SMALLINT"          ,xdb.OleDbType.Integer),

  new tagData("INTEGER"           ,xdb.OleDbType.BigInt),

  new tagData("BIGINT"            ,xdb.OleDbType.BigInt),

  new tagData("FLOAT"             ,xdb.OleDbType.Double),

  new tagData("DOUBLE PRECISION"  ,xdb.OleDbType.Double),

  new tagData("NUMERIC(1)"        ,xdb.OleDbType.Integer),

  new tagData("NUMERIC(1,0)"      ,xdb.OleDbType.Integer),

  new tagData("NUMERIC(2,1)"      ,xdb.OleDbType.Integer),

  new tagData("NUMERIC(5,4)"      ,xdb.OleDbType.BigInt),
 };//sm_Data
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    using(var cmd=cn.CreateCommand())
    {
     ...
     {
      string sql
       ="select CEILING(CAST(1 AS "+testData.ArgType+")) from DUAL";
