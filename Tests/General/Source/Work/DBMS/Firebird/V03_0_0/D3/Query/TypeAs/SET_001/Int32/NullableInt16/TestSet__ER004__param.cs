 ...
 public static void Test_001__min_m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE_U c_valueSource=((T_SOURCE_VALUE)T_TARGET_VALUE_U.MinValue)-1;
...
#pragma warning disable CS0458 // The result of the expression is always 'null'
     var recs=db.testTable.Where(r => (vv1 as T_TARGET_VALUE)==(vv2 as T_TARGET_VALUE));
 ...
 public static void Test_002__max_p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE_U c_valueSource=((T_SOURCE_VALUE)T_TARGET_VALUE_U.MaxValue)+1;
     const T_TARGET_VALUE_U c_valueTarget=-1;
