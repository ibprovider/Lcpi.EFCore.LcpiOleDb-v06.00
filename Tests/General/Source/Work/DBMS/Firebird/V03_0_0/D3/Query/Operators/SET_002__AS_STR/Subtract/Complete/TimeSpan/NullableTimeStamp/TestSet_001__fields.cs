...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_002__AS_STR.Subtract.Complete.TimeSpan.NullableTimeSpan{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(0,18,27,32).Add(new System.TimeSpan(1000));
     T_DATA2 c_value2=new T_DATA2_U(0,2,3,1,432);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1-r.COL_DATA2)=="16:24:30.5681" && r.TEST_ID==testID);
 ...
 public static void Test_003__mcs()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(0,18,27,32).Add(new System.TimeSpan(1000));
     T_DATA2 c_value2=new T_DATA2_U(2,3,1).Add(new System.TimeSpan(4321000));

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => (string)(object)(r.COL_DATA1-r.COL_DATA2)=="16:24:30.5680" && r.TEST_ID==testID);
