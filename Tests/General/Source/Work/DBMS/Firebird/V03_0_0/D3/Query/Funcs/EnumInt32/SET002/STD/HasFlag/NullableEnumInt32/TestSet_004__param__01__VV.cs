...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.EnumInt32.SET002.STD.HasFlag.NullableEnumInt32{
////////////////////////////////////////////////////////////////////////////////

using T_DATA1  =TestEnum001;
using T_DATA2  =System.Nullable<TestEnum001>;

using T_DATA1_U=TestEnum001;
using T_DATA2_U=TestEnum001;

////////////////////////////////////////////////////////////////////////////////
//class TestSet_004__param__01__VV

public static class TestSet_004__param__01__VV
{
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     Assert.IsTrue
      (c_value1.HasFlag(c_value2));

     T_DATA1 vv1=c_value1;
     T_DATA2 vv2=c_value2;

     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)vv2));
 ...
 public static void Test_A001___param__param()
 {
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1_U c_value1=TestEnum001.Flag1|TestEnum001.Flag2;
     const T_DATA2_U c_value2=TestEnum001.Flag1|TestEnum001.Flag2;
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)(T_DATA2)c_value2));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)(T_DATA2)(TestEnum001.Flag1|TestEnum001.Flag2)));
 ...
 public static void Test_B001___param__param()
 {
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1_U c_value1=TestEnum001.Flag1|TestEnum001.Flag2;
     const T_DATA2_U c_value2=TestEnum001.Flag2|TestEnum001.Flag3;
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)(T_DATA2)(TestEnum001.Flag2|TestEnum001.Flag3)));
