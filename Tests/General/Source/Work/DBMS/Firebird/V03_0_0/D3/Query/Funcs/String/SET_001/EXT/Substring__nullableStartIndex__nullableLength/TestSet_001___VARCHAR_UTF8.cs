...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001___VARCHAR_UTF8

public static class TestSet_001___VARCHAR_UTF8
{
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.Substring(2,2)==vv.Substring(vv_start,vv_length) && r.TEST_ID==testID);
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => "A\uD800".Substring(vv_startIndex,vv_length)=="" && r.TEST_ID==testID);
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv.Substring(vv_startIndex,vv_length)=="" && r.TEST_ID==testID);
