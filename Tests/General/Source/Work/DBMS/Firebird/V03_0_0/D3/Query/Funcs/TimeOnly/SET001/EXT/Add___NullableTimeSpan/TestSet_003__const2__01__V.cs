  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => new T_DATA_U(14,27,53).Add((T_AMOUNT)new System.TimeSpan(123,1,2,3))==new T_DATA_U(15,29,56));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => new T_DATA_U(14,27,53).Add((T_AMOUNT)(new System.TimeSpan(0)-new System.TimeSpan(123,1,2,3)))==new T_DATA_U(13,25,50));
