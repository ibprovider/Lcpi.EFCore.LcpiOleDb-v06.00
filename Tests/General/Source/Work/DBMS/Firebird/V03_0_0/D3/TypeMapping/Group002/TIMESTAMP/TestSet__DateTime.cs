...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.TypeMapping.Group002.TIMESTAMP{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet__DateTime
{
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   {
    Int64          recID;
    TEST_COL_TYPE  recData=new DateTime(2018,3,21,11,25,03);

    const long c_k=10000000/10000;

    recData=recData.AddTicks(1234*c_k);
    ...
    //------------------
    cmd.CommandText="select COL_TIMESTAMP from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();

    var rd=cmd.ExecuteReader();

    Assert.IsTrue(rd.Read());

    Assert.AreEqual(recData,rd.GetDateTime(0));
