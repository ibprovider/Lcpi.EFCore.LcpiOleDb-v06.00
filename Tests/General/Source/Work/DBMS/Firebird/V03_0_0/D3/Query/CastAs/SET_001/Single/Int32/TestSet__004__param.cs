...
//
// (int)single_column==(int)single_param
//
using System;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_SOURCE_VALUE c_valueSource=2147483500.0F;
     const T_TARGET_VALUE c_valueTarget=+1;
 ...
 public static void Test_MM003__minP9()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource=-2147483648.9F; //not exact
     const T_TARGET_VALUE c_valueTarget=+1;
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_SOURCE_VALUE c_valueSource=2147483500.9F; //not exact
     const T_TARGET_VALUE c_valueTarget=+1;
