...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Model.Annotations.VGS.SET_001.ExplicitDefinition.NUMERIC_4_0{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_003__SequenceTrigger
{
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  {
   [Key]
   [Column(c_NameOf__COL__ID, TypeName="NUMERIC(4,0)")]
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var expectedSQL1
      =new TestSqlTemplate()
        ...
        .T("    ").N(c_NameOf__COL__ID).T(" NUMERIC(4,0) NOT NULL,").CRLF()
