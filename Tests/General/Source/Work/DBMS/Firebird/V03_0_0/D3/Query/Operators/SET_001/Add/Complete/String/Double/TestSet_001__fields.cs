...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Add.Complete.String.Double{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((").N_TXT_NP("t",c_NameOf__COL_DATA1).T("||").N("t",c_NameOf__COL_DATA2).T(") = _utf8 'asd--2.000000000000000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
