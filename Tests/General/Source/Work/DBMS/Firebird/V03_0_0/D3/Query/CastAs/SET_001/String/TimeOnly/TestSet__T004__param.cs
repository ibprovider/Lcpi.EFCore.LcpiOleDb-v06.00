...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.CastAs.SET_001.String.TimeOnly{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet__T004__param
{
 ...
 private static readonly tagData001[]
  sm_Data001
   =new tagData001[]
     {
      new tagData001("1:2"                       ,new T_TARGET_VALUE(1,2,0,0)),
      new tagData001("1:2:3"                     ,new T_TARGET_VALUE(1,2,3,0)),
      new tagData001("1:2:3.1"                   ,new T_TARGET_VALUE(1,2,3,100)),
      new tagData001("1:2:3.12"                  ,new T_TARGET_VALUE(1,2,3,120)),
      new tagData001("1:2:3.123"                 ,new T_TARGET_VALUE(1,2,3,123)),
      new tagData001("1:2:3.1234"                ,new T_TARGET_VALUE(1,2,3,0).Add(new System.TimeSpan(1234*1000))),
      //new tagData001("1:2:3.1234\0"              ,new T_TARGET_VALUE(1,2,3,0).Add(new System.TimeSpan(1234*1000))),
      ...
      new tagData001("\t1\t:\t2\t:\t3\t.\t123\t"     ,new T_TARGET_VALUE(1,2,3,123)),
      new tagData001("\t1\t:\t2\t:\t3\t.\t1234\t"    ,new T_TARGET_VALUE(1,2,3,0).Add(new System.TimeSpan(1234*1000))),
      //new tagData001("\t1\t:\t2\t:\t3\t.\t1234\0\t"  ,new T_TARGET_VALUE(1,2,3,0).Add(ew System.TimeSpan(1234*1000))),
      ...
      try
      {
       ...
       db.CheckTextOfLastExecutedCommand
        (new TestSqlTemplate()
          ...
          .T("WHERE (").P_TM("__Exec_0").T(" = ").N("t",c_NameOf__COL_TARGET).T(") AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
