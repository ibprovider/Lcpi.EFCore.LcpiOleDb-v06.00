  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (vv1-vv2)==(T_RESULT)(new T_RESULT_U(1,13,19,4,119)));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (vv1-vv2)==(T_RESULT)(new T_RESULT_U()-new T_RESULT_U(1,13,19,4,119)));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (vv1-vv2)==((T_RESULT)new T_RESULT_U(1,13,10,7,0)+new T_RESULT_U(9999000)));
