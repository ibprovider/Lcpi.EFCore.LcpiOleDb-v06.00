...
public static class TestSet___param
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv_src.AddHours((int)vv)==new System.DateTime(2018,10,9,3,00,0) && r.TEST_ID==testID);
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test___expr1a___ByEF____r()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv_src.AddHours(0.5+str.Length)==new System.DateTime(2018,10,9,4,30,0) && r.TEST_ID==testID);
