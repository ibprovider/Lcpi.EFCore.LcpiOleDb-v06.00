...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Funcs.IEnumerable_DateTime.SET001.EXT.Contains{
////////////////////////////////////////////////////////////////////////////////
//using
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ").N("t",c_NameOf__COL_DATA).T(" IN (timestamp '2021-09-16 15:40:12.1233', timestamp '2021-09-16 15:40:12.1234', timestamp '2021-09-16 15:40:12.1235') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")"));
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE ").N("t",c_NameOf__COL_DATA).T(" IN (timestamp '2021-09-16 15:40:12.1233', timestamp '2021-09-16 15:40:12.1234', timestamp '2021-09-16 15:40:12.1235') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
