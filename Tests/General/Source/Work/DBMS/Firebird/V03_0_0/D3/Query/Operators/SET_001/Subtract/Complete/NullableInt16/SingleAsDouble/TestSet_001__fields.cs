...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.Subtract.Complete.NullableInt16.SingleAsDouble{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE ((CAST(").N("t",c_NameOf__COL_DATA1).T(" AS DOUBLE PRECISION) - ").N("t",c_NameOf__COL_DATA2).T(") = 3.0) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
