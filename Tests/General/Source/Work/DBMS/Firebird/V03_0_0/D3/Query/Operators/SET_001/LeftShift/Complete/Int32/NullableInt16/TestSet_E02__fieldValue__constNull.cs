...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Query.Operators.SET_001.LeftShift.Complete.Int32.NullableInt16{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_E02__fieldValue__constNull

public static class TestSet_E02__fieldValue__constNull
{
...
#pragma warning disable CS0458
     var recs=db.testTable.Where(r => ((r.COL_DATA1)<<(T_DATA2)null)==112 && r.TEST_ID==testID);
#pragma warning restore CS0458
     ...
     var sqlt
      =new TestSqlTemplate()
       ...
       .T("WHERE (BIN_SHL(").N("t",c_NameOf__COL_DATA1).T(", NULL) = 112) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
