...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Model.Annotations.VGS.SET_001.ExplicitDefinition.DECIMAL_4{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_003__SequenceTrigger
{
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  {
   [Key]
   [Column(c_NameOf__COL__ID, TypeName="DECIMAL(4)")]
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var expectedSQL1
      =new TestSqlTemplate()
        ...
        .T("    ").N(c_NameOf__COL__ID).T(" DECIMAL(4) NOT NULL,").CRLF()
