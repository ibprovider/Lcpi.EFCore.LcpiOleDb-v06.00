...
//
// <text+field_with_null>.StartsWith(...)
//
using System;
using System.Linq;
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => ("QWE"+r.DATA).StartsWith('Q')==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => ("\0"+r.DATA).StartsWith('\0')==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => ("\0"+r.DATA).StartsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => ("Q"+r.DATA).StartsWith(vv)==null && r.TEST_ID==testID);
#pragma warning restore CS0472
