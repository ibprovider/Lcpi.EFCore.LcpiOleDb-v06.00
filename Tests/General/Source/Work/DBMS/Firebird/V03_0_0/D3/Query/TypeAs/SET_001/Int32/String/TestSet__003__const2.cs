  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.COL_SOURCE as object as T_TARGET_VALUE)==((T_SOURCE_VALUE)(-1) as object as T_TARGET_VALUE) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.COL_SOURCE as object as T_TARGET_VALUE)==((T_SOURCE_VALUE)(0) as object as T_TARGET_VALUE) && r.TEST_ID==testID);
