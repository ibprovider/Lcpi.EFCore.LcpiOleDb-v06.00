  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (null+r.COL_DATA2)==null && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     Assert.AreEqual
      (false,
       ((T_DATA1)(object)null+c_value2)==null);

     var recs=db.testTable.Where(r => ((T_DATA1)(object)null+r.COL_DATA2)==null && r.TEST_ID==testID);
