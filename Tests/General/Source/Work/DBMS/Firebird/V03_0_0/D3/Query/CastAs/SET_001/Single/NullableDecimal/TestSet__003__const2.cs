 ...
 public static void Test_001__m1_6()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(-1.6f)==-1.6m);
 ...
 public static void Test_002__m1_5()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(-1.5f)==-1.5m);
 ...
 public static void Test_003__m1_4()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(-1.4f)==-1.4m);
 ...
 public static void Test_004__m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(-1.0f)==-1.0m);
 ...
 public static void Test_005__zero()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(-0.0f)==0.0m);
