...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith(r.DATA)==null && r.TEST_ID==testID);
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith("123")==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith("\0123")==null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith("\0ABC1234")!=null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith("abc")!=null && r.TEST_ID==testID);
#pragma warning restore CS0472
...
#pragma warning disable CS0472
     var recs=db.testTable.Where(r => r.DATA.EndsWith(r.DATA.ToLower().ToUpper())==null && r.TEST_ID==testID);
#pragma warning restore CS0472
