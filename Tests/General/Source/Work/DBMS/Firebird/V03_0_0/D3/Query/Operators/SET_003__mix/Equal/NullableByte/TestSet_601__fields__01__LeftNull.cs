...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_601__fields__01__LeftNull

public static class TestSet_601__fields__01__LeftNull
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (null /*OP{*/ == /*}OP*/ r.COL_DATA1) && r.TEST_ID==testID);
