...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D3.Migrations.Generations.SET001.DataTypes.Clr.TimeSpan__as_Decimal18_4{
////////////////////////////////////////////////////////////////////////////////

using T_DATA=System.TimeSpan;

////////////////////////////////////////////////////////////////////////////////
//class TestSet_ERR004__bad_Size

public static class TestSet_ERR004__bad_Size
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_0000__ValidSize()
 {
  var operation
  ...
  catch(xEFCore.LcpiOleDb__DataToolException e)
  {
   ...
   CheckErrors.CheckErrorRecord__type_mapping_err__unexpected_Size_1
    (TestUtils.GetRecord(e,0),
     CheckErrors.c_src__EFCoreDataProvider__FB_Common__TypeMapping__TimeSpan__as_Decimal18_4,
     19);
