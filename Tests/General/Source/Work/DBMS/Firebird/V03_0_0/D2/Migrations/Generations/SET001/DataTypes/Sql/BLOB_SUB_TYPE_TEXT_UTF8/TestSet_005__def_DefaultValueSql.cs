...
public static class TestSet_005__def_DefaultValueSql
{
 ...
 public static void Test_0001__NOT_NULL()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     ...
     .T("    ").N(c_testColumnName).T(" BLOB SUB_TYPE TEXT CHARACTER SET UTF8 DEFAULT 12345 NOT NULL").CRLF()
     .T(");").CRLF();
 ...
 public static void Test_0002__NULLABLE()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("CREATE TABLE ").N(c_testTableName).T(" (").CRLF()
     .T("    ").N(c_testColumnName).T(" BLOB SUB_TYPE TEXT CHARACTER SET UTF8 DEFAULT 12345").CRLF()
     .T(");").CRLF();
