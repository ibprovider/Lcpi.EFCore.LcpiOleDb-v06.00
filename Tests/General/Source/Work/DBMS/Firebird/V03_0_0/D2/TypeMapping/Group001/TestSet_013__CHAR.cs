...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_013__CHAR

public static class TestSet_013__CHAR
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public class TEST_MODIFY_ROW_WD
  {
   ...
   public string COL_CHAR_10 { get; set; }
  ...
  using(var cn=LocalCnHelper.CreateCn(c_ex_cn_params))
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var cmd=new xdb.OleDbCommand())
    {
     ...
     cmd.CommandText
      ="insert into TEST_MODIFY_ROW_WD (COL_CHAR_10) values ('123456789')\n"
      +"returning TEST_ID\n"
      +"INTO :TEST_ID";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     foreach(var rec in db.testTable.Where(r=>r.TEST_ID==(Int64)recID))
     {
      ...
      Assert.AreEqual("123456789 ",rec.COL_CHAR_10);
     }//foreach rec
