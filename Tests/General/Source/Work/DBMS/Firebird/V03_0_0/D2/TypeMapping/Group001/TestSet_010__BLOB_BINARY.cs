...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_010__BLOB_BINARY

public static class TestSet_010__BLOB_BINARY
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public class TEST_MODIFY_ROW_WD
  {
   ...
   [Column(TypeName="BLOB SUB_TYPE BINARY")]
   public byte[] COL_BYTES_BLOB { get; set; }
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var cmd=new xdb.OleDbCommand())
    {
     ...
     cmd.CommandText
      ="insert into TEST_MODIFY_ROW_WD (COL_BYTES_BLOB) values (x'010203AA')\n"
      +"returning TEST_ID\n"
      +"INTO :TEST_ID";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     foreach(var rec in db.testTable.Where(r=>r.TEST_ID==(Int64)recID))
     {
      ...
      Assert.AreEqual(new byte[]{1,2,3,0xAA},rec.COL_BYTES_BLOB);
     }//foreach rec
