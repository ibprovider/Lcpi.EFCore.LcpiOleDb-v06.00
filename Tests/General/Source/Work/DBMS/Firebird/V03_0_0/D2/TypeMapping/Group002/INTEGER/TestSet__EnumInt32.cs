...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D2.TypeMapping.Group002.INTEGER{
////////////////////////////////////////////////////////////////////////////////

using TEST_COL_TYPE  =TestTypes.Enums.EnumInt32;
using TEST_COL_TYPE_U=System.Int32;

////////////////////////////////////////////////////////////////////////////////
//class TestSet__EnumInt32

public static class TestSet__EnumInt32
{
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   {
    Int64          recID;
    TEST_COL_TYPE  recData=TEST_COL_TYPE.positive__FOUR;
    ...
    //------------------
    cmd.CommandText="select COL_INTEGER from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();

    var rd=cmd.ExecuteReader();

    Assert.IsTrue(rd.Read());

    Assert.AreEqual((TEST_COL_TYPE_U)recData,rd.GetInt32(0));
