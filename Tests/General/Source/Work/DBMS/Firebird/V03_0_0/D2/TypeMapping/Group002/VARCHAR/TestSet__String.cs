...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D2.TypeMapping.Group002.VARCHAR{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    //------------------
    cmd.CommandText="select COL_VARCHAR_10 from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();
