...
public static class TestSet_005__def_DefaultValueSql__with_spaces
{
 ...
 public static void Test_0001__NOT_NULL()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     ...
     .T("    ").N(c_testColumnName).T(" VARCHAR(32) CHARACTER SET WIN1251 DEFAULT 12345 NOT NULL").CRLF()
     .T(");").CRLF();
 ...
 public static void Test_0002__NULLABLE()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("CREATE TABLE ").N(c_testTableName).T(" (").CRLF()
     .T("    ").N(c_testColumnName).T(" VARCHAR(32) CHARACTER SET WIN1251 DEFAULT 12345").CRLF()
     .T(");").CRLF();
