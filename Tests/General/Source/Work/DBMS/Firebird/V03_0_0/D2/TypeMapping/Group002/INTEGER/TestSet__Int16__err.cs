...
using TEST_COL_TYPE=System.Int16;

////////////////////////////////////////////////////////////////////////////////
//class TestSet__Int16__err

public static class TestSet__Int16__err
{
      ...
      catch(DbUpdateException e)
      {
       ...
       CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
        (TestUtils.GetRecord(e2,0),
         CheckErrors.c_src__EFCoreDataProvider__Core_ValueCvt__Int32__Int16,
       ...
       CheckErrors.CheckErrorRecord__common_err__failed_to_set_property_value_3
        (TestUtils.GetRecord(e2,1),
         ...
         typeof(TestSet__Int16__err).FullName+"+MyContext+TEST_RECORD",
         "TEST_COL",
         "COL_INTEGER__L");
