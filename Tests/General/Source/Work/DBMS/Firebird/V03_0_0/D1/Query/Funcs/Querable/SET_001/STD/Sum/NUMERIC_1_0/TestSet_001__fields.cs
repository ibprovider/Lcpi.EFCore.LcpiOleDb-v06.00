...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.Querable.SET_001.STD.Sum.NUMERIC_1_0{
////////////////////////////////////////////////////////////////////////////////
//using
...
public static class TestSet_001__fields
{
 ...
 private const string c_NameOf__COL_DATA="N_1_0";
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   [Column(c_NameOf__COL_DATA, TypeName = "NUMERIC(1,0)")]
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT COALESCE(SUM(").N("n",c_NameOf__COL_DATA).T("), 0)").EOL()
