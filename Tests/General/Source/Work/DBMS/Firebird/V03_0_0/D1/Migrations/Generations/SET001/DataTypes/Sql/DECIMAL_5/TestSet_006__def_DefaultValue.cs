...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Migrations.Generations.SET001.DataTypes.Sql.DECIMAL_5{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_005__def_DefaultValue
{
 ...
 public static void Test_0001__NOT_NULL()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     ...
     .T("    ").N(c_testColumnName).T(" DECIMAL(5) DEFAULT _utf8 '12345' NOT NULL").CRLF()
     .T(");").CRLF();
 ...
 public static void Test_0002__NULLABLE()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("CREATE TABLE ").N(c_testTableName).T(" (").CRLF()
     .T("    ").N(c_testColumnName).T(" DECIMAL(5) DEFAULT _utf8 '12345'").CRLF()
     .T(");").CRLF();
