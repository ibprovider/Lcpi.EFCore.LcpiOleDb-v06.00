...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.NotEqual.Complete2__objs.DateTime.NullableDateTime{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields__01__VV
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_001__greater()
 {
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_003__less()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
