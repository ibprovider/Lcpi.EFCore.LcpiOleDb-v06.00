  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(vv)==new System.DateTime(2018,10,9) && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (DATEADD(MILLISECOND,").P_R8("__p_0").T(",").N("t",c_NameOf__COL_DATA).T(") = timestamp '2018-10-09') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_1").T(")");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(xdbfunc.DbCast.AsInteger(vv))==new System.DateTime(2018,10,9,0,0,0,4) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(xdbfunc.DbCast.AsDouble(r.COL_INTEGER)-0.75)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(xdbfunc.DbCast.AsInteger(str.Length)+0.5)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(xdbfunc.DbCast.AsDouble(str.Length)+0.5)==new System.DateTime(x2) && r.TEST_ID==testID);
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.AddMilliseconds(xdbfunc.DbCast.AsDouble(r.COL_INTEGER)/(2*r.COL_INTEGER))==new System.DateTime(x2) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        .T("SELECT ").N("t","TEST_ID").T(", ").N("t",c_NameOf__COL_INTEGER).T(", ").N("t",c_NameOf__COL_DATA).EOL()
        .T("FROM ").N(c_NameOf__TABLE).T(" AS ").N("t").EOL()
        .T("WHERE (DATEADD(MILLISECOND,CAST(").N("t",c_NameOf__COL_INTEGER).T(" AS DOUBLE PRECISION) / (CAST(2 AS DOUBLE PRECISION) * ").N("t",c_NameOf__COL_INTEGER).T("),").N("t",c_NameOf__COL_DATA).T(") = timestamp '2018-10-09 00:00:00.0005') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
