...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__field__02__VN

public static class TestSet_001__field__02__VN
{
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.TEST_ID==testID && r.COL_DATA1.HasFlag((TestEnum001)new T_DATA2()));
