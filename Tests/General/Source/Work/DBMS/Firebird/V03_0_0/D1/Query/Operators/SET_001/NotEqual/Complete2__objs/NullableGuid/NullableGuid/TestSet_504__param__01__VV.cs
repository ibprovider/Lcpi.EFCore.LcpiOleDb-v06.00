 ...
 public static void Test_001__less()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=T_DATA1_U.Parse("D2C26678-562B-44D1-AB96-23D1775E0926");
     T_DATA2 vv2=T_DATA2_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
 ...
 public static void Test_002__equal()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=T_DATA1_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     T_DATA2 vv2=T_DATA2_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
 ...
 public static void Test_003__greater()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=T_DATA1_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     T_DATA2 vv2=T_DATA1_U.Parse("D2C26678-562B-44D1-AB96-23D1775E0926");
 ...
 public static void Test_103__greater()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=T_DATA1_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     T_DATA2 vv2=T_DATA2_U.Parse("D2C26678-562B-44D1-AB96-23D1775E0926");
