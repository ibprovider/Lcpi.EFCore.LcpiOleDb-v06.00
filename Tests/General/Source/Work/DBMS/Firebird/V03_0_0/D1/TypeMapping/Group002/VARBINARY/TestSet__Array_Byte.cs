...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.TypeMapping.Group002.VARBINARY{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet__Array_Byte
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   [Column("COL_VARBINARY_10", TypeName="VARBINARY(10)")]
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   {
    Int64   recID;
    byte[]  recData=new byte[]{0,1,2,3,4,0};
    ...
    //------------------
    cmd.CommandText="select COL_VARBINARY_10 from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();
