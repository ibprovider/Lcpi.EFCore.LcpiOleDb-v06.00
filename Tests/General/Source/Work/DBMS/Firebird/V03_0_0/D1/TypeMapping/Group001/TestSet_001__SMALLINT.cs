...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__SMALLINT

public static class TestSet_001__SMALLINT
{
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public class TEST_MODIFY_ROW_WD
  {
   ...
   public Int16 COL_SMALLINT { get; set; }
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var cmd=new xdb.OleDbCommand())
    {
     ...
     cmd.CommandText
      ="insert into TEST_MODIFY_ROW_WD (COL_SMALLINT) values (123)\n"
      +"returning TEST_ID\n"
      +"INTO :TEST_ID";
    ...
    using(var db=new MyContext(tr))
    {
     ...
     foreach(var rec in db.testTable.Where(r=>r.TEST_ID==(Int64)recID))
     {
      ...
      Assert.AreEqual(123,rec.COL_SMALLINT);
     }//foreach
