...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.NotEqual.Complete2__objs.NullableDateTime.DateTime{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_001__less()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,05,11,12,14,34).AddTicks(1000*1233).AddTicks(900);
     T_DATA2 c_value2=new T_DATA2_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(0);
 ...
 public static void Test_002__equal()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(0);
     T_DATA2 c_value2=new T_DATA2_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(100);
 ...
 public static void Test_003__greater()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_value1=new T_DATA1_U(2021,05,11,12,14,34).AddTicks(1000*1235).AddTicks(0);
     T_DATA2 c_value2=new T_DATA2_U(2021,05,11,12,14,34).AddTicks(1000*1234).AddTicks(900);
