...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.NotEqual.Complete2__objs.Array1_Char.Array1_Char{
////////////////////////////////////////////////////////////////////////////////

using T_DATA1_E  =System.Char;
using T_DATA2_E  =System.Char;
 ...
 public static void Test_001__less()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1_E[] vv1="3".ToCharArray();
     T_DATA2_E[] vv2="4".ToCharArray();
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(T_DATA1_E[])(System.Object)vv1__null_obj) /*OP{*/ != /*}OP*/ ((object)vv2));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (((object)vv1) /*OP{*/ != /*}OP*/ ((object)(T_DATA2_E[])(System.Object)vv2__null_obj)));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(T_DATA1_E[])(System.Object)vv1__null_obj) /*OP{*/ != /*}OP*/ ((object)(T_DATA2_E[])(System.Object)vv2__null_obj));
