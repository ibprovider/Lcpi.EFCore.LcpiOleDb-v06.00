...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.Divide.Complete.NUMERIC_2_1.Single{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     Assert.AreEqual
      (1.75,
       ((System.Single)c_value1)/c_value2);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => ((System.Single)r.COL_DATA1/r.COL_DATA2)==1.75 && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N_AS_FLT("t",c_NameOf__COL_DATA1).T(" / ").N("t",c_NameOf__COL_DATA2).T(") = 1.75) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
