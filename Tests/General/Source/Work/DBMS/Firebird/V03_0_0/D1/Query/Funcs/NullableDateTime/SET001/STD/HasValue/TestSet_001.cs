...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.NullableDateTime.SET001.STD.HasValue{
////////////////////////////////////////////////////////////////////////////////
//using
 ...
 public static void Test_011___param___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA c_data=new System.DateTime(2020,11,27);

     System.Int64? testID=Helper__InsertRow(db,c_data);

     System.DateTime? vv=c_data;
 ...
 public static void Test_012___param___ByEF()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     System.DateTime c_data=new System.DateTime(2020,11,8,18,17,32);
