 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1_U c_value1=false;

     System.Int64? testID=Helper__InsertRow(db,c_value1,null);

     var recs=db.testTable.Where(r => (r.COL_DATA1 /*OP{*/ ?? /*}OP*/ r.COL_DATA2) == false && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (COALESCE(").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).T(") = FALSE) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
