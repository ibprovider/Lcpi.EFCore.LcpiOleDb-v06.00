...
public static class TestSet_ERR504__param
{
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_001__positive()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1_U(9999,12,31,12,00,01);
     T_DATA2 vv2=new T_DATA2_U(11,59,59)+new T_DATA2_U(1000);
     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__common_err__out_of_range_in_arithmetic_op2__5<System.DateTime,System.TimeSpan>
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__FB_V03_0_0__Query_Local_D0_Expressions__Op2_MasterCode__Add___DateTime__TimeSpan,
 ...
 //-----------------------------------------------------------------------
 [Test]
 public static void Test_002__negative()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   cn.Open();
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 vv1=T_DATA1_U.MinValue;
     T_DATA2 vv2=new T_DATA2_U(0)-new T_DATA2_U(1000);

     T_RESULT vr=new T_RESULT_U(0);
