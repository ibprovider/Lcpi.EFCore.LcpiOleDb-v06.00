...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.String.SET_001.STD.Concat__obj2.Complete.TimeOnly.Boolean{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 private const string c_TypeNameOf__COL_DATA1    ="TIME";
 private const string c_TypeNameOf__COL_DATA2    ="BOOLEAN";
 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
           T_DATA1_U c_value1=new T_DATA1_U(21,20,37);
     const T_DATA2_U c_value2=true;

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     var recs=db.testTable.Where(r => string.Concat(r.COL_DATA1,r.COL_DATA2)=="21:20:37.0000TRUE" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
       ...
       .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T("||").N("t",c_NameOf__COL_DATA2).T(") = _utf8 '21:20:37.0000TRUE') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
