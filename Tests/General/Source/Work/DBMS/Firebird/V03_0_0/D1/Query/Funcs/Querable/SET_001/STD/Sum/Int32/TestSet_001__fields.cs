...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.Querable.SET_001.STD.Sum.Int32{
////////////////////////////////////////////////////////////////////////////////
//using
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     catch(xdb.OleDbException e)
     {
      ...
      CheckErrors.CheckOleDbError__Firebird__NumericValueOutOfRange
       (e.Errors[0]);
     }//catch
