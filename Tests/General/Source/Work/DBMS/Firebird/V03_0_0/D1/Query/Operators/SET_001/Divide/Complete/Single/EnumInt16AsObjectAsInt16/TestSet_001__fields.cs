...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.Divide.Complete.Single.EnumInt16AsObjectAsInt16{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1/(T_DATA2_AS)(object)r.COL_DATA2)==-3.5F && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" / ").N_AS_FLT("t",c_NameOf__COL_DATA2).T(") = -3.5) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
