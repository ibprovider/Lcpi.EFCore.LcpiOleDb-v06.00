 ...
 public static void Test_001()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 vv1=new T_DATA1_U(22,11,29,324);
     T_DATA2 vv2="--cucu";

     var recs=db.testTable.Where(r => (vv1+vv2)=="22:11:29.3240--cucu");
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((string)(object)vv1+vv2)=="22:11:29.3240--cucu");
