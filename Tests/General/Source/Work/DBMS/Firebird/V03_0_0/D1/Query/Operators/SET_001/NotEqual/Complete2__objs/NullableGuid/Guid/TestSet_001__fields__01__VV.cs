...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.NotEqual.Complete2__objs.NullableGuid.Guid{
////////////////////////////////////////////////////////////////////////////////

using T_DATA1  =System.Nullable<System.Guid>;
using T_DATA2  =System.Guid;

using T_DATA1_U=System.Guid;
using T_DATA2_U=System.Guid;
...
public static class TestSet_001__fields__01__VV
{
 ...
 private const string c_NameOf__COL_DATA1        ="COL_EMULATE_GUID";
 private const string c_NameOf__COL_DATA2        ="COL2_EMULATE_GUID";
 ...
 public static void Test_001__less()
 {
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1_U c_value1=T_DATA1_U.Parse("D2C26678-562B-44D1-AB96-23D1775E0926");
     T_DATA2_U c_value2=T_DATA2_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" <> ").N("t",c_NameOf__COL_DATA2).T(") OR (").N("t",c_NameOf__COL_DATA1).IS_NULL().T(")) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
 ...
 public static void Test_002__equal()
 {
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1_U c_value1=T_DATA1_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     T_DATA2_U c_value2=T_DATA2_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
 ...
 public static void Test_003__greater()
 {
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1_U c_value1=T_DATA1_U.Parse("D2C26679-562B-44D1-AB96-23D1775E0926");
     T_DATA2_U c_value2=T_DATA2_U.Parse("D2C26678-562B-44D1-AB96-23D1775E0926");
