...
using T_DATA1_E_U=System.Char;
using T_DATA2_E_U=System.Char;
...
public static class TestSet_001__fields__01__VV
{
 ...
 private sealed class MyContext:TestBaseDbContext
 {
  ...
  public sealed class TEST_RECORD
  {
   ...
   public T_DATA2_E[] COL_DATA2 { get; set; }
  };//class TEST_RECORD
 ...
 public static void Test_001__less()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1_E_U[] c_value1="3".ToCharArray();
     T_DATA2_E_U[] c_value2="4".ToCharArray();
 ...
 public static void Test_002__equal()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1_E_U[] c_value1="4".ToCharArray();
     T_DATA2_E_U[] c_value2="4".ToCharArray();
 ...
 public static void Test_003__greater()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1_E_U[] c_value1="5".ToCharArray();
     T_DATA2_E_U[] c_value2="4".ToCharArray();
