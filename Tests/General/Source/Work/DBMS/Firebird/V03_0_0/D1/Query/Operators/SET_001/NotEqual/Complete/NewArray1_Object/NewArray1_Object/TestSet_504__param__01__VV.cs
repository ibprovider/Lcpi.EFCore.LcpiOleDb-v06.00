     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__local_eval_err__comparison_of_arrays_with_different_length_not_supported_2
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Op2_MasterCode__NotEqual___Array1_generic__Array1_generic,
        3,
        2);
     }//catch
    }//using db
     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__local_eval_err__binary_operator_not_supported_3
       (TestUtils.GetRecord(e3,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Op2_Code__NotEqual___Object__Object,
