...
//
// (int)string_param_with_null==int_column
//
using System;
 ...
 public static void Test_100__null()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE c_sourceValue=null;

     System.Int64? testID=Helper__InsertRow(db,null,null);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)c_sourceValue==r.COL_TARGET && r.TEST_ID==testID);
