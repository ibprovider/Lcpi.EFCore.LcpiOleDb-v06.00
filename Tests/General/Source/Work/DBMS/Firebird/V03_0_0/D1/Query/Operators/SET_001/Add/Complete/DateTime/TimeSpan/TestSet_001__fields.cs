...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.Add.Complete.DateTime.TimeSpan{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_DATA2 c_value2=new System.TimeSpan(14,12,11);
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1+r.COL_DATA2)==new System.DateTime(2020,11,27,14,12,11) && r.TEST_ID==testID);
 ...
 public static void Test_002__non_zero_day_count()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2020,11,27);
     T_DATA2 c_value2=new T_DATA2_U(1,1,12,11,0);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     Assert.AreEqual
      (new System.DateTime(2020,11,28,1,12,11),
       c_value1+c_value2);
 ...
 public static void Test_002__non_zero_day_count__negative()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2020,11,27);
     T_DATA2 c_value2=new T_DATA2_U(0)-new T_DATA2_U(1,1,12,11,0);

     System.Int64? testID=Helper__InsertRow(db,c_value1,c_value2);

     Assert.AreEqual
      (new System.DateTime(2020,11,25,22,47,49),
       c_value1+c_value2);
 ...
 public static void Test_003__mcs()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_DATA1 c_value1=new System.DateTime(2020,11,27);
     ...
     var recs=db.testTable.Where(r => (r.COL_DATA1+r.COL_DATA2)==new System.DateTime(2020,11,27,14,12,11)+new System.TimeSpan(1000) && r.TEST_ID==testID);
