...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.Object.SET_001.STD.Equals__obj2.Complete.String.TimeSpan{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_001__fields
{
 ...
 private const string c_NameOf__COL_DATA1        ="COL2_VARCHAR_32";
 private const string c_NameOf__COL_DATA2        =DB_TABLE.Columns.COL_for_TimeSpan;
 ...
 public static void Test_001__field__field()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_DATA1 c_value1="11:12:17.4321";
           T_DATA2 c_value2=new T_DATA2(0,11,12,17,0)+new T_DATA2(4321*1000);
