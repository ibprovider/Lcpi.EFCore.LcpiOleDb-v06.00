...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.NotEqual.Complete2__objs.NullableDouble.NullableDecimal{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(vv1/vv1)) /*OP{*/ != /*}OP*/ ((object)vv2));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(((T_DATA1)vv1__null_obj)/((T_DATA1)vv1__null_obj))) /*OP{*/ != /*}OP*/ ((object)vv2));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(vv1/vv1)) /*OP{*/ != /*}OP*/ ((object)(T_DATA2)vv2__null_obj));
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((object)(((T_DATA1)vv1__null_obj)/((T_DATA1)vv1__null_obj))) /*OP{*/ != /*}OP*/ ((object)((T_DATA2)vv2__null_obj)));
