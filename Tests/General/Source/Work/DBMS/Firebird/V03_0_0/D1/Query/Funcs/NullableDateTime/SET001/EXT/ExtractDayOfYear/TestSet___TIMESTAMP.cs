  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => r.DATA.ExtractDayOfYear()==85 && r.TEST_ID==testID);
     ...
     var sqlt
      =new TestSqlTemplate()
        ...
        .T("WHERE ((EXTRACT(YEARDAY FROM ").N("t",c_NameOf__COL_DATA).T(") + 1) = 85) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")");
