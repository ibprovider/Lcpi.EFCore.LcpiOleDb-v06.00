 ...
 public static void Test_001__m1_6()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     const T_SOURCE_VALUE c_valueSource="-.0000000000001600000000000000000000123456789E+00000000000013";
 ...
 public static void Test_002__m1_5()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource="-.0000000000001500000000000000000000123456789E+00000000000013";
 ...
 public static void Test_003__m1_4()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource="-.0000000000001400000000000000000000123456789E+00000000000013";
 ...
 public static void Test_004__m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     const T_SOURCE_VALUE c_valueSource="-.0000000000001000000000000000000000123456789E+00000000000013";
 ...
 public static void Test_M01__minValue()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     //                                    12345678901234         -->|<-- !!!
     const T_SOURCE_VALUE c_valueSource="-.0000000000179769313486231560000000000000000000123456789E+000000000000319";
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     const T_SOURCE_VALUE c_valueSource=".000000000000000012345700000000000000000000123456789E+00000000000021";
