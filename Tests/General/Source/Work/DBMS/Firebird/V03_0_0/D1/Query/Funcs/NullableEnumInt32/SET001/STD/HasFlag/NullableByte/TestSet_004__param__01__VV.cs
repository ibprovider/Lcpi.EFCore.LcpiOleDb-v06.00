...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.NullableEnumInt32.SET001.STD.HasFlag.NullableByte{
////////////////////////////////////////////////////////////////////////////////

using T_DATA1  =System.Nullable<TestEnum001>;
using T_DATA2  =System.Nullable<System.Byte>;

using T_DATA1_U=TestEnum001;
using T_DATA2_U=System.Byte;
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((TestEnum001)vv1).HasFlag((TestEnum001)vv2));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((TestEnum001)vv1).HasFlag((TestEnum001)c_value2));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((TestEnum001)vv1).HasFlag((TestEnum001)(T_DATA2)(TestEnum001.Flag1|TestEnum001.Flag2)));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((TestEnum001)vv1).HasFlag((TestEnum001)(T_DATA2)(TestEnum001.Flag2|TestEnum001.Flag3)));
