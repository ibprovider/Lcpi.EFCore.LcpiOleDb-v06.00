...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.CastAs.SET_001.DateTime.String{
////////////////////////////////////////////////////////////////////////////////
...
using T_LOCAL_CVT
 =Lcpi.EntityFrameworkCore.DataProvider.LcpiOleDb.Core.Engines.Dbms.Firebird.Common.Mirror.Value.Converts.Code.Convert_Code__TIMESTAMP__STRING___D1;
...
public static class TestSet__000
{
 ...
 {
  /*    0 */ new tagData(new T_SOURCE_VALUE(2021,  1, 3), "03-JAN-2021"),
  /*    1 */ new tagData(new T_SOURCE_VALUE(2021,  2, 3), "03-FEB-2021"),
  /*    2 */ new tagData(new T_SOURCE_VALUE(2021,  3, 3), "03-MAR-2021"),
  /*    3 */ new tagData(new T_SOURCE_VALUE(2021,  4, 3), "03-APR-2021"),
  /*    4 */ new tagData(new T_SOURCE_VALUE(2021,  5, 3), "03-MAY-2021"),
  /*    5 */ new tagData(new T_SOURCE_VALUE(2021,  6, 3), "03-JUN-2021"),
  /*    6 */ new tagData(new T_SOURCE_VALUE(2021,  7, 3), "03-JUL-2021"),
  /*    7 */ new tagData(new T_SOURCE_VALUE(2021,  8, 3), "03-AUG-2021"),
  /*    8 */ new tagData(new T_SOURCE_VALUE(2021,  9, 3), "03-SEP-2021"),
  /*    9 */ new tagData(new T_SOURCE_VALUE(2021, 10, 3), "03-OCT-2021"),
  /*   10 */ new tagData(new T_SOURCE_VALUE(2021, 11, 3), "03-NOV-2021"),
  /*   11 */ new tagData(new T_SOURCE_VALUE(2021, 12, 3), "03-DEC-2021"),

  /*   12 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 2, 0, 0),
               "23-JAN-2021 2:00:00.0000"),

  /*   13 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 2, 3, 0),
               "23-JAN-2021 2:03:00.0000"),

  /*   14 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 2, 3, 4),
               "23-JAN-2021 2:03:04.0000"),

  /*   15 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 2, 3, 4, 5),
               "23-JAN-2021 2:03:04.0050"),

  /*   16 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 2, 3, 4, 0).AddTicks(9*c_ticks_for_MicroSecond),
               "23-JAN-2021 2:03:04.0009"),

  /*   17 */ new tagData
              (new T_SOURCE_VALUE(2021, 1, 23, 0, 0, 0).AddTicks(c_ticks_for_MicroSecond),
               "23-JAN-2021 0:00:00.0001"),
