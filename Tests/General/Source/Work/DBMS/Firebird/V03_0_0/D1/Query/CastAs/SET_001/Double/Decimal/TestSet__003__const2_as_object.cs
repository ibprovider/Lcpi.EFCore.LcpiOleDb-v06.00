 ...
 public static void Test_001__m1_6()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(-1.6)==-1.6m);
 ...
 public static void Test_002__m1_5()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(-1.5)==-1.5m);
 ...
 public static void Test_003__m1_4()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(-1.4)==-1.4m);
 ...
 public static void Test_004__m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(-1.0)==-1.0m);
 ...
 public static void Test_005__zero()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)(-0.0)==0.0m);
