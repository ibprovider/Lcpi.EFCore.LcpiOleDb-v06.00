...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.DateTime.SET001.STD.Now{
////////////////////////////////////////////////////////////////////////////////
//using
 ...
 public static void Test___field___ByDBMS()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA c_data=System.DateTime.Now;

     System.Int64? testID=Helper__InsertRow(db,c_data);

     var recs=db.testTable.Where(r => (r.DATA==System.DateTime.Now || r.DATA!=System.DateTime.Now) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N("t",c_NameOf__COL_DATA).T(" = CURRENT_TIMESTAMP) OR (").N("t",c_NameOf__COL_DATA).T(" <> CURRENT_TIMESTAMP)) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
