...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__fields__05__VN

public static class TestSet_001__fields__05__VN
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (new T_ARR1_E[]{r.COL_DATA1,r.COL_DATA2} /*OP{*/ != /*}OP*/ new T_ARR2_E[]{null,null}) && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE ((").N("t",c_NameOf__COL_DATA1).T(" IS NOT NULL) OR (").N("t",c_NameOf__COL_DATA2).T(" IS NOT NULL)) AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
    }//using db
 ...
 public static void Test_002()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     System.Int64? testID=Helper__InsertRow(db,null,1);
 ...
 public static void Test_003()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     System.Int64? testID=Helper__InsertRow(db,2,null);
