...
////////////////////////////////////////////////////////////////////////////////
//class TestSet_001__fields__06__NV

public static class TestSet_001__fields__06__NV
{
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => (new T_ARR2_E[]{null,null} /*OP{*/ != /*}OP*/ new T_ARR1_E[]{r.COL_DATA1,r.COL_DATA2}) && r.TEST_ID==testID);
