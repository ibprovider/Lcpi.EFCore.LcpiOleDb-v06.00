...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Funcs.EnumInt32.SET002.STD.HasFlag.EnumInt32{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     Assert.IsTrue
      (c_value1.HasFlag((TestEnum001)(object)c_value2));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)c_value2));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)(TestEnum001.Flag1|TestEnum001.Flag2)));
  ...
  using(var cn=Helper__CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => vv1.HasFlag((TestEnum001)(object)(TestEnum001.Flag2|TestEnum001.Flag3)));
