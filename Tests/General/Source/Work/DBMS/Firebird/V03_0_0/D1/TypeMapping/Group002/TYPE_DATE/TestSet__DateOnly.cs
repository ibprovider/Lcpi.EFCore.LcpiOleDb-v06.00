...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.TypeMapping.Group002.TYPE_DATE{
////////////////////////////////////////////////////////////////////////////////

using TEST_COL_TYPE=DateOnly;

////////////////////////////////////////////////////////////////////////////////
//class TestSet__DateOnly

public static class TestSet__DateOnly
{
 ...
 public static void Test_01()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   {
    Int64          recID;
    TEST_COL_TYPE  recData=new DateOnly(2018,3,18);
    ...
    //------------------
    cmd.CommandText="select COL_TYPE_DATE from TEST_MODIFY_ROW_WD where TEST_ID="+recID.ToString();

    var rd=cmd.ExecuteReader();

    Assert.IsTrue(rd.Read());

    Assert.AreEqual(recData,rd.GetDateOnly(0));
