  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     T_SOURCE_VALUE vv=new T_SOURCE_VALUE_U(c_srcTicks);

     var recs=db.testTable.Where(r => (T_TARGET_VALUE)(object)vv=="19:31:53.4321");
 ...
 public static void Test_ERR1__001__neg_tick1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_SOURCE_VALUE vv=new T_SOURCE_VALUE_U(-1);
 ...
 public static void Test_ERR2__001__day1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     T_SOURCE_VALUE vv=new T_SOURCE_VALUE_U(1,0,0,0,0);
