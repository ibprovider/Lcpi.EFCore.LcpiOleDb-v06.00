...
public static class TestSet_001__verify_result_type
{
 ...
 private static readonly tagData[] sm_Data=
 {
  ...
  new tagData("NUMERIC(9)"        ,  2, "SMALLINT"         ,  1, xdb.OleDbType.BigInt),
  new tagData("NUMERIC(9)"        ,  2, "INTEGER"          ,  1, xdb.OleDbType.BigInt),
  new tagData("NUMERIC(9)"        ,  2, c_SQL_TYPE_I64     ,  1, xdb.OleDbType.BigInt),
  new tagData("NUMERIC(9)"        ,  2, "NUMERIC(1)"       ,  1, xdb.OleDbType.BigInt),
  new tagData("NUMERIC(9)"        ,  2, "NUMERIC(1,0)"     ,  1, xdb.OleDbType.BigInt),
 };//sm_Data
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    using(var cmd=cn.CreateCommand())
    {
     ...
     {
      string sql
       ="select BIN_SHR(CAST("+testData.LeftValue+" AS "+testData.LeftType+"),CAST("+testData.RightValue+" AS "+testData.RightType+")) from DUAL";
