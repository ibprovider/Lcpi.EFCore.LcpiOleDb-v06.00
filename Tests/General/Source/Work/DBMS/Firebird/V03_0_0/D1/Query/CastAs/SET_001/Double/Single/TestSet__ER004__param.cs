 ...
 public static void Test_001__min_m1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     //
     // R4.MIN: -3.40282347E+38F
     // R8.MIN: -1.7976931348623157E+308;

     const T_SOURCE_VALUE c_valueSource=-3.40282348E+38D;
     ...
     catch(InvalidOperationException exc)
     {
      ...
      CheckErrors.CheckErrorRecord__common_err__cant_convert_value_between_types_2
       (TestUtils.GetRecord(e2,0),
        CheckErrors.c_src__EFCoreDataProvider__Root_Query_Local_Expressions__Cvt_MasterCode__Double__Single,
 ...
 public static void Test_002__max_p1()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     //
     // R4.MAX: 3.40282347E+38F
     // R8.MAX: 1.7976931348623157E+308
     const T_SOURCE_VALUE c_valueSource=3.40282348E+38D;
     const T_TARGET_VALUE c_valueTarget=-1;
