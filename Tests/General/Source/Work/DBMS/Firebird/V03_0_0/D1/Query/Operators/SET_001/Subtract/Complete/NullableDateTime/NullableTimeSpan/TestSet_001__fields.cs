...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.Subtract.Complete.NullableDateTime.NullableTimeSpan{
////////////////////////////////////////////////////////////////////////////////
 ...
 public static void Test_002__non_zero_days_count()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2020,11,27,14,12,11);
     T_DATA2 c_value2=new T_DATA2_U(1,1,2,3,0);
 ...
 public static void Test_002__non_zero_days_count__negative()
 {
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    {
     T_DATA1 c_value1=new T_DATA1_U(2020,11,27,14,12,11);
     T_DATA2 c_value2=new T_DATA2_U(0)-new T_DATA2_U(1,1,2,3,0);
