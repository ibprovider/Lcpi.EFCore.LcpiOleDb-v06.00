...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_002__AS_STR.Divide.Complete.Double.Int64{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (CAST((").N("t",c_NameOf__COL_DATA1).T(" / ").N_AS_DBL("t",c_NameOf__COL_DATA2).T(") AS VARCHAR("+c_RESULT_VCH_LEN+")) = _utf8 '3.500000000000000') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
