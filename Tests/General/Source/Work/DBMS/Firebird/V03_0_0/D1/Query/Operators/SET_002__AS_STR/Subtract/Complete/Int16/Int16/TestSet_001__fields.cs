...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_002__AS_STR.Subtract.Complete.Int16.Int16{
////////////////////////////////////////////////////////////////////////////////
    ...
    using(var db=new MyContext(tr))
    {
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (").PUSH().N("t",c_NameOf__COL_DATA1).T(" - ").N("t",c_NameOf__COL_DATA2).W_BRKTS().W_CastAsVCH(11).POP().T(" = _utf8 '3') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
