...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Migrations.Generations.SET001.DataTypes.Clr.Single{
////////////////////////////////////////////////////////////////////////////////
...
public static class TestSet_003__def_ClrType_and_TypeName__lower
{
 ...
 public static void Test_0001__NOT_NULL()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     ...
     .T("    ").N(c_testColumnName).T(" FLOAT NOT NULL").CRLF()
     .T(");").CRLF();
 ...
 public static void Test_0002__NULLABLE()
 {
  ...
  var expectedSQL
   =new TestSqlTemplate()
     .T("CREATE TABLE ").N(c_testTableName).T(" (").CRLF()
     .T("    ").N(c_testColumnName).T(" FLOAT").CRLF()
     .T(");").CRLF();
