...
namespace EFCore_LcpiOleDb_Tests.General.Work.DBMS.Firebird.V03_0_0.D1.Query.Operators.SET_001.Coalesce.Complete.NullableBoolean.NullableBoolean{
////////////////////////////////////////////////////////////////////////////////
  ...
  using(var cn=LocalCnHelper.CreateCn())
  {
   ...
   using(var tr=cn.BeginTransaction())
   {
    ...
    using(var db=new MyContext(tr))
    {
     ...
     var recs=db.testTable.Where(r => ((string)(object)(r.COL_DATA1 /*OP{*/ ?? /*}OP*/ r.COL_DATA2) ?? "asd") == "asd" && r.TEST_ID==testID);
     ...
     db.CheckTextOfLastExecutedCommand
      (new TestSqlTemplate()
        ...
        .T("WHERE (COALESCE(CAST(COALESCE(").N("t",c_NameOf__COL_DATA1).T(", ").N("t",c_NameOf__COL_DATA2).T(") AS VARCHAR(5)), _utf8 'asd') = _utf8 'asd') AND (").N("t","TEST_ID").T(" = ").P_ID("__testID_0").T(")"));
